...
const patch = {
  "math-5-51": {
    overview: `The retainer is identical on every Halcyon bill, so the extra $2400$ that Client $1$ pays is only the extra AUM speaking. Let $x$ be the fee rate as a decimal and $y$ the shared retainer in dollars.
...
A client with AUM of $850000$ pays the recovered $1.6\\%$ plus the $1200$ retainer:
...
The recovered retainer is $1200$ and Client $2$'s printed fee is $10800$. The retainer's share is
...
Client $1$'s recovered fee on $750000$ is $13200$. Cut the rate to $1.4\\%$ and double the retainer to $2400$:
...
Triple Client $2$'s AUM is $1800000$. At the recovered $1.6\\%$ plus $1200$:
...
Triple Client $2$'s fee is $3(10800) = 32400$. The $30000$ bill is less than $32400$ because the retainer is not tripled.`,
  ...
  "math-5-52": {
    overview: `Batches $1$ and $2$ are already in millilitres, so they pin the two concentrations. Batch $3$ logged Suspension A in litres and is only an audit after the solve. Let $x$ be mg/mL in Suspension A and $y$ the same in Suspension B.
...
The recovered concentrations are $8.4$ mg/mL in A and $15.6$ mg/mL in B. The relative increase is
...
Batch $2$'s roughly $78\\%$ B exceeds Batch $3$'s roughly $58\\%$.`,
  ...
  "math-5-53": {
    overview: `Ridgeline invoices the waste-padded counts, not the usable ones, so convert first: $12\\%$ extra studs and $8\\%$ extra drywall. Let $x$ be the price of one stud and $y$ the price of one drywall sheet.
...
Job $1$'s waste is $24$ extra studs and $12$ extra sheets. At the recovered $4.50$ and $38$:

$$
24(4.50) + 12(38) = 108 + 456 = 564
$$

Five hundred sixty-four dollars of waste cost does not exceed $700$.`,
      `**B.** → True

Job $2$ still orders $392$ studs, but drywall at a $5\\%$ allowance is $175(1.05) = 183.75$ sheets. The new invoice is

$$
392(4.50) + 183.75(38) = 1764 + 6982.50 = 8746.50
$$

The drop from $8946$ is $199.50$, which is more than $150$.`,
      `**C.** → True

Job $2$'s usable $350$ studs and $175$ sheets cost

$$
350(4.50) + 175(38) = 1575 + 6650 = 8225
$$

Ninety percent of the as-ordered $8946$ is $0.90(8946) = 8051.40$. Usable cost of $8225$ exceeds that $8051.40$ benchmark.`,
      `**D.** → True

The recovered sheet price over the stud price is
...
Waste as a percentage of usable cost is $(I - U)/U$. Job $1$'s usable cost is $200(4.50) + 150(38) = 6600$, so the add-on is $\\frac{564}{6600} \\approx 0.0855$. Job $2$'s usable cost is $8225$, so the add-on is $\\frac{721}{8225} \\approx 0.0877$. Job $1$'s roughly $8.55\\%$ is smaller than Job $2$'s roughly $8.77\\%$.`,
    ],
  },
  "math-5-54": {
    overview: `The offset is shared by both calibration points, so it disappears the moment those two rows are subtracted. Point $3$ is only a verification. Let $x$ be the scale factor and $y$ the offset, with true value $V = xR + y$.
...
The recovered scale factor is $3.50$. Relative excess over $3.4$ is
...
Keep the recovered scale $3.50$ and double the offset from $13.50$ to $27$. At a reading of $20$:
...
At a reading of $8.0$ the recovered curve gives
...
Half of Point $1$'s certified $56.90$ is $28.45$. The predicted $41.5$ stays well above $28.45$ because the offset keeps the curve off the origin.`,
  ...
  "math-5-55": {
    overview: `Each shipment's mix is a ratio of a known total weight, so split kilograms before any price equation is written. Let $x$ be the price per kg of Coffee and $y$ the price per kg of Cocoa.
...
Coffee's recovered premium over Cocoa is
...
The $1.35$ gap stays under $1.86$, about $21.8\\%$ of Coffee rather than $30\\%$.`,
  ...
  "math-5-56": {
    overview: `Fuel is quoted in litres per $100$ km, so rewrite every distance in hundreds of kilometres before the litres can talk. Route $3$'s Truck log is in miles and waits until the audit. Let $x$ be the Truck rate and $y$ the Van rate.
...
The recovered rates are $32$ L per $100$ km for the Truck and $18$ for the Van. The Truck's excess is
...
If each vehicle alone covered the combined $1470$ km, that is $14.7$ hundreds of kilometres at each recovered rate:
...
Route $1$'s actual $383.6$ L is far below those two full-distance runs of $735$ L.`,
  ...
  "math-5-57": {
    overview: `The two allocations swap the same $27000$ and $18000$ blocks of the $45000$ fund. Adding them counts the whole fund once at each rate; subtracting them isolates the rate gap. Let $x$ be the Bond rate and $y$ the Equity rate, both in percent, with each allocation written in hundreds of dollars so a percent rate multiplies cleanly.
...
The current allocation returns $2646$ on the $45000$ fund. The blended rate is

$$
\\frac{2646}{45000} = 0.0588
$$

A $5.88\\%$ blend sits under $6\\%$, as expected when more of the money sits in the lower-yielding Bonds.`,
      `**C.** → False

The entire $45000$ at the recovered equity rate of $6.6\\%$ returns
...
A $\\frac{50}{50}$ split of $22500$ in each portfolio returns

$$
22500(0.054) + 22500(0.066) = 1215 + 1485 = 2700
$$

The average of the two described returns is $\\frac{2646 + 2754}{2} = 2700$ as well. The even split matches that average exactly.`,
      `**E.** → True
...
Eighty percent of $6.6$ is $5.28$, and $5.4 > 5.28$. Bonds earn about $81.8\\%$ of the equity rate.`,
  ...
  "math-5-58": {
    overview: `Auto and Home share the administrative fee, so their premium difference is purely coverage. Renters coverage is missing and is recovered after that pair is known. Let $x$ be the fixed fee and $y$ the rate per $1000$ of coverage, counting Auto as $85$ units and Home as $210$ units.
...
The reconstructed Renters coverage is $25$ units of $1000$, which is $25000$. That amount sits below $30000$.`,
      `**B.** → False

The recovered fee of $214.70$ as a share of the Auto premium of $612.50$ is
...
A $10\\%$ rise in the recovered rate of $4.68$ adds $0.468$ per coverage unit. On the Home policy's $210$ units, with the fee unchanged:
...
A single policy covering both amounts pays the recovered fee once over $85 + 210 = 295$ units:
...
Two separate policies total $612.50 + 1197.50 = 1810$. The combined bill of $1595.30$ is lower by exactly one $214.70$ fee.`,
  ...
  "math-5-59": {
    overview: `Year $2$ gives each species separately. Year $6$ gives only the combined headcount, plus the rule that A adds twice what B adds each year. Let $x$ be Species A's annual net change and $y$ Species B's.
...
By Year $6$ the recovered populations are $898$ for A and $874$ for B. The gap is
...
If Species B also grew at A's recovered $72$ per year, then B at Year $6$ would be $730 + 4(72) = 1018$. Combined with A's $898$ that is $1916$. The excess over the actual $1772$ is
...
From Year $2$, A closes a $120$ gap while gaining $36$ a year on B, which takes $\\frac{120}{36} = \\frac{10}{3}$ years. The crossover is at Year $2 + \\frac{10}{3} \\approx 5.33$. At Year $5$ itself, $A = 610 + 72(3) = 826$ and $B = 730 + 36(3) = 838$, so A is still behind and the overtake is not before Year $5$.`,
  ...
  "math-5-60": {
    overview: `Days $1$ and $2$ are already in hours and are the working pair. Convert Day $3$'s $1020$ minutes only when it is time to audit. Let $x$ be Plant A's MWh per hour and $y$ Plant B's.
...
Plant A's recovered $145$ MWh per hour against Plant B's $98$ gives
...
The combined recovered rate is $145 + 98 = 243$. Two-point-four times Plant B is
