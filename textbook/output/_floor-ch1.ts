/**
 * Chapter 1 ΓÇö Logic (subsections 1.1-1.4).
...
export const MATH_CH1_LOGIC: MathTask[] = [
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ False\n\nThe trap is keeping ΓÇ£only the positive root.ΓÇ¥ Both $3$ and $-3$ square to $9$, and both are integers, so $A=\\{-3,3\\}$, not $\\{3\\}$.",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ True\n\n$\\emptyset$ has no elements at all, so the subset test ΓÇ£every element of $\\emptyset$ lies in $A$ΓÇ¥ has nothing that can fail. Hence **$\\emptyset\\subseteq A$** (and $\\emptyset$ appears in $\\mathcal P(A)$).",
  ...
  },
  {
    ...
    sort_order: 5,
    solution_overview:
      "Picture the two lists side by side:\n\n| | in $E$ | not in $E$ |\n| --- | --- | --- |\n| **in $F$** | $\\{3,5\\}$ (overlap) | $\\{4,6\\}$ |\n| **not in $F$** | $\\{1,7\\}$ |, |\n\nSo $E\\setminus F=\\{1,7\\}$ (left column, bottom row) and $F\\setminus E=\\{4,6\\}$ (right column, top row). Their **union** is the two leftover piles together, $\\{1,4,6,7\\}$. Their **intersection** is empty: a number cannot be both ΓÇ£outside $F$ΓÇ¥ and ΓÇ£inside $F$ΓÇ¥ at once. In particular the two differences are different sets.",
  },
  {
    id: "math-1-6",
    case_id: "MATH 1.06",
  ...
  },
  {
    ...
    tactical_explanations: [
      "**A.** ΓåÆ True\n\nStrip $1$ΓÇô$6$ from $U$. What remains is exactly $\\{7,8,9,10,11,12\\}$.",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**B.** ΓåÆ True\n\nBoth sides equal $\\{1,2,3,6,7,8,9,10\\}$. This is De MorganΓÇÖs second law on the nose.",
      "**C.** ΓåÆ False\n\n$A^c\\cap B^c$ keeps only numbers outside **both** sets, namely $9$ and $10$. The claimΓÇÖs $\\{6,7,8\\}$ still live in $B$, so they are not in $B^c$.",
  ...
  },
  {
    ...
    statements: [
      ...
      "A set with n ΓëÑ 2 elements always has more than one possible partition.",
    ],
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**E.** ΓåÆ False\n\n$1+10+5=16$ even-sized subsets. The claimΓÇÖs $15$ is one short.",
    ],
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**B.** ΓåÆ False\n\nThe union is $(0,15)$, open at $15$. The claimΓÇÖs closed bracket $(0,15]$ wrongly includes $15$.",
  ...
  },
  {
    ...
    tactical_explanations: [
      "**A.** ΓåÆ False\n\nInclusionΓÇôexclusion gives **$145$**, not $155$. (Also $155>150$ is impossible for this survey.)",
      "**B.** ΓåÆ True\n\n$150-145=5$ tourists visited none of the three.",
      "**C.** ΓåÆ False\n\nΓÇ£Exactly $A$ and $B$ΓÇ¥ strips the $10$ triple visitors from the pair total $30$, leaving **$20$**, not $30$.",
  ...
  },
  {
    ...
    statements: [
      ...
      "The fact that E Γèè N yet has the same cardinality as N shows that the finite-set intuition ΓÇ£proper subset $\\Rightarrow$ fewer elementsΓÇ¥ does not carry over to infinite sets.",
  ...
  },
  {
    ...
    sort_order: 16,
    solution_overview:
      "$A=\\{2,4,6,8,10,12\\}$, six even numbers, nothing else.\n\nAsk of each claim: is the thing an **element** (one of those six numbers) or a **subset** (a collection of them)?\n\nΓÇó $6$ is on the list ΓåÆ $6\\in A$.\n\nΓÇó The singleton object $\\{6\\}$ is a set, not a number on the list ΓåÆ $\\{6\\}\\notin A$, even though $\\{6\\}\\subseteq A$.\n\nΓÇó $\\{6,8\\}$ has both members in $A$ ΓåÆ subset.\n\nΓÇó $\\emptyset$ always subsets every set.\n\nΓÇó Total subsets: $2^6=64$; drop $A$ itself to get $63$ proper subsets.",
  },
  {
    id: "math-1-17",
    case_id: "MATH 1.17",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**B.** ΓåÆ True\n\n$w,x\\in D$ ΓçÆ $\\{w,x\\}\\subseteq D$ ΓçÆ $\\{w,x\\}\\in\\mathcal P(D)$.",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ True\n\nNonempty + disjoint + full cover ΓçÆ **$\\mathcal S$ partitions $G$**.",
  ...
  },
  {
    ...
    subsection: "1.2",
    context: "Let $A = \\{x \\in R : 1 < x < 5\\}$ and $B = \\{x \\in R : x ΓëÑ 3\\}$.",
    statements: [
      "$A \\subseteq B$.",
      "$A \\cap B = \\{x \\in R : 3 Γëñ x < 5\\}$, i.e. the interval [3, 5).",
      "$B \\subseteq A$.",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**D.** ΓåÆ True\n\nDisjoint ΓçÆ $A\\setminus B=A$ and $B\\setminus A=B$, so the symmetric difference collapses to the ordinary union.",
  ...
  },
  {
    ...
    subsection: "1.2",
    context:
      "A vineyard defines two conditions for its automated systems. Let $A = \\{T \\in R : T^2 < 16\\}$ be the set of temperatures (in ┬░C) for which grapevines are considered frost-safe, and let $B = \\{T \\in R : T ΓëÑ -1\\}$ be the set of temperatures at which the irrigation system is switched on. Note that A is the open interval (-4, 4) and B is the closed-below interval $[-1, \\infty)$.",
    statements: [
      "$A \\cap B = [-1, 4).",
  ...
  },
  {
    ...
    subsection: "1.3",
    context:
      "Consider the statement: ΓÇ£For every prime number p greater than 2, p is an odd number.ΓÇ¥",
    statements: [
      "The statement is true.",
      "The number 2 is a counterexample to the statement.",
      "The correct negation of the statement is: ΓÇ£There exists a prime number p greater than 2 such that p is even.ΓÇ¥",
  ...
  },
  {
    id: "math-1-50",
    case_id: "MATH 1.50",
    title: "The universe of discourse is the set of real numbers, Γä¥",
    subsection: "1.3",
    context: "The universe of discourse is the set of real numbers, Γä¥.",
    statements: [
  ...
  },
  {
    ...
    subsection: "1.3",
    context:
      "A club's rule: ΓÇ£A person is a member if and only if they are not on the banned list.ΓÇ¥ The banned list contains exactly the people with 3 or more rule violations. Person T has 2 violations. Person U has 4 violations.",
    statements: [
  ...
  },
  {
    ...
    subsection: "1.3",
    context:
      'Consider the universal claim: "All prime numbers are odd," and the irrationality of ΓêÜ2.',
    statements: [
      ...
      "A proof by contradiction that ΓêÜ2 is irrational begins by assuming that ΓêÜ2 IS irrational.",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**D.** ΓåÆ True\n\nA dry day with a cancellation is $P$ false, $Q$ true. The inverse had demanded ΓÇ£no rain, so no cancellationΓÇ¥, and the cancellation happened anyway, **the inverse is broken**. The original rule speaks only about rainy days, and this was not one, so it is not even put to the test. Both halves of the statement are right.",
      "**E.** ΓåÆ True\n\nThe contrapositive is the one relative that always carries the same truth value as the original, so once the organizer's rule is granted, **ΓÇ£not cancelled, therefore no rainΓÇ¥ comes free with it.**",
    ],
    difficulty_level: "2/5",
    sort_order: 12,
    solution_overview:
      "The organizer's promise is a **conditional**: it fires only when it rains. Write $P$ for ΓÇ£it rainsΓÇ¥ and $Q$ for ΓÇ£the picnic is cancelledΓÇ¥, so the rule is $P \\Rightarrow Q$.\n\nA conditional makes **no promise at all** when its ΓÇ£ifΓÇ¥ part is false. That single fact settles most of this task, and it also pins down the only way the rule can be broken:\n\n$$\\neg(P \\Rightarrow Q) \\equiv P \\land \\neg Q$$\n\n**The rule and its three relatives**\n\n| Form | Symbols | In plain words | Follows from the rule? |\n| --- | --- | --- | --- |\n| Original | $P \\Rightarrow Q$ | if it rains, the picnic is cancelled | given as true |\n| Converse | $Q \\Rightarrow P$ | if cancelled, then it rained | no |\n| Inverse | $\\neg P \\Rightarrow \\neg Q$ | if no rain, then not cancelled | no |\n| Contrapositive | $\\neg Q \\Rightarrow \\neg P$ | if not cancelled, then no rain | **yes, always** |\n\n**The test day.** On the venue-conflict day it did not rain ($P$ false) but the picnic was cancelled ($Q$ true). Feed that day into the table: the inverse had promised ΓÇ£no cancellationΓÇ¥, so it breaks; the original promised nothing, because it never rained, so it comes through untouched.",
  },
  {
    id: "math-1-56",
    case_id: "MATH 1.56",
    ...
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      "**A.** ΓåÆ True\n\nMathematical ΓÇ£orΓÇ¥ is inclusive by default: ΓÇ£bought X or YΓÇ¥ asks for *at least one*, so the 15 shoppers holding both products are counted in, not out. Nothing in the survey wording narrows it to ΓÇ£exactly oneΓÇ¥. **The reading in the statement is the standard one.**",
      "**B.** ΓåÆ True\n\nInclusionΓÇôexclusion gives $40 + 35 - 15 = 60$, the subtraction removing the double count of the 15 both-buyers. **60 is right.**",
      ...
      "**D.** ΓåÆ True\n\nΓÇ£$P$ if and only if $Q$ΓÇ¥ is a statement about agreement: true when both parts are true, true when both are false, false in the two mixed cases. Saying the two ΓÇ£always have the same truth valueΓÇ¥ is that description in words. **An accurate definition.**",
    ...
    sort_order: 13,
    solution_overview:
      "Two quite different things are being tested here: how many shoppers the word ΓÇ£orΓÇ¥ actually covers, and what a **biconditional** promises.\n\n**Sorting the 100 shoppers.** With $|X| = 40$, $|Y| = 35$ and $|X \\cap Y| = 15$, the survey splits into 15 people who bought both products, $40 - 15 = 25$ who bought only X, and $35 - 15 = 20$ who bought only Y.\n\n**Inclusive ΓÇ£orΓÇ¥.** In mathematics ΓÇ£X or YΓÇ¥ always means *at least one of them*, so the 15 both-buyers are inside the group. Adding 40 and 35 counts those 15 twice, so subtract them once:\n\n$$|X \\cup Y| = 40 + 35 - 15 = 60$$\n\n**Exclusive ΓÇ£orΓÇ¥ (XOR).** If ΓÇ£orΓÇ¥ were meant as *exactly one*, the both-buyers drop out and only the two outer groups remain: $25 + 20 = 45$.\n\n**And the biconditional.** $P \\Leftrightarrow Q$ is a far stricter connective than ΓÇ£orΓÇ¥. It is true when both parts are true and also when both are false, in short, whenever the two agree, and **false the moment their truth values differ.**",
  },
  {
    id: "math-1-57",
    case_id: "MATH 1.57",
  ...
  },
  {
    ...
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      "**A.** ΓåÆ True\n\nSwap the halves and negate each: $\\neg Q \\Rightarrow \\neg P$, no rate rise implying inflation not above 10%. ΓÇ£Not above 10%ΓÇ¥ is just another way of writing ΓÇ£at most 10%ΓÇ¥, so **the sentence is the contrapositive, correctly built.**",
      ...
      "**C.** ΓåÆ True\n\nSufficient means ΓÇ£enough on its own to guaranteeΓÇ¥, which is exactly what an arrow from $P$ to $Q$ asserts. **$P$ is a sufficient condition for $Q$.**",
  ...
  },
  {
    ...
    subsection: "1.3",
    context:
      "A rule states: the outdoor concert will be cancelled unless the rain stops before 6 PM. Let C: ΓÇ£the concert is cancelledΓÇ¥, S: ΓÇ£the rain stops before 6 PM.ΓÇ¥",
    statements: [
    ...
    answer_key: [true, false, true, false, true],
    tactical_explanations: [
      "**A.** ΓåÆ True\n\nΓÇ£$C$ unless $S$ΓÇ¥ means the cancellation stands unless the exception rescues it, so the failure of the exception triggers the cancellation: $\\neg S \\Rightarrow C$. **The translation is right.**",
  ...
  },
  {
    ...
    answer_key: [false, true, false, true, true],
    tactical_explanations: [
      "**A.** ΓåÆ False\n\nΓÇ£Inflation *must* increase for unemployment to decreaseΓÇ¥ makes inflation the necessary condition, and the necessary condition is the one the arrow points at, so this sentence is $Q \\Rightarrow P$. **That is the converse, a different claim.**",
      "**B.** ΓåÆ True\n\nΓÇ£Sufficient conditionΓÇ¥ names the tail of the arrow. Inflation increasing is offered as the sufficient condition and falling unemployment as what follows, which is $P \\Rightarrow Q$ itself. **Same claim, new wording.**",
      "**C.** ΓåÆ False\n\nΓÇ£Only ifΓÇ¥ is the phrase most often misread. ΓÇ£$Q$ only if $P$ΓÇ¥ restricts $Q$ to situations where $P$ already holds, giving $Q \\Rightarrow P$, the converse once again. **Not equivalent to the original.**",
    ...
    sort_order: 21,
    solution_overview:
      "Every statement here is the same claim in different clothing, so the work is translation rather than calculation. Take $P$ = ΓÇ£inflation increasesΓÇ¥ and $Q$ = ΓÇ£unemployment decreasesΓÇ¥; the original is $P \\Rightarrow Q$.\n\nOnly two sentences are ever equivalent to $P \\Rightarrow Q$: the statement itself, and its contrapositive $\\neg Q \\Rightarrow \\neg P$. The converse $Q \\Rightarrow P$ is a different claim no matter how natural it sounds in English.\n\n**A dictionary for the awkward phrases:**\n\n| English phrase | Symbols |\n| --- | --- |\n| ΓÇ£$P$ is sufficient for $Q$ΓÇ¥ | $P \\Rightarrow Q$ |\n| ΓÇ£$Q$ is necessary for $P$ΓÇ¥ | $P \\Rightarrow Q$ |\n| ΓÇ£$P$ is necessary for $Q$ΓÇ¥, ΓÇ£$P$ must happen for $Q$ to happenΓÇ¥ | $Q \\Rightarrow P$ |\n| ΓÇ£$Q$ only if $P$ΓÇ¥, ΓÇ£$Q$ can only happen if $P$ΓÇ¥ | $Q \\Rightarrow P$ |\n| ΓÇ£if not $Q$, then not $P$ΓÇ¥ | $\\neg Q \\Rightarrow \\neg P$ |\n\nThe pattern worth memorising: **the necessary condition is the one the arrow points at, and the sufficient condition is the one it starts from.**",
  },
  {
    id: "math-1-65",
    case_id: "MATH 1.65",
    ...
    tactical_explanations: [
      ...
      "**D.** ΓåÆ False\n\nThis reads rule (1) as if a delay were the *only* thing that could cancel Flight 305. A conditional with a false ΓÇ£ifΓÇ¥ part is silent, not negative, the flight might still be cancelled by a crew shortage. **The guarantee claimed here does not exist.**",
    ...
    sort_order: 22,
    solution_overview:
      "Three facts sit in the log: two rules and one observation.\n\n$$D \\Rightarrow C, \\qquad C \\Rightarrow O, \\qquad D \\text{ is true}$$\n\nwith $D$ = Flight 202 is delayed, $C$ = Flight 305 is cancelled, $O$ = the ground crew works overtime.\n\nThe engine is **modus ponens**: when you know ΓÇ£if $A$ then $B$ΓÇ¥ and you also know $A$, you may write down $B$. Fire it twice and the facts cascade, the delay is real, so rule (1) hands over the cancellation; the cancellation is now real, so rule (2) hands over the overtime.\n\n$$D \\;\\longrightarrow\\; C \\;\\longrightarrow\\; O$$\n\nTwo further checks are worth making. **Is any clue load-bearing?** Rules (1) and (3) mention only $D$ and $C$, the word ΓÇ£overtimeΓÇ¥ never appears in them, so without rule (2) the reasoning stops dead at the cancellation. **What would a quiet day tell us?** If Flight 202 ran on time, rule (1) would have a false ΓÇ£ifΓÇ¥ part and would simply fall silent: Flight 305 could still be cancelled by a crew shortage.",
  },
  {
    id: "math-1-66",
    case_id: "MATH 1.66",
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ True\n\nAnna is $P$ false, $Q$ true. That combination is fatal to the converse ΓÇ£every passer studied 10 hoursΓÇ¥, while the original, which addresses only students who did study, never makes a promise about her. **Both halves of the statement hold.**",
    ...
    sort_order: 23,
    solution_overview:
      "$P$ = ΓÇ£the student studies at least 10 hoursΓÇ¥, $Q$ = ΓÇ£the student passesΓÇ¥. The professor asserts $P \\Rightarrow Q$: ten hours buys a pass.\n\n**Breaking that promise** takes one very specific student, one who put in the hours and failed anyway. In symbols the negation is $P \\land \\neg Q$, and note that it is not another if-then rule but a single counterexample.\n\n**Anna has the opposite shape:** she did not study ($P$ false) yet passed ($Q$ true). Feed her to each version of the claim in turn.\n\nThe **original** never speaks about students who skipped the studying, so Anna falls outside its scope and it survives her intact.\n\nThe **converse** $Q \\Rightarrow P$, ΓÇ£every passer studied 10 hoursΓÇ¥, is refuted by her on the spot.\n\nThe **inverse** $\\neg P \\Rightarrow \\neg Q$, ΓÇ£skip the hours and you failΓÇ¥, is refuted by her too. That is no coincidence: converse and inverse are contrapositives of each other, so they always stand or fall together.\n\nThe **contrapositive** $\\neg Q \\Rightarrow \\neg P$, ΓÇ£anyone who failed studied under 10 hoursΓÇ¥, is untouched, and it is the one form the professor's claim actually guarantees.",
  },
  {
    id: "math-1-67",
    case_id: "MATH 1.67",
    ...
    subsection: "1.3",
    context:
      "A contract clause states: ΓÇ£If the contractor fails to complete the project by the deadline, then a penalty fee applies.ΓÇ¥",
    statements: [
      "Failing to complete the project by the deadline is sufficient for a penalty fee to apply.",
      "The converse, ΓÇ£If a penalty fee applies, then the contractor missed the deadline,ΓÇ¥ must also be true simply because the original clause is true.",
      "The contrapositive, ΓÇ£If no penalty fee applies, then the contractor did not fail to complete by the deadline,ΓÇ¥ is logically guaranteed by the original clause.",
      "The inverse, ΓÇ£If the contractor does not fail to complete by the deadline, then no penalty fee applies,ΓÇ¥ must also be true given the original clause.",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ False\n\nThe statement quietly swaps ΓÇ£eligibleΓÇ¥ for ΓÇ£votesΓÇ¥. Maria keeps her eligibility whether or not she registers, so she is a citizen with $Q$ still true, the law is honoured, not broken. **A counterexample would have to be a citizen who is barred from voting.**",
  ...
  },
  {
    ...
    subsection: "1.3",
    context:
      "A company memo reasons: ΓÇ£If we increase our marketing budget, then sales will increase. Sales have increased this quarter. Therefore, we must have increased our marketing budget.ΓÇ¥",
    statements: [
      "The memo's argument is logically valid.",
      "The argument would become valid if restated as: ΓÇ£If we increase our marketing budget, then sales will increase. We did NOT increase our marketing budget. Therefore, sales did not increase.ΓÇ¥",
      "The argument would become valid if restated as: ΓÇ£If we increase our marketing budget, then sales will increase. Sales did NOT increase. Therefore, we did not increase our marketing budget.ΓÇ¥",
      "For the original memo's conclusion to be validly drawn, the premise would need to be strengthened to a biconditional: ΓÇ£We increase our marketing budget if and only if sales increase.ΓÇ¥",
      "The fallacy in the original memo is the same type as concluding ΓÇ£It is rainingΓÇ¥ from the premises ΓÇ£If it rains, the ground gets wetΓÇ¥ and ΓÇ£The ground is wet.ΓÇ¥",
    ],
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ True\n\nFrom ΓÇ£sales did not riseΓÇ¥ to ΓÇ£the budget did not riseΓÇ¥ is modus tollens, which is just the contrapositive $\\neg Q \\Rightarrow \\neg P$ used forwards. **This version of the argument is valid.**",
  ...
  },
  {
    ...
    statements: [
      'ΓêÜ2 + (-ΓêÜ2) = 0 is a valid counterexample to "the sum of two irrational numbers is always irrational," since ΓêÜ2 and -ΓêÜ2 are irrational but their sum, 0, is rational',
    ...
    tactical_explanations: [
      ...
      "**B.** ΓåÆ True\n\nA claim carrying the word ΓÇ£alwaysΓÇ¥ is destroyed by a single failure, and there is nothing left to repair. **One counterexample settles the matter.**",
      "**C.** ΓåÆ True\n\nContradiction proofs open with the negation of the target, and the negation of ΓÇ£there is no largest primeΓÇ¥ is ΓÇ£there is one, call it $p$ΓÇ¥. **That is the correct opening move.**",
      ...
      "**E.** ΓåÆ True\n\nΓÇ£There existsΓÇ¥ asks for one witness and nothing more, so exhibiting a single $x$ with $P(x)$ true completes the proof. **This is the standard way to establish an existential claim.**",
    ],
    difficulty_level: "4/5",
    sort_order: 29,
    solution_overview:
      "Two lopsided facts drive this whole task: **one example can destroy a ΓÇ£for allΓÇ¥ claim but can never establish one**, while for a ΓÇ£there existsΓÇ¥ claim a single example is the entire job.\n\n| Claim | To prove it | To disprove it |\n| --- | --- | --- |\n| $\\forall x\\, P(x)$ | an argument covering every $x$ | one counterexample |\n| $\\exists x\\, P(x)$ | one witness | an argument covering every $x$ |\n\n**The irrational sums.** ΓÇ£The sum of two irrational numbers is always irrationalΓÇ¥ is a $\\forall$ claim, so one bad pair finishes it. Take $\\sqrt2$ and $-\\sqrt2$: both are irrational, and\n\n$$\\sqrt2 + (-\\sqrt2) = 0,$$\n\nwhich is rational, since $0 = \\tfrac{0}{1}$. The word ΓÇ£alwaysΓÇ¥ cannot survive that.\n\n**The largest prime.** A **proof by contradiction** always opens with the negation of the target. The target ΓÇ£there is no largest primeΓÇ¥ is negated by ΓÇ£there is a largest prime, call it $p$ΓÇ¥, so that is the first line; the proof then manufactures a prime larger than $p$ and the assumption collapses.",
  },
  {
    id: "math-1-73",
    case_id: "MATH 1.73",
  ...
  },
  {
    ...
    tactical_explanations: [
      "**A.** ΓåÆ False\n\nThe sentence offered, ΓÇ£paid on time and received the discountΓÇ¥, is $P \\land Q$: a satisfied customer, the policy working as intended. A negation must keep the payment and remove the discount, $P \\land \\neg Q$. **The wrong half has been negated.**",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**D.** ΓåÆ True\n\nΓÇ£No audit, therefore revenue at most \\$1 millionΓÇ¥ is the contrapositive, which always tracks the truth of the original. **Given the regulation, this must hold too.**",
    ...
    sort_order: 32,
    solution_overview:
      "$P$ = ΓÇ£a company's annual revenue exceeds \\$1 millionΓÇ¥, $Q$ = ΓÇ£the company files an annual auditΓÇ¥. The regulation is $P \\Rightarrow Q$.\n\n**Negating a rule does not produce another rule.** A regulation is overturned by a single offender, so\n\n$$\\neg(P \\Rightarrow Q) \\equiv P \\land \\neg Q$$, *some* company with revenue above \\$1 million filed no audit. The sentence ΓÇ£if revenue exceeds \\$1 million, then no audit is filedΓÇ¥ is a rival regulation binding *every* large company; that is a far stronger claim, and not the negation at all.\n\n**Small companies may still audit.** Nothing forbids a firm with \\$300,000 of revenue from filing voluntarily, giving $Q$ true with $P$ false. That case is fatal to the converse $Q \\Rightarrow P$ (ΓÇ£filing proves high revenueΓÇ¥) and equally fatal to the inverse $\\neg P \\Rightarrow \\neg Q$, while the regulation itself is untouched.\n\n**Company X**, at \\$2 million with no audit, has $P$ true and $Q$ false, precisely the shape the negation calls for, so it really does prove the regulation broken. Meanwhile the contrapositive $\\neg Q \\Rightarrow \\neg P$ is the only rewriting that inherits the regulation's truth.",
  },
  {
    id: "math-1-76",
    case_id: "MATH 1.76",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**B.** ΓåÆ True\n\nThe target is ΓÇ£not every point-earner ordered dessertΓÇ¥, so the assumption to be contradicted is ΓÇ£every point-earner ordered dessertΓÇ¥, the converse, and Sam is the immediate contradiction. **The proof is set up correctly.**",
    ...
    sort_order: 35,
    solution_overview:
      "$P$ = ΓÇ£the diner orders dessertΓÇ¥, $Q$ = ΓÇ£the diner receives a loyalty pointΓÇ¥, and the policy is $P \\Rightarrow Q$. Sam's birthday point gives him $P$ false, $Q$ true.\n\nEverything in this task turns on comparing **Sam's shape** with the shape each statement needs.\n\nTo refute a conditional you need its ΓÇ£ifΓÇ¥ half true and its ΓÇ£thenΓÇ¥ half false. For the **converse** $Q \\Rightarrow P$ (ΓÇ£every point-earner ordered dessertΓÇ¥) that means a point without dessert, Sam exactly. For the **inverse** $\\neg P \\Rightarrow \\neg Q$ (ΓÇ£no dessert, no pointΓÇ¥) it means no dessert but a point anyway, Sam again. For the **original policy** it would mean dessert with no point, $P \\land \\neg Q$, which is not Sam at all; the restaurant's promise therefore stands.\n\nThe contradiction argument mentioned in the statements is the same observation in formal dress: to prove ΓÇ£not every point-earning diner ordered dessertΓÇ¥, assume the opposite, that is the converse $Q \\Rightarrow P$, then produce Sam and watch the assumption die.",
  },
  {
    id: "math-1-79",
    case_id: "MATH 1.79",
    ...
    subsection: "1.4",
    context:
      "Consider the statement: ΓÇ£For every positive integer m, there exists a positive integer n such that m┬╖n = 100.ΓÇ¥",
    statements: [
      "The statement holds when m = 4 (there exists n with 4n = 100).",
      "The statement holds when m = 3 (there exists n with 3n = 100).",
      "The overall statement (ΓÇ£for every m, there exists n...ΓÇ¥) is true.",
      "The correct negation of the overall statement is: ΓÇ£There exists a positive integer m such that for every positive integer n, m┬╖n Γëá 100.ΓÇ¥",
      "Reversing the quantifiers to ΓÇ£There exists n such that for every m, m┬╖n = 100ΓÇ¥ would also produce a false statement.",
    ],
    answer_key: [true, false, false, true, true],
    tactical_explanations: [
      ...
      "**C.** ΓåÆ False\n\nΓÇ£For every $m$ΓÇ¥ admits no exceptions, and $m = 3$ is one. **The overall statement fails.**",
  ...
  },
  {
    ...
    tactical_explanations: [
      ...
      "**C.** ΓåÆ False\n\nCara's innocence arrives from clue (3) together with ΓÇ£exactly one is guiltyΓÇ¥, without clue (2) being consulted at all. Clue (2) is consistent with the solution, but nothing here rests on it. **It is not essential.**",
      "**D.** ΓåÆ True\n\nWith Ann innocent, clue (1) has a false ΓÇ£ifΓÇ¥ part, so it is automatically satisfied and produces nothing. Its contrapositive $D \\Rightarrow \\neg A$ could in principle have cleared Ann, but the counting had already done that job. **Clue (1) adds no information in this puzzle.**",
      "**E.** ΓåÆ True\n\nClue (3) is a flat assertion rather than a conditional, so it needs no supporting premises. The ΓÇ£exactly one guiltyΓÇ¥ condition was needed only to clear the other three suspects. **Dan's guilt rests on clue (3) alone.**",
    ],
    difficulty_level: "1/5",
    sort_order: 2,
    solution_overview:
      "Four suspects, exactly one guilty, and one clue that simply hands the answer over.\n\n**Clue (3) is not a conditional at all.** It is a plain assertion: Dan is guilty. Combine it with ΓÇ£exactly one of the four is guiltyΓÇ¥ and the whole picture is fixed before the if-then clues are even read.\n\n| Suspect | Verdict | Where it comes from |\n| --- | --- | --- |\n| Dan | **guilty** | clue (3), stated outright |\n| Ann | innocent | only one can be guilty, and Dan holds that place |\n| Ben | innocent | same reason |\n| Cara | innocent | same reason |\n\n**Do the conditional clues add anything?** Check each against the verdicts. Clue (1), $A \\Rightarrow \\neg D$, has a false ΓÇ£ifΓÇ¥ part, so it is automatically satisfied and yields nothing new. Clue (2), $\\neg B \\Rightarrow \\neg C$, only re-confirms Cara's innocence, which the counting had already given us. Clue (4), $C \\Rightarrow A$, is likewise vacuous with $C$ false. All three are consistent with the solution, and all three are redundant here.",
  },
  {
    id: "math-1-81",
    case_id: "MATH 1.81",
    ...
    subsection: "1.4",
    context:
      "On an island, every inhabitant either always tells the truth or always lies. Two inhabitants make statements: X says, ΓÇ£Y always lies.ΓÇ¥ Y says, ΓÇ£X and I are both liars.ΓÇ¥",
    statements: [
      "X is a truth-teller.",
      "Y is a truth-teller.",
      "Y's statement (ΓÇ£X and I are both liarsΓÇ¥) is false.",
    ...
    tactical_explanations: [
      ...
      "**B.** ΓåÆ False\n\nX is truthful, so X's sentence ΓÇ£Y always liesΓÇ¥ is true. **Y is a liar.**",
      ...
      "**D.** ΓåÆ False\n\nOne of the two cases self-destructs, leaving only the assignment ΓÇ£X truthful, Y lyingΓÇ¥. **The solution is unique, not doubled.**",
      "**E.** ΓåÆ True\n\nA lying X makes ΓÇ£Y always liesΓÇ¥ false, so Y would have to be truthful; but a truthful Y's sentence demands that Y be a liar. **The assumption collapses, which is precisely why that case was ruled out.**",
    ],
    difficulty_level: "1/5",
    sort_order: 3,
    solution_overview:
      "Every islander is either a **truth-teller**, whose every sentence is true, or a **liar**, whose every sentence is false. Write $x$ for ΓÇ£X is a truth-tellerΓÇ¥ and $y$ for ΓÇ£Y is a truth-tellerΓÇ¥. X's sentence claims $\\neg y$; Y's sentence claims $\\neg x \\land \\neg y$.\n\nThere are only two possibilities for X, so test them both.\n\n**Case 1: X is a liar.** Then X's sentence is false, so $\\neg y$ is false and Y is a truth-teller. But a truth-teller's sentence must be true, so $\\neg x \\land \\neg y$ holds, and that requires $\\neg y$, making Y a liar. Y cannot be both. **This case is impossible.**\n\n**Case 2: X is a truth-teller.** Then X's sentence is true, so Y is a liar. Check Y for consistency: a liar's sentence must be false, and $\\neg x \\land \\neg y$ is indeed false, because $\\neg x$ is false. Nothing clashes. **This case works.**\n\nOne case collapses and one survives, so the answer is forced and unique: **X tells the truth and Y lies**, which also makes Y's sentence ΓÇ£X and I are both liarsΓÇ¥ false, as it had to be, given who said it.",
  },
  {
    id: "math-1-82",
    case_id: "MATH 1.82",
    ...
    subsection: "1.4",
    context:
      "Compare two statements about a class of students and several exams: Statement 1: ΓÇ£There exists a student who scored above 90 on every exam.ΓÇ¥ Statement 2: ΓÇ£For every exam, there exists a student who scored above 90.ΓÇ¥",
    statements: [
  ...
  },
  {
    ...
    subsection: "1.4",
    context:
      "A product warranty: ΓÇ£The warranty is void if the product is used commercially, except if the manufacturer has explicitly approved commercial use in writing, in which case the warranty remains valid provided the product is serviced annually.ΓÇ¥ Company Z uses the product commercially, has written approval from the manufacturer, but has never had the product serviced.",
    statements: [
  ...
  },
  {
    ...
    statements: [
      ...
      'A "proof" of "ΓêÜ3 is irrational" that begins "Assume ΓêÜ3 is irrational..." and proceeds from there is a valid proof by contradiction.',
  ...
  },
  {
    ...
    statements: [
      ...
      "The argument would still be valid if Premise 2 were changed to ΓÇ£No economists specialize in game theory.ΓÇ¥ 39",
      ...
      "This argument is an example of the fallacy of ΓÇ£affirming the consequent.ΓÇ¥",
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
  ...
  },
  {
    ...
    subsection: "1.4",
    context:
      "A professor's rule: ΓÇ£A student receives a B or higher if and only if their exam score is at least 70 - unless the professor applies a curve, in which case a score of at least 60 suffices for a B or higher.ΓÇ¥ In a particular exam, the professor did apply a curve. Student W scored 65.",
    statements: [
      ...
      "The phrase ΓÇ£if and only ifΓÇ¥ in the rule means that scoring at least 70 is both necessary and sufficient for a B or higher under all circumstances, curve or no curve.",
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
  ...
  },
  {
    ...
    subsection: "1.4",
    context:
      "A policy: ΓÇ£If a subscriber cancels at least 3 days before the renewal date, the subscription does not renew and no charge applies. If a subscriber cancels fewer than 3 days before the renewal date, the subscription still renews, but a partial refund is issued afterward if and only if the subscriber had used less than 10% of the service during that period.ΓÇ¥ Subscriber K cancelled 2 days before the renewal date and had used 15% of the service that period.",
    statements: [
  ...
  },
  {
    ...
    statements: [
      ...
      'The converse, "If a sequence is bounded, then it converges," is false - the sequence (-1)Γü┐ (that is, -1, 1, -1, 1,...) is bounded but does not converge, serving as a counterexample.',
      'The inverse, "If a sequence does not converge, then it is not bounded," is logically equivalent to the converse, and is therefore also false, using the same sequence (-1)Γü┐ as its counterexample.',
  ...
  },
  {
    ...
    subsection: "1.4",
    context:
      "On the same island (truth-tellers always tell the truth, liars always lie), three inhabitants speak. J says: ΓÇ£Exactly one of us is a truth-teller.ΓÇ¥ K says: ΓÇ£J is lying.ΓÇ¥ L says: ΓÇ£K and I are the same type (both truth-tellers or both liars).ΓÇ¥",
    statements: [
      "J is a liar.",
      "K is a truth-teller.",
      "L is a truth-teller.",
  ...
  },
  {
    ...
    statements: [
      ...
      "Without rule (3)'s ΓÇ£unlessΓÇ¥ exception (i.e. if Ceci attending always forced Dmitri not to attend, no exceptions), the rules would become impossible to satisfy at all given that Dmitri attends.",
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
