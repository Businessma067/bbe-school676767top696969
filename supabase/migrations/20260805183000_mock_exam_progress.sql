-- In-progress mock exam recovery: answers, flags, notes, annotations, timer.
-- Completed attempts keep status = 'submitted' (default for legacy rows).
...
-- One active sitting per user + exam
