  ...
  "sections": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "p",
          "text": "For the laptop, book value continues to €800 after year 2 and €0 after year 3. For the van, depreciable cost is 14,000 − 2,000 = 12,000, so annual depreciation = 12,000 / 5 = €2,400. **Carrying value** = cost − accumulated depreciation."
        },
        {
          "type": "idea",
        ...
        {
          "type": "p",
          "text": "**Cash** change and **profit** can diverge sharply. Opening cash €4,800 and closing cash €40,700 imply a cash increase of €35,900 in the same year that profit was €54,000, because profit includes non-cash depreciation and accruals while cash only counts actual movements — and because investing and financing cash also move the bank balance. A firm can be **profitable and still short of cash**, or raise cash by borrowing without matching profit."
        },
        {
          "type": "table",
        ...
        {
          "type": "p",
          "text": "Exam cues for 6.2: separate period from point-in-time, remember that **profit is not cash**, classify operating / investing / financing flows, compute straight-line depreciation and carrying value, spot that depreciation is an expense without a same-period cash payment, and keep expenditure (buy the asset) distinct from expense (use the asset up)."
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "p",
          "text": "Cedar Circuit Components publishes a sample statement of financial position in **€ thousands**. Compare the two years in the table — do not learn the story as a wall of prose."
        },
        {
          "type": "table",
