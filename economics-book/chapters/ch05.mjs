  ...
  "sections": [
    {
      ...
      "blocks": [
        ...
        {
          "type": "p",
          "text": "Customers may be other businesses or private households. Goods and services sold from one business to another are **producer products** (**B2B**); the same categories sold to consumers are **consumer products** (**B2C**). Buyer and user need not be the same person: a parent may pay while a teenager uses the product, or a facilities manager may purchase while employees use the lamps daily. Value is not only the core function — light on a desk — because extra features such as dimmers or USB ports, image such as craft reputation, and the joy or reassurance of use all shape why someone chooses one offering over another. Marketing designs and communicates that whole package, not only the physical object."
        },
        {
          "type": "idea",
          "term": "Product line",
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "Not every rider wants the same bike. GlassHarbor’s research shows four different “ideal bikes” living in one city: students wanting cheap short hops, nurses wanting reliable night commuting, tourists wanting day rentals near the harbour, and cargo users needing stable racks. Treating all four as one average customer would produce a bike that delights nobody. **Segmentation** starts by grouping similar customers; **targeting** chooses whom to serve; **positioning** shapes what those groups believe the offer stands for."
        },
        {
          "type": "idea",
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          "type": "figure",
          "id": "marketing-mix",
          "caption": "The four elements of the marketing mix: product, price, place and promotion — decisions that must stay consistent with one another and with market research."
        },
        {
          "type": "p",
        ...
        },
        {
          ...
          "caption": "Product life cycle: introduction, growth, maturity and decline — sales and profit follow different paths across stages."
        },
        {
          "type": "p",
        ...
        },
        {
          "type": "figure",
          "id": "bcg-matrix",
          "caption": "Boston Consulting Group matrix: stars and question marks in high-growth markets; cash cows and dogs in low-growth markets — split by high versus low relative market share."
        },
        {
          "type": "p",
