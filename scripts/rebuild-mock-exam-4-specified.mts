...
The hospital wants to know which schedule is cheapest in present-value terms at the stated annual discount rates.`;
  ...
  if (caseId === "MATH 13.18") {
    mapped.context = `Two sales reps each make $25$ independent calls in a day. Rep A is new (probability $0.30$ of converting a call). Rep B is experienced (probability $0.68$).

A “strong day” means at least $13$ conversions.
