...
## Files
- `src/data/economics-cases-ch2-subtopics.json` (done)
...
2. Explain this statement’s nouns/logic. False → concrete counterexample or corrected category.
...
Read against… / nouns in play… / teacher-meta / keyed true-false commentary /
...
python3 scripts/_econ_expl_from_scratch_validate.py src/data/economics-cases-chN-subtopics.json --from-id 'CASE …' --to-id 'CASE …'
```
