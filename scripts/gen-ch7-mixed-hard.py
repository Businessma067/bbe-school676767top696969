...
def build_all() -> list[dict]:
    ...
    add(
        ...
        expls=[
            pack("A", True, [
                ...
                D(r"x=1\qquad x=5"),
                D(r"1+5=6"),
                "Vieta says the same thing after expansion: the sum of the roots is $-b/a=12/2=6$.",
                close(True, "The sum of the roots is $6$"),
            ]),
            pack("B", True, [
            ...
            pack("C", True, [
                "Evaluate the factored form on the axis, keeping the leading $2$.",
                D(r"g(3)=2(3-1)(3-5)"),
                D(r"2\cdot 2\cdot(-2)=-8"),
                "Dropping the leading $2$ would have produced the trap value $-4$.",
                close(True, "The vertex height is $-8$"),
            ]),
            pack("D", True, [
    ...
    add(
        ...
        expls=[
            ...
            pack("C", True, [
                ...
                D(r"7-5=2"),
                D(r"(2,2,2)"),
                close(True, "The first differences are constantly $2$"),
            ]),
            pack("D", True, [
    ...
    add(
        ...
        statements=[
            "The turning point of the solid curve lies on the dashed line.",
        ...
        expls=[
            pack("A", True, [
                ...
                D(r"g(x)=(x-1)(x-3)"),
                D(r"g(2)=-1"),
                "The turning point and the dashed line share the point $(2,-1)$.",
                close(True, "The turning point lies on the dashed line"),
            ]),
            pack("B", True, [
    ...
    add(
        ...
        expls=[
            ...
            pack("D", True, [
                "Second differences of a constant first-difference row are all zero.",
                D(r"3-3=0"),
                D(r"(0,0,0)"),
    ...
    add(
        ...
        expls=[
            ...
            pack("E", False, [
                "Read the peak height on the vertical scale, or evaluate the hidden rule at $t=3$.",
                D(r"h(3)=3\cdot 3=9"),
                D(r"9\neq 8"),
