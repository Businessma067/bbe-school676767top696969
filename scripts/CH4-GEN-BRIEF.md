...
- One formal sentence per statement; teacher-style explanations (no TRUE — / FALSE — leads, no em dashes)
...
```
{
  ...
  "tactical_explanations": ["<teacher prose; end with The statement is true/false.>", ...],
