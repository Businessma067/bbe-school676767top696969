...
def specs() -> list[dict]:
    return [
        dict(title="Regional Tennis Circuit", story="Over a full indoor season of {n} independent matches, a player's expected number of wins is {E}. Assume the win chance is the same in every match.", n=40, E=27.2, p=0.68, success="win", fail="lose", unit="match", style="classic", difficulty="3/5"),
        dict(title="Festival Food Stall", story="A festival food stall tracks whether each customer leaves satisfied. In a typical block of {n} independent orders, the expected number of satisfied customers is {E}.", n=16, E=12.8, p=0.8, success="satisfied customer", fail="unsatisfied customer", unit="order", style="exact_vs_atleast", difficulty="3/5"),
        dict(title="Community Clinic Screening", story="On a screening day with {n} independent patients, positives and negatives are expected in the ratio {r_pos} : {r_neg}. The standard deviation of the number of positives that day is $\\sqrt{{{sd2}}}$.", n=80, E=12.0, p=0.15, r_pos=3, r_neg=17, sd2=10.2, success="positive screen", fail="negative screen", unit="patient", style="ratio", difficulty="4/5"),
        dict(title="Night Courier Audit", story="A courier completed an audit of {n} independent evening deliveries. The expected number of on-time deliveries was {E}, and the variance of that count was {V}.", n=50, E=42.0, V=6.72, p=0.84, success="on-time delivery", fail="late delivery", unit="delivery", style="mean_var", difficulty="3/5"),
        dict(title="Coding Contest Auto-Grader", story="In a contest with {n} independent submissions, the auto-grader accepts {E} on average.", n=35, E=14.0, p=0.4, success="accepted submission", fail="rejected submission", unit="submission", style="low_p", difficulty="3/5"),
        dict(title="Warehouse Picker Accuracy", story="A warehouse audits {n} independent picks. The expected number of correct picks is {E}, and the variance of the correct-pick count is {V}.", n=25, E=20.0, V=4.0, p=0.8, success="correct pick", fail="incorrect pick", unit="pick", style="mean_var", difficulty="2/5"),
        dict(title="Language Lab Listening Test", story="In a listening quiz of {n} independent items, a student is expected to answer {E} correctly.", n=20, E=15.0, p=0.75, success="correct answer", fail="incorrect answer", unit="item", style="classic", difficulty="2/5"),
        dict(title="Bike-Share Dock Sensors", story="A maintenance log covers {n} independent dock sensors. Faulty and working sensors are expected in the ratio {r_pos} : {r_neg}.", n=60, E=12.0, p=0.2, r_pos=1, r_neg=4, success="faulty sensor", fail="working sensor", unit="sensor", style="ratio", difficulty="3/5"),
        dict(title="Hotel Booking Confirmations", story="A hotel tracks {n} independent booking requests. The expected number of confirmed bookings is {E}.", n=30, E=24.0, p=0.8, success="confirmed booking", fail="unconfirmed booking", unit="request", style="exact_vs_atleast", difficulty="3/5"),
        dict(title="Pharmacy Prescription Checks", story="A pharmacy reviews {n} independent prescriptions. The expected number flagged for follow-up is {E}, with variance {V}.", n=40, E=8.0, V=6.4, p=0.2, success="flagged prescription", fail="clear prescription", unit="prescription", style="low_p", difficulty="3/5"),
        dict(title="Museum Audio Guide Returns", story="Over {n} independent audio-guide loans, the expected number returned on time is {E}.", n=45, E=36.0, p=0.8, success="on-time return", fail="late return", unit="loan", style="classic", difficulty="2/5"),
        dict(title="Startup Demo Conversions", story="A sales team ran {n} independent product demos. The expected number of conversions was {E}, and the standard deviation of conversions was $\\sqrt{{{sd2}}}$.", n=25, E=10.0, sd2=6.0, p=0.4, success="conversion", fail="non-conversion", unit="demo", style="mean_sd", difficulty="4/5"),
        dict(title="Campus Bus On-Time Arrivals", story="Across {n} independent bus arrivals, on-time and late arrivals are expected in the ratio {r_pos} : {r_neg}.", n=50, E=40.0, p=0.8, r_pos=4, r_neg=1, success="on-time arrival", fail="late arrival", unit="arrival", style="ratio", difficulty="3/5"),
        dict(title="Escape-Room Puzzle Solves", story="In an escape room with {n} independent puzzles, the expected number solved within the time limit is {E}.", n=12, E=7.2, p=0.6, success="solved puzzle", fail="unsolved puzzle", unit="puzzle", style="classic", difficulty="3/5"),
        dict(title="Wildlife Camera Triggers", story="A wildlife camera records {n} independent night windows. The expected number of windows with an animal trigger is {E}, with variance {V}.", n=48, E=12.0, V=9.0, p=0.25, success="animal trigger", fail="empty window", unit="night window", style="low_p", difficulty="3/5"),
        dict(title="Theatre Ticket Upsells", story="A box office handles {n} independent ticket sales. The expected number of sales that include an upsell is {E}.", n=32, E=12.8, p=0.4, success="upsell", fail="no upsell", unit="sale", style="exact_vs_atleast", difficulty="3/5"),
        dict(title="Lab Pipette Calibration Passes", story="Technicians calibrate {n} independent pipettes. The expected number that pass on the first try is {E}, and the variance is {V}.", n=20, E=17.0, V=2.55, p=0.85, success="first-try pass", fail="first-try fail", unit="pipette", style="mean_var", difficulty="3/5"),
        dict(title="Online Quiz Instant Feedback", story="A quiz has {n} independent multiple-choice items. The expected number correct is {E}.", n=15, E=9.0, p=0.6, success="correct item", fail="incorrect item", unit="item", style="classic", difficulty="2/5"),
        dict(title="Airport Lounge Wi-Fi Sessions", story="Over {n} independent Wi-Fi sessions, successful and dropped connections are expected in the ratio {r_pos} : {r_neg}.", n=70, E=56.0, p=0.8, r_pos=4, r_neg=1, success="successful connection", fail="dropped connection", unit="session", style="ratio", difficulty="3/5"),
        dict(title="Charity Door-to-Door Pledges", story="Volunteers visit {n} independent households. The expected number of pledges is {E}, with standard deviation $\\sqrt{{{sd2}}}$.", n=40, E=10.0, sd2=7.5, p=0.25, success="pledge", fail="no pledge", unit="household", style="mean_sd", difficulty="4/5"),
        dict(title="Bakery Morning Batch QC", story="A bakery inspects {n} independent loaves. The expected number meeting quality standards is {E}.", n=28, E=22.4, p=0.8, success="quality loaf", fail="rejected loaf", unit="loaf", style="exact_vs_atleast", difficulty="3/5"),
        dict(title="Swim-Meet Legal Starts", story="In a meet with {n} independent starts, the expected number of legal starts is {E}, and the variance is {V}.", n=24, E=19.2, V=3.84, p=0.8, success="legal start", fail="false start", unit="start", style="mean_var", difficulty="2/5"),
        dict(title="Library Reserve Hold Pickups", story="Of {n} independent reserve holds, the expected number picked up within 48 hours is {E}.", n=36, E=27.0, p=0.75, success="on-time pickup", fail="missed pickup", unit="hold", style="classic", difficulty="2/5"),
        dict(title="App Push Notification Opens", story="A campaign sends {n} independent push notifications. Opens and ignores are expected in the ratio {r_pos} : {r_neg}.", n=100, E=30.0, p=0.3, r_pos=3, r_neg=7, success="open", fail="ignore", unit="notification", style="ratio", difficulty="3/5"),
        dict(title="Robot Vacuum Room Completions", story="A robot attempts {n} independent room cleanings. The expected number completed without human help is {E}, with variance {V}.", n=18, E=12.6, V=3.78, p=0.7, success="unassisted completion", fail="assisted room", unit="room", style="mean_var", difficulty="3/5"),
        dict(title="Debate Tournament Coin Tosses", story="A tournament uses {n} independent coin tosses to assign sides. The expected number of heads is {E}.", n=20, E=11.0, p=0.55, success="heads", fail="tails", unit="toss", style="classic", difficulty="2/5"),
        dict(title="Farm Soil Moisture Alerts", story="Sensors check {n} independent field plots. The expected number of drought alerts is {E}.", n=45, E=9.0, p=0.2, success="drought alert", fail="no alert", unit="plot", style="low_p", difficulty="3/5"),
        dict(title="Cinema Loyalty Card Scans", story="At a cinema, {n} independent ticket purchases are tracked. The expected number that scan a loyalty card is {E}, with SD $\\sqrt{{{sd2}}}$.", n=60, E=36.0, sd2=14.4, p=0.6, success="loyalty scan", fail="no scan", unit="purchase", style="mean_sd", difficulty="3/5"),
        dict(title="Ski-Lift Gate Passes", story="A lift processes {n} independent riders. Valid and invalid passes are expected in the ratio {r_pos} : {r_neg}.", n=80, E=72.0, p=0.9, r_pos=9, r_neg=1, success="valid pass", fail="invalid pass", unit="rider", style="ratio", difficulty="3/5"),
        dict(title="Podcast Ad Click-Throughs", story="An ad plays in {n} independent episodes. The expected number of click-throughs is {E}.", n=50, E=5.0, p=0.1, success="click-through", fail="no click", unit="episode", style="low_p", difficulty="4/5"),
        dict(title="Campus Printer Job Success", story="A computer lab runs {n} independent print jobs. The expected number completed without error is {E}, and the variance is {V}.", n=22, E=17.6, V=3.52, p=0.8, success="error-free job", fail="failed job", unit="print job", style="mean_var", difficulty="2/5"),
        dict(title="Board-Game Critical Hits", story="In a campaign of {n} independent attack rolls, the expected number of critical hits is {E}.", n=30, E=6.0, p=0.2, success="critical hit", fail="non-critical roll", unit="attack roll", style="exact_vs_atleast", difficulty="3/5"),
        dict(title="Harbor Foghorn Tests", story="Harbor staff run {n} independent foghorn tests. The expected number of clear audible tests is {E}.", n=14, E=11.2, p=0.8, success="audible test", fail="failed test", unit="test", style="classic", difficulty="2/5"),
        dict(title="Blood-Donation Appointment Shows", story="A clinic books {n} independent donation appointments. Shows and no-shows are expected in the ratio {r_pos} : {r_neg}.", n=55, E=44.0, p=0.8, r_pos=4, r_neg=1, success="show", fail="no-show", unit="appointment", style="ratio", difficulty="3/5"),
        dict(title="Drone Delivery Drop Accuracy", story="A drone completes {n} independent drops. The expected number landing in the target zone is {E}, with variance {V}.", n=16, E=12.0, V=3.0, p=0.75, success="on-target drop", fail="off-target drop", unit="drop", style="mean_var", difficulty="3/5"),
        dict(title="Music Festival Wristband Scans", story="At an entrance gate, {n} independent wristband scans are logged. The expected number of successful scans is {E}, with SD $\\sqrt{{{sd2}}}$.", n=90, E=81.0, sd2=8.1, p=0.9, success="successful scan", fail="failed scan", unit="scan", style="mean_sd", difficulty="3/5"),
        dict(title="Tutoring Session Homework Done", story="A tutor checks {n} independent homework sets. The expected number completed before the session is {E}.", n=18, E=10.8, p=0.6, success="completed set", fail="incomplete set", unit="homework set", style="classic", difficulty="2/5"),
        dict(title="Ice-Cream Machine Self-Cleans", story="A parlor runs {n} independent self-clean cycles. The expected number that finish without a fault alert is {E}.", n=26, E=20.8, p=0.8, success="clean finish", fail="fault alert", unit="cycle", style="exact_vs_atleast", difficulty="3/5"),
        dict(title="Archaeology Dig Artifact Finds", story="A dig team examines {n} independent soil squares. Finds and empty squares are expected in the ratio {r_pos} : {r_neg}.", n=64, E=16.0, p=0.25, r_pos=1, r_neg=3, success="artifact find", fail="empty square", unit="soil square", style="ratio", difficulty="4/5"),
        dict(title="Satellite Packet Acknowledgements", story="A ground station sends {n} independent packets. The expected number of acknowledgements received is {E}, and the variance is {V}.", n=40, E=34.0, V=5.1, p=0.85, success="acknowledgement", fail="lost packet", unit="packet", style="mean_var", difficulty="3/5"),
    ]
