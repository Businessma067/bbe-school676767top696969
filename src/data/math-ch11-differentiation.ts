 ...
 * Lovable sync marker: 11.4 one-plane graphs, coordinate stems, no waves.
 */
...
For $x\\in(0,1)$ the product $(x-1)(x-3)$ is positive; for $x\\in(1,3)$ it is negative. Hence $+$ to $-$ at $x=1$ ⇒ local maximum of $f$.
...
$f'(0)=3$ and $g'(0)=10$, both positive with green larger.
...
$f''(x)=3x^{2}-2x-4$ opens upward and $f''(0)<0$.
...
$f'(1)=4$ on this model; the green height matches.
...
Direct evaluation matches a positive reading on the graph.
...
The statement is False.`
    ...
    sort_order: 140,
    solution_overview:
      "Sign chart on $(-2,1)$, $(1,2)$, and beyond; evaluate $f'(-1)=6$.",
