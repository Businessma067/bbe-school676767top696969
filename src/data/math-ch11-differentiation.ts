 ...
 * Subsections 11.1–11.4 (11.4: Interpreting graphs without algebra, MATH 11.121–11.160).
 * Lovable sync marker: 11.4 one-plane graphs; 40 tasks; graph-only stems.
 */
...
Between $2.5$ and $5$ the curve is below the axis; $x=4$ is in that interval.
...
Left of the marked zero the curve is above the axis.

The statement is True.`,
      `**B.** → True

Right of $x=4$ the curve is below the axis.
...
The largest $f'$ is the top of the hump near $x=1$; at $x=4$ one has $f'=0$.

The statement is True.`,
      `**E.** → True

At $x=0$ the height is near $4$; at $x=6$ the curve is slightly below zero but above $-1$.
...
Four transversal zeros of $f'$ give four local extrema of $f$.

The statement is True.`,
      `**B.** → True

Visually the curve dips below the axis between the middle two zeros.
...
$-$ to $+$ at a zero of $f'$ ⇒ local minimum of $f$.

The statement is True.`,
      `**B.** → True

Sign of $f'$ is negative on the left and positive on the right.
...
Max of $f'$ on the right is near $x=1$; that maximises the upward slope of $f$.
...
The curve falls as $x$ approaches $0$ from the left.

The statement is True.`,
      `**C.** → True

The curve rises as $x$ moves right from $0$.

The statement is True.`,
      `**D.** → True

$f(2)=4\\ln 5\\approx 6.4>2$ — visibly well above $2$ on the scale.
...
Between the marked zeros the curve is below the axis.

The statement is True.`,
      `**B.** → True

Left of $x=1$ the curve is above the axis; just right of $x=1$ it is below. That $+$ to $-$ change is a local maximum of $f$.

The statement is True.`,
      `**C.** → True

Negative to positive at $x=3$ ⇒ local minimum of $f$.
...
Between $1$ and $2$ the curve dips below the axis.
...
At $x=3$ (between $2.5$ and $5$) brown is negative.

The statement is True.`,
      `**B.** → True

Green is negative through much of the middle, including $x=3$.

The statement is True.`,
      `**C.** → True

Extrema of $f'$ occur where $f''=0$; the local max of brown aligns with a green zero.
...
Count axis crossings: brown three times, green twice.
...
Negative $f''$ is about concavity of $f$ / decrease of $f'$, not about whether $f$ decreases. On $(2,4)$ one still has $f'>0$, so $f$ is still increasing there.
...
Negative $P'$ means profit falls as output rises.
...
Four crossings of the brown curve.

The statement is True.`,
      `**B.** → True

A degree drop: three crossings for green.
...
Between the middle zeros brown is below the axis; $x=3$ is there.
...
From the figure, green starts below the axis at $x=0$ (near height $-1$).

The statement is False.`,
      `**C.** → True

Brown crosses near $x=4$ and is negative afterward, including at $x=5$.
...
The value of $P'$ is the instantaneous rate.
...
At $x=2.5$: brown is in $(1,3)$ (negative); green is in $(2,5)$ (negative).
...
At $x=3$, brown sits near $10$ and purple sits lower, near $6$.
...
Positive green means $f''>0$, so $f'$ (brown) is increasing.
...
Local lowest point near $x=1$.

The statement is True.`,
      `**B.** → True

Local highest point near $x=2.5$.

The statement is True.`,
      `**C.** → True

Local lowest point near $x=5$.

The statement is True.`,
      `**D.** → True

Between those turning points the curve rises.
...
Local min of $f$ at $0$ with $f'(0)=0$.
...
$f'(1)$ is the height of the green curve at $x=1$; on the figure that height is about $4$.
...
Both curves are above the axis at $x=2$.

The statement is True.`,
      `**B.** → True

Green has a zero at $x=5$; brown is below the axis near the right.

The statement is True.`,
      `**C.** → True

Read brown's two axis crossings on the shared plane.

The statement is True.`,
      `**D.** → True

Sign of $Q'$ controls monotonicity of $Q$.

The statement is True.`,
      `**E.** → True

On a shared vertical scale, higher curve ⇒ larger derivative value.
...
Both brown and green are below the axis at $x=3$.

The statement is True.`,
      `**B.** → False

If $B<0$, then $A-B=A-(\\text{negative})=A+|B|>A$. The statement wrote $A-|B|$, which is the wrong algebraic reading. Purple is above brown when green is negative — but the formula in the claim is incorrect, so the claim as written is False.

The statement is False.`,
      `**C.** → True

Since $B=A'$, extrema of $A$ sit at zeros of $B$.
...
The statement is True.`
    ...
    sort_order: 139,
    solution_overview:
      "Named curves with $B=A'$; evaluate at $x=3$ and use differentiation alignment.",
...
For $x<-2$, $f'<0$; just after $x=-2$, $f'>0$. The change is $-$ to $+$, so $x=-2$ is a local **minimum** of $f$, not a local maximum.
...
Between the zeros the curve sits above the axis.

The statement is True.`,
      `**B.** → True

A $+$ to $-$ crossing at $x=5$ is a local maximum of $f$.
...
Left of $x=1$ the curve is below the axis.

The statement is True.`,
      `**E.** → True

The largest positive height of $f'$ is $4$ at $x=3$.
...
Sign change $+$ to $-$ at $x=2$.

The statement is True.`,
      `**B.** → True

Sign change $-$ to $+$ at $x=4$.

The statement is True.`,
      `**C.** → True

The curve dips below the axis between the zeros.
...
A local extremum of $f$ needs $f'=0$ (with a sign change). Here $f'(3)\\neq 0$.
...
Local highest point near $x=5$.

The statement is True.`,
      `**C.** → True

The curve climbs between those turning points.

The statement is True.`,
      `**D.** → True

The middle of the climb is the steepest stretch.

The statement is True.`,
      `**E.** → False

An axis crossing is $f=0$, not $f'=0$.
...
Sign change $+$ to $-$ ⇒ local maximum of $P$.

The statement is True.`,
      `**D.** → True

At $x=1$ the height is near $1.9$.

The statement is True.`,
      `**E.** → False

A linear $P'$ means $P$ is quadratic (a parabola), not linear.
...
The hill crosses down through the axis on both sides of the peak.

The statement is True.`,
      `**B.** → True

The hill sits above the axis between its two zeros.

The statement is True.`,
      `**C.** → True

Outside that interval the curve is below the axis.

The statement is True.`,
      `**D.** → True

The top of the hill is at $x=2$ with height near $4$.

The statement is True.`,
      `**E.** → False

A max of $f'$ is where $f$ is steepest, not where $f$ peaks. Peaks of $f$ need zeros of $f'$.
...
The curve stays on or above the axis for $x>0$ in view.

The statement is True.`,
      `**B.** → True

Largest $f'$ is the top of the hump near $x=2$.
...
Clear $-$ to $+$ crossing at $x=4$.

The statement is True.`,
      `**B.** → True

Between $1$ and $4$ the curve is below the axis.

The statement is True.`,
      `**C.** → True

Left of $x=1$ the curve is below the axis as well.

The statement is True.`,
      `**D.** → True

Read the height at $x=2$.

The statement is True.`,
      `**E.** → True

A flat touch without a sign change fails the first-derivative test for a local extremum.
...
The curve stays above the axis.
...
At $x=4$ the height is clearly above $2$.
...
The left endpoint height is near $0.5$.
...
Negative $f''$ ⇒ decreasing $f'$ and concave-down $f$.
...
Peak of brown aligns with a green zero.
...
Zero of $f''$ is about $f'$, not a critical point of $f$. Critical points of $f$ are zeros of brown.
...
Positive green on the left.

The statement is True.`,
      `**C.** → True

Negative green on the right.

The statement is True.`,
      `**D.** → True

Small positive brown ⇒ slow increase of $f$.
...
At $x=1$, brown is near $2$ and green is near $1$.

The statement is True.`,
      `**B.** → True

Brown has crossed below zero; green remains above.

The statement is True.`,
      `**C.** → True

Positive $P'$ ⇒ expanding raises profit.

The statement is True.`,
      `**D.** → True

Positive $C'$ ⇒ increasing $C$.
...
Both curves sit below the axis at $x=0$.

The statement is True.`,
      `**B.** → True

Count the axis crossings of each colour.

The statement is True.`,
      `**C.** → True

Between brown's middle and right zeros the curve is below the axis.

The statement is True.`,
      `**D.** → True

Negative derivatives ⇒ decreasing; less negative ⇒ gentler decrease.

The statement is True.`,
      `**E.** → False

Brown has three zeros and green two, so $f$ and $g$ need not have the same number of turning points.
...
Read both brown and purple at $x=0$.

The statement is True.`,
      `**B.** → True

Extrema of $f'$ align with zeros of $f''$.
...
Brown is above the axis at $x=3$.

The statement is True.`,
      `**B.** → True

Green is below the axis at $x=3$.

The statement is True.`,
      `**C.** → True

Purple is still above the axis at $x=3$.

The statement is True.`,
      `**D.** → True

Brown crosses from $+$ to $-$ near $x=5$.

The statement is True.`,
      `**E.** → False

At $x=3$ already A and C want to expand while B does not.
...
The statement is False.`
    ...
    sort_order: 155,
    solution_overview:
      "Read each colour's sign at $x=3$; opposite signs mean opposite advice.",
...
Critical points of $f$ are zeros of $f'$.
...
Green's peak height near $4$ at $x=3$ matches the steep middle climb of brown.
...
Visible $-$ to $+$ crossing at $x=4$.

The statement is True.`,
      `**B.** → True

Brown does not change from above to below (or below to above) across $x=1$.
...
By construction on the figure, purple tracks brown minus green.

The statement is True.`,
      `**B.** → True

At $x=2$, brown is high and above green.

The statement is True.`,
      `**C.** → True

Brown drops toward/under green on the right; purple goes negative.

The statement is True.`,
      `**D.** → True

Sign change of $P'$ from $+$ to $-$ is a local max of $P$.
...
Green crosses at $x=3$; brown bottoms there.

The statement is True.`,
      `**B.** → True

Negative green on the left of $x=3$.

The statement is True.`,
      `**C.** → True

Purple tracks a parallel lift of brown.
...
Left of the zero the line is above the axis.

The statement is True.`,
      `**B.** → True

Right of the zero the line is below the axis.
