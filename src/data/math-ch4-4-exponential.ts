...
export const MATH_CH4_4_EXPONENTIAL: MathTask[] = [
  {
    ...
    statements: [
      `The equation $2^x = 32$. A clerk claims the unique real solution is an odd integer.`,
      `The equation $2^x = -8$. An examiner claims some real exponent satisfies it.`,
      `The equation $\\log_3 x = 2$. A candidate claims exactly one positive admissible root exists.`,
      `The equation $5^x = -1$. A student claims some real exponent satisfies it.`,
      `The equation $\\left(\\frac{1}{2}\\right)^x = \\frac{1}{8}$. A clerk claims exactly one real exponent works.`,
    ],
...
Decay base $\\frac{1}{2}$ is still one-to-one on $\\mathbb{R}$, so exactly one real exponent works.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $10^{x-1} = 1000$. A student claims exactly one real solution exists.`,
      `The equation $2^{2x} = 2$. A clerk claims exactly one real solution exists.`,
      `The equation $7^x = 0$. An examiner claims some real exponent satisfies it.`,
      `The equation $\\log_5 125 = x$. A candidate claims exactly one real solution exists.`,
      `The equation $3^{2x} = 81$. A student claims more than one distinct real solution exists.`,
    ],
...
Strict monotonicity gives exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $4^{2x} = 8^{x+1}$. A candidate claims exactly one real solution exists.`,
      `The equation $3^{2x} = 3^3$. A student claims exactly one real solution exists.`,
      `The equation $16^x = 4$. A clerk claims some real exponent satisfies it.`,
      `The equation $\\log_2 x = -3$. An examiner claims every admissible root satisfies $0 < x < 1$.`,
      `The equation $2^{3x} = 4^{x+1}$. A candidate claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
Strict monotonicity yields exactly one real root, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $2^{x+1} = 8^{x-1}$. An examiner claims exactly one real solution exists.`,
      `The equation $81 = 3^4$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_2 x = 5$. A student claims the unique real solution is positive.`,
      `The equation $6^x = 216$. A clerk claims exactly one real solution exists.`,
      `The equation $3^{2x} = 81$. An examiner claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
A real solution exists, contradicting the claim of no real solution.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $25^x = 125$. A clerk claims exactly one real solution exists.`,
      `The equation $2^{2x+1} = 32$. An examiner claims exactly one real solution exists.`,
      `The equation $5^{x-2} = \\frac{1}{25}$. A candidate claims the unique real solution is positive.`,
      `The equation $\\log_{10} x = -1$. A student claims exactly one positive admissible root exists.`,
      `The equation $3^x = \\frac{1}{9}$. A clerk claims the unique real solution is negative.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $e^x = 20$. A student claims exactly one real solution exists.`,
      `The equation $e^x = -1$. A clerk claims no real solution exists.`,
      `The equation $e^{2x} = e^6$. An examiner claims more than one distinct real solution exists.`,
      `The equation $\\ln x = 1$. A candidate claims exactly one real solution exists.`,
      `The equation $e^x = 0$. A student claims some real exponent satisfies it.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
There are zero real solutions, not exactly one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $e^{2x-1} = 5$. A candidate claims exactly one real solution exists.`,
      `The equation $2e^x = 10$. A student claims exactly one real solution exists.`,
      `The equation $e^{x+2} = e^{x-1}$. A clerk claims exactly one real solution exists.`,
      `The equation $\\ln(2x) = 0$. An examiner claims exactly one positive admissible root exists.`,
      `The equation $e^{-x} = e^x$. A candidate claims more than one distinct real solution exists.`,
    ],
...
There is exactly one real solution, so the claim of no real solution is false.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2 x = 5$. An examiner claims exactly one positive admissible root exists.`,
      `The equation $\\log_3 x = 2$. A candidate claims the unique real solution is positive.`,
      `The equation $\\log_3(x-1) = 2$. A student claims exactly one real solution exists.`,
      `The equation $\\ln(1-x) = 0$. A clerk claims exactly one real solution exists.`,
      `The equation $\\ln x = 0$. An examiner claims more than one distinct real solution exists.`,
    ],
...
Only one admissible real value exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\ln(x+1) = 2$. A clerk claims exactly one real solution exists.`,
      `The equation $\\ln(2x-1) = 3$. An examiner claims exactly one real solution exists.`,
      `The equation $\\ln(5-x) = \\ln 2$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_2(x-3) = 1$. A student claims more than one distinct real solution exists.`,
      `The equation $\\ln x + \\ln(x-1) = \\ln 12$. A clerk claims exactly one real solution exists.`,
    ],
...
Together these force $x > 1$ for any valid solution.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log a + \\log b = \\log(ab)$. A student claims exactly one positive admissible root exists.`,
      `The equation $\\log(x+2) + \\log(x-1) = 1$. A clerk claims more than one distinct real solution exists.`,
      `The equation $\\ln(x^2) = 0$. An examiner claims exactly one real solution exists.`,
      `The equation $\\log_{10}(x-9) = 1$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_2(x-4) = 3$. A student claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The admissible root is $x = 12$, which is not $\\le 4$.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_5 x = 2$. A candidate claims exactly one positive admissible root exists.`,
      `The equation $\\log_2(x^2 - 1) = 3$. A student claims exactly one real solution exists.`,
      `The equation $\\log_{10} x = 2$. A clerk claims more than one distinct real solution exists.`,
      `The equation $\\ln(x^2) = 2$. An examiner claims exactly one real solution exists.`,
      `The equation $\\log_2 x = \\log_2 8$. A candidate claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
Domain $x > 0$ is satisfied, and the solution is unique.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{\\log_2 x}{\\log_2 4} = 3$. An examiner claims exactly one real solution exists.`,
      `The equation $\\log_3 x = 2$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_4 x = 2$. A student claims exactly one positive admissible root exists.`,
      `The equation $\\ln(e^x) = 2$. A clerk claims exactly one real solution exists.`,
      `The equation $\\log_{10}(0.01) = x$. An examiner claims the unique real solution is negative.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_8 2 = \\frac{1}{3}$. A clerk claims exactly one positive admissible root exists.`,
      `The equation $\\log_{10} x = 2$. An examiner claims exactly one real solution exists.`,
      `The equation $\\log_9 x = \\frac{1}{2}$. A candidate claims exactly one positive admissible root exists.`,
      `The equation $\\log_2 x = 3$. A student claims more than one distinct real solution exists.`,
      `The equation $\\log x + \\log 2 = 1$. A clerk claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one positive admissible root exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2(x-3) = 1$. A student claims exactly one real solution exists.`,
      `The equation $\\ln(5-x) = \\ln 2$. A clerk claims exactly one real solution exists.`,
      `The equation $\\log(x^2) = 1$. An examiner claims more than one distinct real solution exists.`,
      `The equation $\\ln x + \\ln(x-1) = \\ln 12$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_2(x-4) = 3$. A student claims exactly one real solution exists.`,
    ],
...
No value with $x \\le 4$ can satisfy the equation.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $u = 2x - 5 > 0$. A candidate claims exactly one real solution exists.`,
      `The equation $\\sqrt{\\ln(x+4)} = 2$. A student claims exactly one real solution exists.`,
      `The equation $\\ln x = \\pm 2$. A clerk claims exactly one real solution exists.`,
      `The equation $\\ln x = -\\ln x$. An examiner claims exactly one real solution exists.`,
      `The equation $\\ln(2x-5) = 0$. A candidate claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The admissible root exceeds $2$, so no value with $x \\le 2$ works.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2(x-1) + \\log_2(x-3) = 2$. An examiner claims exactly one real solution exists.`,
      `The equation $e^{2x} - 5e^x + 6 = 0$. A candidate claims substituting $u = e^x > 0$ yields two positive values of $u$.`,
      `The equation $\\ln|x| = 0$. A student claims exactly one real solution exists.`,
      `The equation $\\log(x^2 - 1) = 1$. A clerk claims exactly one real solution exists.`,
      `The equation $2^x = 3^{x-1}$. An examiner claims exactly one real solution exists.`,
    ],
...
The function $\\left(\\frac{3}{2}\\right)^x$ is strictly increasing, so exactly one real crossing exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $e^{2x} - 7e^x + 12 = 0$. A clerk claims substituting $u = e^x > 0$ yields two positive values of $u$.`,
      `The equation $3 \\cdot 2^x + 2^{-x} = 5$. An examiner claims exactly one real solution exists.`,
      `The equation $\\log_x 8 = 3$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_4 x = \\frac{\\log_2 x}{2}$. A student claims exactly one real solution exists.`,
      `The equation $\\ln(x^2 - 1) = 1$. A clerk claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Both satisfy the domain, giving exactly two real solutions, not more than two.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $2^{x+1} - 2^x = 16$. A student claims exactly one real solution exists.`,
      `The equation $\\log_3(x+4) = \\log_3(2x-1)$. A clerk claims exactly one real solution exists.`,
      `The equation $e^x - 3e^{-x} = 2$. An examiner claims exactly one real solution exists.`,
      `The equation $5^{2x} = 25^{x-1}$. A candidate claims exactly one real solution exists.`,
      `The equation $\\ln(3x+1) = \\ln 7$. A student claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Also $2 > -\\frac{1}{3}$, giving exactly one admissible root.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2(x+1) + \\log_2(x-1) = 3$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log(x+5) = \\log(2x)$. A student claims exactly one real solution exists.`,
      `The equation $4^x = 2^{x+3}$. A clerk claims exactly one real solution exists.`,
      `The equation $\\ln(x-2) = \\ln(2x-5)$. An examiner claims exactly one real solution exists.`,
      `The equation $10^x = 10^{-x}$. A candidate claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one real solution exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $2^x = 3^x$. An examiner claims exactly one real solution exists.`,
      `A student claims that $\\left(\\frac{1}{2}\\right)^x = \\left(\\frac{1}{3}\\right)^x$ holds for more than one real exponent. A candidate claims that more than one distinct real solution exists.`,
      `The inequality $e^x \\ge x + 1$ shows $e^x - x \\ge 1 > 0$ for every real $x$. A student claims that exactly one real solution exists.`,
      `The equation $f(x) = \\ln x + x - 1$. A clerk claims exactly one real solution exists.`,
      `The equation $\\sqrt{\\ln x} = 1$. An examiner claims exactly one positive admissible root exists.`,
    ],
...
Exactly one admissible root exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2(x-1) + \\log_2(x+1) = 3$. A clerk claims exactly one real solution exists.`,
      `The equation $e^{2x} = 4e^x$. An examiner claims exactly one real solution exists.`,
      `The equation $2 \\cdot 3^x = 54$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_3(2x-1) = 2$. A student claims exactly one real solution exists.`,
      `The equation $\\ln(x^2 - 4) = \\ln 5$. A clerk claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Both $x = 3$ and $x = -3$ satisfy $x^2 - 4 > 0$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_x 8 = 3$. A student claims exactly one real solution exists.`,
      `The equation $\\log_4 x = \\frac{\\log_2 x}{2}$. A clerk claims exactly one real solution exists.`,
      `The equation $2^x = 3^{x-1}$. An examiner claims exactly one real solution exists.`,
      `The equation $e^{2x} - 7e^x + 12 = 0$. A candidate claims substituting $u = e^x > 0$ yields two positive values of $u$.`,
      `The equation $\\log(x^2 - 1) = 1$. A student claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Both $\\pm \\sqrt{11}$ satisfy $|x| > 1$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $3 \\cdot 2^x + 2^{-x} = 5$. A candidate claims exactly one real solution exists.`,
      `The equation $\\ln(x^2 - 1) = 1$. A student claims exactly one real solution exists.`,
      `The equation $\\log_2(x-1) + \\log_2(x-3) = 2$. A clerk claims exactly one real solution exists.`,
      `The equation $5^{2x} = 25^{x-1}$. An examiner claims exactly one real solution exists.`,
      `The equation $e^x - 3e^{-x} = 2$. A candidate claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $u = 3 > 0$ is valid, giving exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\sqrt{\\ln(x+4)} = 2$. An examiner claims exactly one real solution exists.`,
      `The equation $\\ln|x| = 0$. A candidate claims exactly one real solution exists.`,
      `The equation $e^{2x} - 5e^x + 6 = 0$. A student claims substituting $u = e^x > 0$ yields two positive values of $u$.`,
      `The equation $\\log_9 x = \\frac{1}{2}$. A clerk claims exactly one positive admissible root exists.`,
      `The equation $\\log_2(x+1) + \\log_2(x-1) = 3$. An examiner claims more than one distinct real solution exists.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $x = 3$ exceeds $1$, giving exactly one admissible root, not two.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_x 27 = 3$. A clerk claims exactly one real solution exists.`,
      `The equation $\\log_9 x = \\frac{\\log_3 x}{2}$. An examiner claims exactly one real solution exists.`,
      `The equation $2 \\cdot 2^x + 2^{-x} = 3$. A candidate claims exactly one real solution exists.`,
      `The equation $3^{x+1} = 3^{2x-4}$. A student claims exactly one real solution exists.`,
      `The equation $\\log a - \\log b = \\log(a/b)$. A clerk claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one admissible root with $x > 1$ exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $e^{2x} - 9e^x + 20 = 0$. A student claims substituting $u = e^x > 0$ yields two positive values of $u$.`,
      `The equation $5^x = 2^{x+1}$. A clerk claims exactly one real solution exists.`,
      `The equation $\\log_x 16 = 2$. An examiner claims exactly one real solution exists.`,
      `The equation $\\ln(x^2 - 4) = \\ln 5$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_2 x + \\log_8 x = \\frac{4}{3}$. A student claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one positive root exists.`,
  ...
  },
  {
    ...
    statements: [
      `The equation $\\log_x 8 = 3$. A candidate claims exactly one real solution exists.`,
      `The equation $\\log_4 x = \\frac{\\log_2 x}{2}$. A student claims exactly one real solution exists.`,
      `The equation $2^x = 3^{x-1}$. A clerk claims exactly one real solution exists.`,
      `The equation $e^{2x} - 7e^x + 12 = 0$. An examiner claims substituting $u = e^x > 0$ yields two positive values of $u$.`,
      `The equation $3 \\cdot 2^x + 2^{-x} = 5$. A candidate claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
