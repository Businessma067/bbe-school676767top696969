...
Decay base $\\frac{1}{2}$ is still one-to-one on $\\mathbb{R}$, so exactly one real exponent works.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $10^{x-1} = 1000$ has exactly one real solution.`,
      `The equation $4^x = 2$ has exactly one real solution.`,
      `The equation $7^x = 0$ has a real solution.`,
      `The equation $\\log_5 125 = x$ has exactly one real solution.`,
      `The equation $3^{2x} = 81$ has more than one real solution.`,
    ],
...
Strict monotonicity gives exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $4^{2x} = 8^{x+1}$ has exactly one real solution.`,
      `The equation $9^x = 27$ has exactly one real solution.`,
      `The equation $16^x = 4$ has no real solution.`,
      `The equation $\\log_2 x = -3$ has exactly one positive real solution with $0 < x < 1$.`,
      `The equation $2^{3x} = 4^{x+1}$ has more than one real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
Strict monotonicity yields exactly one real root, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $6^x = 216$ has exactly one positive real solution.`,
      `The equation $3^{2x} = 81$ has no real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
A real solution exists, contradicting the claim of no real solution.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\log_{10} x = -1$ has exactly one positive real solution with $0 < x < 1$.`,
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $e^x = -1$ has no real solution.`,
      `The equation $e^{2x} = e^6$ has more than one real solution.`,
      `The equation $\\ln x = 1$ has exactly one positive real solution.`,
      `The equation $e^x = 0$ has exactly one real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
There are zero real solutions, not exactly one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ln(2x) = 0$ has exactly one positive real solution.`,
...
The admissible root is $x = 12$, which is not $\\le 4$.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_5 x = 2$ has exactly one positive real solution.`,
      `The equation $\\log_2(x^2 - 1) = 3$ has exactly two real solutions.`,
      `The equation $\\log_{10} x = 2$ has a solution with $x < 1$.`,
      `The equation $\\ln(x^2) = 2$ has exactly two real solutions.`,
      `The equation $\\log_2 x = \\log_2 8$ has more than one positive real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
Domain $x > 0$ is satisfied, and the solution is unique.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{\\log_2 x}{\\log_2 4} = 3$ has exactly one positive real solution.`,
      `The equation $\\log_3 x = 2$ has no positive real solution with $x > 10$.`,
      `The equation $\\log_4 x = 2$ has exactly one positive real solution.`,
      `The equation $\\ln(e^x) = 2$ has exactly one real solution.`,
      `The equation $\\log_{10}(0.01) = x$ has a positive real solution.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2 x = \\log_8 2$ has exactly one positive real solution.`,
      `The equation $\\log_{10} x = 2$ has exactly one positive real solution.`,
      `The equation $\\log_9 x = \\frac{1}{2}$ has exactly one positive real solution.`,
      `The equation $\\log_2 x = 3$ has a solution with $x < 1$.`,
      `The equation $\\log x + \\log 2 = 1$ has exactly one positive real solution.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one positive admissible root exists.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Every real solution of $\\log(x^2) = 1$ is positive.`,
...
No value with $x \\le 4$ can satisfy the equation.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $(\\ln x)^2 = 4$ has exactly two positive real solutions.`,
...
The admissible root exceeds $2$, so no value with $x \\le 2$ works.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ln|x| = 0$ has exactly two real solutions.`,
      `The equation $\\log(x^2 - 1) = 1$ has exactly two real solutions with $|x| > 1$.`,
...
The function $\\left(\\frac{3}{2}\\right)^x$ is strictly increasing, so exactly one real crossing exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $e^{2x} - 7e^x + 12 = 0$ has exactly two real solutions.`,
      `The equation $3 \\cdot 2^x + 2^{-x} = 5$ has exactly two real solutions.`,
      `The equation $\\log_x 8 = 3$ has exactly one positive real solution with $x \\neq 1$.`,
      `The equation $\\log_2 x + \\log_4 x = 3$ has exactly one positive real solution.`,
      `The equation $\\ln(x^2 - 1) = 1$ has more than two real solutions.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Both satisfy the domain, giving exactly two real solutions, not more than two.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $2^{x+1} - 2^x = 16$ has exactly one real solution.`,
      `The equation $\\log_3(x+4) = \\log_3(2x-1)$ has exactly one real solution with $x > \\frac{1}{2}$.`,
      `The equation $e^x - 3e^{-x} = 2$ has exactly one real solution.`,
      `The equation $5^{2x} = 25^{x-1}$ has no real solution.`,
      `The equation $\\ln(3x+1) = \\ln 7$ has exactly one real solution with $x > -\\frac{1}{3}$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Also $2 > -\\frac{1}{3}$, giving exactly one admissible root.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_2(x+1) + \\log_2(x-1) = 3$ has exactly one real solution with $x > 1$.`,
      `The equation $\\log(x+5) = \\log(2x)$ has exactly one positive real solution.`,
      `The equation $4^x = 2^{x+3}$ has exactly one real solution.`,
      `The equation $\\ln(x-2) = \\ln(2x-5)$ has exactly one real solution.`,
      `The equation $10^x = 10^{-x}$ has exactly one real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one real solution exists.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\left(\\frac{1}{2}\\right)^x = \\left(\\frac{1}{3}\\right)^x$ has more than one real solution.`,
      `The equation $e^x = x$ has no real solution.`,
      `The equation $\\ln x = 1 - x$ has exactly one real solution on $x > 0$.`,
      `The equation $\\sqrt{\\ln x} = 1$ has exactly one real solution.`,
    ],
...
Exactly one admissible root exists.`,
  ...
  },
  {
    ...
    statements: [
      `The equation $\\log_2(x-1) + \\log_2(x+1) = 3$ has exactly one real solution with $x > 1$.`,
      `The equation $e^{2x} = 4e^x$ has exactly one real solution.`,
      `The equation $2 \\cdot 3^x = 54$ has exactly one real solution.`,
      `The equation $\\log_3(2x-1) = 2$ has exactly one real solution with $x > \\frac{1}{2}$.`,
      `The equation $\\ln(x^2 - 4) = \\ln 5$ has exactly two real solutions.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Both $\\pm \\sqrt{11}$ satisfy $|x| > 1$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    statements: [
      `The equation $3 \\cdot 2^x + 2^{-x} = 5$ has exactly two real solutions.`,
      `The equation $\\ln(x^2 - 1) = 1$ has exactly two real solutions.`,
      `The equation $\\log_2(x-1) + \\log_2(x-3) = 2$ has no real solution with $x \\le 3$.`,
      `The equation $5^{2x} = 25^{x-1}$ has no real solution.`,
      `The equation $e^x - 3e^{-x} = 2$ has more than one real solution.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $u = 3 > 0$ is valid, giving exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ln|x| = 0$ has exactly two real solutions.`,
      `The equation $e^{2x} - 5e^x + 6 = 0$ has exactly two real solutions.`,
      `The equation $\\log_9 x = \\frac{1}{2}$ has exactly one positive real solution with $x \\neq 1$.`,
      `The equation $\\log_2(x+1) + \\log_2(x-1) = 3$ has exactly two real solutions with $x > 1$.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $x = 3$ exceeds $1$, giving exactly one admissible root, not two.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\log_x 27 = 3$ has exactly one positive real solution with $x \\neq 1$.`,
      `The equation $\\log_3 x + \\log_9 x = 2$ has exactly one positive real solution.`,
      `The equation $2 \\cdot 2^x + 2^{-x} = 3$ has exactly two real solutions.`,
      `The equation $3^{x+1} = 9^{x-2}$ has exactly one real solution.`,
      `The equation $\\log(x+1) - \\log(x-1) = 1$ has exactly one real solution with $x > 1$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one admissible root with $x > 1$ exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $e^{2x} - 9e^x + 20 = 0$ has exactly two real solutions.`,
      `The equation $5^x = 2^{x+1}$ has exactly one real solution.`,
      `The equation $\\log_x 16 = 2$ has exactly one positive real solution with $x \\neq 1$.`,
      `The equation $\\ln(x^2 - 4) = \\ln 5$ has exactly two real solutions.`,
      `The equation $\\log_2 x + \\log_8 x = \\frac{4}{3}$ has exactly one positive real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
