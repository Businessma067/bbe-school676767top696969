...
export const MATH_CH4_4_EXPONENTIAL: MathTask[] = [
  {
    ...
    statements: [
      `Matching bases in $2^x = 32$ forces $x = 5$ because base $2$ is strictly increasing.`,
...
Decay base $\\frac{1}{2}$ is still one-to-one on $\\mathbb{R}$, so exactly one real exponent works.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Expressing $4^x = 2$ on base $2$ gives $2^{2x} = 2$, hence $x = \\frac{1}{2}$.`,
...
Strict monotonicity gives exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Writing $9^x = 27$ as $3^{2x} = 3^3$ yields $x = \\frac{3}{2}$.`,
...
A real solution exists, contradicting the claim of no real solution.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `On domain $x > 0$, $\\log_{10} x = -1$ corresponds to $x = 0.1$.`,
...
There are zero real solutions, not exactly one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The rule $\\ln(2x) = 0$ with $2x > 0$ forces $x = \\frac{1}{2}$.`,
      `A student claims that $e^{-x} = e^x$ has no real solution.`,
    ],
...
There is exactly one real solution, so the claim of no real solution is false.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `On domain $x > 0$, $\\log_2 x = 5$ converts to $x = 32$.`,
      ...
      `With $1 - x > 0$, the equation $\\ln(1-x) = 0$ forces $x = 0$.`,
...
Only one admissible real value exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `With $x + 1 > 0$, the equation $\\ln(x+1) = 2$ gives $x = e^2 - 1$.`,
...
Together these force $x > 1$ for any valid solution.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ln(x^2) = 0$ gives $x^2 = 1$, producing roots at $x = \\pm 1$.`,
...
The admissible root is $x = 12$, which is not $\\le 4$.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Converting $\\log_5 x = 2$ to exponential form with $x > 0$ gives $x = 25$.`,
      `The equation $\\log_2(x^2 - 1) = 3$ with $|x| > 1$ yields $x = \\pm 3$.`,
      `A student claims that $\\log_{10} x = 2$ is satisfied by some $x < 1$.`,
      `Squaring $\\ln(x^2) = 2$ on domain $x^2 > 0$ gives $x = \\pm e$.`,
...
Domain $x > 0$ is satisfied, and the solution is unique.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `On domain $x > 0$, $\\log_4 x = 2$ converts to $x = 16$.`,
      `Since $\\ln$ and $e^x$ are inverses, $\\ln(e^x) = 2$ forces $x = 2$.`,
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Evaluating $\\log_8 2 = \\frac{1}{3}$ turns $\\log_2 x = \\log_8 2$ into $x = 2^{1/3}$.`,
      `Strict monotonicity of $\\log_{10}$ on $(0,\\infty)$ gives a unique preimage for $\\log_{10} x = 2$.`,
      `Converting $\\log_9 x = \\frac{1}{2}$ gives $x = 3$ on domain $x > 0$.`,
...
No value with $x \\le 4$ can satisfy the equation.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The rule $\\ln u = 0$ with $u = 2x - 5 > 0$ forces $x = 3$.`,
...
The admissible root exceeds $2$, so no value with $x \\le 2$ works.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ln|x| = 0$ gives $|x| = 1$, so $x = \\pm 1$.`,
      `With $|x| > 1$, the equation $\\log(x^2 - 1) = 1$ produces $x = \\pm\\sqrt{11}$.`,
...
Also $2 > -\\frac{1}{3}$, giving exactly one admissible root.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The product rule on $\\log_2(x+1) + \\log_2(x-1) = 3$ with $x > 1$ keeps only $x = 3$ admissible.`,
      ...
      `Dividing $10^x = 10^{-x}$ by $10^x > 0$ gives $10^{2x} = 1$, hence $x = 0$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one real solution exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Dividing $2^x = 3^x$ by $2^x > 0$ gives $\\left(\\frac{3}{2}\\right)^x = 1$, forcing $x = 0$.`,
      ...
      `Squaring $\\sqrt{\\ln x} = 1$ on domain $x > 0$ and $\\ln x \\ge 0$ gives $x = e$.`,
    ],
...
Exactly one admissible root exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The product rule on $\\log_2(x-1) + \\log_2(x+1) = 3$ with $x > 1$ filters to $x = 3$.`,
      `Dividing $e^{2x} = 4e^x$ by $e^x > 0$ isolates $e^x = 4$.`,
      `Dividing $2 \\cdot 3^x = 54$ by $2$ gives $3^x = 27$, hence $x = 3$.`,
...
Both $\\pm \\sqrt{11}$ satisfy $|x| > 1$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    statements: [
      `Letting $u = 2^x > 0$ turns $3 \\cdot 2^x + 2^{-x} = 5$ into a quadratic with two positive roots.`,
      `With $x^2 - 1 > 0$, the equation $\\ln(x^2 - 1) = 1$ gives $x = \\pm\\sqrt{e + 1}$.`,
...
Only $u = 3 > 0$ is valid, giving exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ln|x| = 0$ gives $|x| = 1$, so $x = \\pm 1$.`,
      `Substituting $u = e^x > 0$ in $e^{2x} - 5e^x + 6 = 0$ yields two positive values of $u$.`,
      `Converting $\\log_9 x = \\frac{1}{2}$ gives $x = 3$ on domain $x > 0$ with $x \\neq 1$.`,
