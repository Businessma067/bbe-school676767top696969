...
export const MATH_CH4_4_EXPONENTIAL: MathTask[] = [
  {
    ...
    statements: [
      ...
      `For $2^x = -8$, the equation has two distinct real solutions.`,
      `For $\\log_3 x = 2$, the product of all admissible roots equals $1$.`,
      `For $5^x = -1$, the equation has exactly one real solution.`,
      `For $2^{-x} = 2^{-3}$, the sum of all admissible roots equals $2$.`,
    ],
...
Decay base $\\frac{1}{2}$ is still one-to-one on $\\mathbb{R}$, so exactly one real exponent works.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $4^x = 2$, the equation has exactly one real solution.`,
      `For $7^x = 0$, exactly one admissible root satisfies the equation.`,
...
Strict monotonicity gives exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $3^{2x} = 3^3$, the equation has exactly one real solution.`,
      `For $2^{4x} = 2^2$, exactly one admissible root satisfies the equation.`,
      `For $\\log_2 x = -3$, the equation has exactly one admissible real solution.`,
...
Strict monotonicity yields exactly one real root, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $3^{-x} = 3^4$, the equation has exactly one real solution.`,
      `For $\\log_2 x = 5$, the product of all admissible roots equals $4$.`,
      `For $6^x = 6^3$, the equation has exactly one admissible real solution.`,
...
A real solution exists, contradicting the claim of no real solution.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $2^{2x+1} = 2^5$, the equation has exactly one real solution.`,
...
There are zero real solutions, not exactly one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^{2x-1} = 5$, the sum of all admissible roots equals $2$.`,
      `For $e^x = 5$, the equation has exactly one real solution.`,
...
Only one admissible real value exists.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $\\log_2(x-3) = 1$, the equation has exactly one real solution.`,
      `For $\\log(x(x-1)) = 1$, the sum of all admissible roots equals $1$.`,
    ],
...
Together these force $x > 1$ for any valid solution.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $x - 9 = 10$, the equation has exactly one admissible real solution.`,
...
Exactly one positive admissible root exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log(x-3) = 1$, the sum of all admissible roots equals $1$.`,
      `For $\\ln(5-x) = \\ln 2$, the equation has exactly one real solution.`,
      `For $\\log(x^2) = 1$, the product of all admissible roots equals $4$.`,
      `For $\\log(x(x-1)) = 1$, the equation has exactly one admissible real solution.`,
      `For $\\log_2(x-4) = 1$, the sum of all admissible roots equals $1$.`,
    ],
...
No value with $x \\le 4$ can satisfy the equation.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $2x - 5 = 1$, the sum of all admissible roots equals $2$.`,
...
The admissible root exceeds $2$, so no value with $x \\le 2$ works.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $e^{2x} - 5e^x + 6 = 0$, the equation has exactly one real solution.`,
      `For $\\ln|x| = 0$, the product of all admissible roots equals $1$.`,
      `For $\\log(x^2 - 1) = 1$, exactly one positive admissible root exists.`,
      `For $2^x = 3^{x-1}$, the sum of all admissible roots equals $2$.`,
    ],
...
The function $\\left(\\frac{3}{2}\\right)^x$ is strictly increasing, so exactly one real crossing exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^{2x} - 7e^x + 12 = 0$, the sum of all admissible roots equals $2$.`,
      `For $3 \\cdot 2^x + 2^{-x} = 5$, the equation has exactly one real solution.`,
      `For $x^3 = 8$, the product of all admissible roots equals $2$.`,
      `For $\\log_2 x + \\frac{\\log_2 x}{2} = 3$, exactly one positive admissible root exists.`,
      `For $\\ln(x^2 - 1) = 1$, the sum of all admissible roots equals $4$.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Both satisfy the domain, giving exactly two real solutions, not more than two.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $x + 4 = 2x - 1$, the equation has exactly one real solution.`,
      `For $e^x - 3e^{-x} = 2$, the product of all admissible roots equals $2$.`,
...
Also $2 > -\\frac{1}{3}$, giving exactly one admissible root.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $x + 5 = 2x$, the equation has exactly one real solution.`,
      `For $2^{2x} = 2^{x+3}$, the product of all admissible roots equals $2$.`,
      `For $x - 2 = 2x - 5$, the equation has exactly one admissible real solution.`,
...
Exactly one real solution exists.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $1 = \\left(\\frac{2}{3}\\right)^x$, the equation has two distinct admissible real solutions.`,
      `For $e^x - x = 0$, no real root satisfies the equation.`,
      `For $\\ln x + x - 1 = 0$, the equation has exactly one admissible real solution.`,
...
Exactly one admissible root exists.`,
  ...
  },
  {
    ...
    statements: [
      `For $\\log_2((x-1)(x+1)) = 3$, the sum of all admissible roots equals $1$.`,
      `For $e^{2x} = 4e^x$, the equation has exactly one real solution.`,
      `For $3^x = 3^3$, the product of all admissible roots equals $2$.`,
      `For $2x - 1 = 9$, the equation has exactly one admissible real solution.`,
...
Both $x = 3$ and $x = -3$ satisfy $x^2 - 4 > 0$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $e^{2x} - 7e^x + 12 = 0$, the equation has exactly one admissible real solution.`,
...
Both $\\pm \\sqrt{11}$ satisfy $|x| > 1$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $3 \\cdot 4^x - 5 \\cdot 2^x + 1 = 0$, the sum of all admissible roots equals $2$.`,
      `For $x^2 - 1 = e$, the equation has exactly one real solution.`,
      `For $\\log((x-1)(x-3)) = 1$, the product of all admissible roots equals $1$.`,
      `For $5^{2x} = 5^{2x-2}$, the equation has no real solution.`,
      `For $e^{2x} - 2e^x - 3 = 0$, the sum of all admissible roots equals $5$.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $u = 3 > 0$ is valid, giving exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $e^{2x} - 5e^x + 6 = 0$, the product of all admissible roots equals $2$.`,
      `For $\\log_9 x = \\frac{1}{2}$, the equation has exactly one admissible real solution.`,
...
Only $x = 3$ exceeds $1$, giving exactly one admissible root, not two.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $2 \\cdot 4^x - 3 \\cdot 2^x + 1 = 0$, the product of all admissible roots equals $2$.`,
      `For $3^{x+1} = 3^{2x-4}$, the equation has exactly one admissible real solution.`,
      `For $\\log a - \\log b = \\log(a/b)$, the sum of all admissible roots equals $1$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one admissible root with $x > 1$ exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^{2x} - 9e^x + 20 = 0$, the sum of all admissible roots equals $2$.`,
      ...
      `For $x^2 - 4 = 5$, the equation has exactly one admissible real solution.`,
