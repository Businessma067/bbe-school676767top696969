...
export const MATH_CH4_4_EXPONENTIAL: MathTask[] = [
  {
    ...
    statements: [
      `For $2^x = 2^5$, A clerk claims that precisely one real value of the exponent works.`,
      `For $2^x = -8$, An examiner claims that exactly one real exponent satisfies the equation.`,
      `For $\\log_3 x = 2$, A candidate claims that exactly one positive admissible root exists.`,
      `For $5^x = -1$, A student claims that precisely one real value of the exponent works.`,
      `For $\\left(\\frac{1}{2}\\right)^x = \\frac{1}{8}$, A clerk claims that exactly one real exponent satisfies the equation.`,
    ],
...
Decay base $\\frac{1}{2}$ is still one-to-one on $\\mathbb{R}$, so exactly one real exponent works.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $10^{x-1} = 1000$, A student claims that the equation has exactly one real solution.`,
      `For $2^{2x} = 2$, A clerk claims that precisely one real value of the exponent works.`,
      `For $7^x = 0$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\log_5 125 = x$, A candidate claims that exactly one positive admissible root exists.`,
      `For $3^{2x} = 81$, A student claims that the equation has no real solution.`,
    ],
...
Strict monotonicity gives exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $4^{2x} = 8^{x+1}$, A candidate claims that exactly one real exponent satisfies the equation.`,
      `For $3^{2x} = 3^3$, A student claims that the equation has exactly one real solution.`,
      `For $2^{4x} = 2^2$, A clerk claims that exactly one admissible root satisfies the equation.`,
      `For $\\log_2 x = -3$, An examiner claims that exactly one positive admissible root exists.`,
      `For $2^{3x} = 4^{x+1}$, A candidate claims that more than one real exponent satisfies the equation.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
Strict monotonicity yields exactly one real root, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $2^{x+1} = 8^{x-1}$, An examiner claims that precisely one real value of the exponent works.`,
      `For $3^{-x} = 3^4$, A candidate claims that exactly one real exponent satisfies the equation.`,
      `For $\\log_2 x = 5$, A student claims that no positive admissible root exists.`,
      `For $6^x = 216$, A clerk claims that precisely one real value of the exponent works.`,
      `For $3^{2x} = 81$, An examiner claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
A real solution exists, contradicting the claim of no real solution.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $25^x = 125$, A clerk claims that the equation has exactly one real solution.`,
      `For $2^{2x+1} = 32$, An examiner claims that precisely one real value of the exponent works.`,
      `For $5^{x-2} = \\frac{1}{25}$, A candidate claims that no real exponent satisfies the equation.`,
      `For $\\log_{10} x = -1$, A student claims that exactly one positive admissible root exists.`,
      `For $3^x = \\frac{1}{9}$, A clerk claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^x = 20$, A student claims that exactly one real exponent satisfies the equation.`,
      `For $e^x = -1$, A clerk claims that the equation has no admissible real solution.`,
      `For $e^{2x} = e^6$, An examiner claims that the equation has no real solution.`,
      `For $\\ln x = 1$, A candidate claims that exactly one real exponent satisfies the equation.`,
      `For $e^x = 0$, A student claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
There are zero real solutions, not exactly one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^{2x-1} = 5$, A candidate claims that precisely one real value of the exponent works.`,
      `For $2e^x = 10$, A student claims that exactly one real exponent satisfies the equation.`,
      `For $e^{x+2} = e^{x-1}$, A clerk claims that the equation has no admissible real solution.`,
      `For $x = \\frac{1}{2} > 0$, An examiner claims that precisely one real value of the exponent works.`,
      `For $e^{-x} = e^x$, A candidate claims that the equation has exactly one real solution.`,
    ],
...
There is exactly one real solution, so the claim of no real solution is false.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_2 x = 5$, An examiner claims that exactly one positive admissible root exists.`,
      `For $\\log_3 x = 2$, A candidate claims that the equation has two distinct admissible roots.`,
      `For $\\log_3(x-1) = 2$, A student claims that exactly one positive admissible root exists.`,
      `For $\\ln(1-x) = 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $\\ln x = 0$, An examiner claims that the equation has no real solution.`,
    ],
...
Only one admissible real value exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x + 1 = e^2$, A clerk claims that exactly one real exponent satisfies the equation.`,
      `For $2x - 1 = e^3$, An examiner claims that the equation has exactly one real solution.`,
      `An exponential or logarithmic equation is posed. A candidate claims that the solutions add up to $3$.`,
      `For $\\log_2(x-3) = 1$, A student claims that exactly one real exponent satisfies the equation.`,
...
Together these force $x > 1$ for any valid solution.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log(x(x+3)) = 1$, A student claims that exactly one positive admissible root exists.`,
      `For $\\log(x+2) + \\log(x-1) = 1$, A clerk claims that no positive admissible root exists.`,
      `For $\\ln(x^2) = 0$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\log_{10}(x-9) = 1$, A candidate claims that the product of all admissible roots equals $19$.`,
      `For $\\log_2(x-4) = 3$, A student claims that no positive admissible root exists.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The admissible root is $x = 12$, which is not $\\le 4$.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_5 x = 2$, A candidate claims that exactly one positive admissible root exists.`,
      `For $\\log_2(x^2 - 1) = 3$, A student claims that exactly one positive admissible root exists.`,
      `For $\\log_{10} x = 2$, A clerk claims that no positive admissible root exists.`,
      `For $\\ln(x^2) = 2$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\log_2 x = \\log_2 8$, A candidate claims that the equation has two distinct admissible roots.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
Domain $x > 0$ is satisfied, and the solution is unique.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\dfrac{\\log_2 x}{\\log_2 4} = 3$, An examiner claims that exactly one positive admissible root exists.`,
      `For $\\log_3 x = 2$, A candidate claims that more than one real exponent satisfies the equation.`,
      `For $\\log_4 x = 2$, A student claims that exactly one positive admissible root exists.`,
      `For $\\ln(e^x) = 2$, A clerk claims that exactly one real exponent satisfies the equation.`,
      `For $x = 3^{5}$, An examiner claims that more than one real exponent satisfies the equation.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The unique real solution is negative, not positive.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_2 x = \\frac{1}{3}$, A clerk claims that exactly one positive admissible root exists.`,
      `For $\\log_{10} x = 2$, An examiner claims that exactly one positive admissible root exists.`,
      `For $\\log_9 x = \\frac{1}{2}$, A candidate claims that exactly one positive admissible root exists.`,
      `For $\\log_2 x = 3$, A student claims that no positive admissible root exists.`,
      `For $\\log x + \\log 2 = 1$, A clerk claims that exactly one positive admissible root exists.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one positive admissible root exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_2(x-3) = 1$, A student claims that exactly one positive admissible root exists.`,
      `An exponential or logarithmic equation is posed. A clerk claims that a common-base rewrite reduces it to a linear exponent equation.`,
      `For $\\log(x^2) = 1$, An examiner claims that no positive admissible root exists.`,
      ...
      `For $\\log_2(x-4) = 3$, A student claims that exactly one positive admissible root exists.`,
    ],
...
No value with $x \\le 4$ can satisfy the equation.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $u = 2x - 5 > 0$, A candidate claims that exactly one real exponent satisfies the equation.`,
      `For $\\ln(x+4) = 4$, A student claims that the equation has exactly one real solution.`,
      `For $x = e^2 \\text{ or } x = e^{-2}$, A clerk claims that precisely one real value of the exponent works.`,
      `For $\\ln x = -\\ln x$, An examiner claims that exactly one real exponent satisfies the equation.`,
...
The admissible root exceeds $2$, so no value with $x \\le 2$ works.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_2(x-1) + \\log_2(x-3) = 2$, An examiner claims that exactly one positive admissible root exists.`,
      `For $e^{2x} - 5e^x + 6 = 0$, A candidate claims that exactly one real exponent satisfies the equation.`,
      `For $x = 1 \\text{ or } x = -1$, A student claims that the equation has exactly one real solution.`,
      `For $\\log(x^2 - 1) = 1$, A clerk claims that exactly one positive admissible root exists.`,
      `For $2^x = 3^{x-1}$, An examiner claims that exactly one real exponent satisfies the equation.`,
    ],
...
The function $\\left(\\frac{3}{2}\\right)^x$ is strictly increasing, so exactly one real crossing exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^{2x} - 7e^x + 12 = 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $3 \\cdot 2^x + 2^{-x} = 5$, An examiner claims that precisely one real value of the exponent works.`,
      `For $\\log_x 8 = 3$, A candidate claims that exactly one positive admissible root exists.`,
      `For $\\log_4 x = \\frac{\\log_2 x}{2}$, A student claims that exactly one positive admissible root exists.`,
      `For $\\ln(x^2 - 1) = 1$, A clerk claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Both satisfy the domain, giving exactly two real solutions, not more than two.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $2^{x+1} - 2^x = 16$, A student claims that exactly one real exponent satisfies the equation.`,
      `For $\\log_3(x+4) = \\log_3(2x-1)$, A clerk claims that the sum of all admissible roots equals $5$.`,
      `For $e^x - 3e^{-x} = 2$, An examiner claims that precisely one real value of the exponent works.`,
      `For $5^{2x} = 25^{x-1}$, A candidate claims that the equation has no real solution.`,
      `For $3x + 1 = 7$, A student claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Also $2 > -\\frac{1}{3}$, giving exactly one admissible root.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_2(x+1) + \\log_2(x-1) = 3$, A candidate claims that exactly one positive admissible root exists.`,
      `For $\\log(x+5) = \\log(2x)$, A student claims that exactly one positive admissible root exists.`,
      `For $4^x = 2^{x+3}$, A clerk claims that the equation has exactly one real solution.`,
      `For $x - 2 = 2x - 5$, An examiner claims that precisely one real value of the exponent works.`,
      `For $10^x = 10^{-x}$, A candidate claims that exactly one real exponent satisfies the equation.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one real solution exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $2^x = 3^x$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\left(\\frac{1}{2}\\right)^x = \\left(\\frac{1}{3}\\right)^x$, A candidate claims that the equation has no real solution.`,
      `For $x = 0$, A student claims that the equation has no real solution.`,
      `For $f'(x) = \\frac{1}{x} + 1 > 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $\\ln x = 1$, An examiner claims that precisely one real value of the exponent works.`,
    ],
...
Exactly one admissible root exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_2(x-1) + \\log_2(x+1) = 3$, A clerk claims that exactly one positive admissible root exists.`,
      `For $e^{2x} = 4e^x$, An examiner claims that the equation has exactly one real solution.`,
      `For $2 \\cdot 3^x = 54$, A candidate claims that precisely one real value of the exponent works.`,
      `For $\\log_3(2x-1) = 2$, A student claims that exactly one positive admissible root exists.`,
      `For $\\ln(x^2 - 4) = \\ln 5$, A clerk claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Both $x = 3$ and $x = -3$ satisfy $x^2 - 4 > 0$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_x 8 = 3$, A student claims that exactly one positive admissible root exists.`,
      `For $\\log_4 x = \\frac{\\log_2 x}{2}$, A clerk claims that exactly one positive admissible root exists.`,
      `For $2^x = 3^{x-1}$, An examiner claims that the equation has exactly one real solution.`,
      `For $e^{2x} - 7e^x + 12 = 0$, A candidate claims that precisely one real value of the exponent works.`,
      `For $\\log(x^2 - 1) = 1$, A student claims that exactly one positive admissible root exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Both $\\pm \\sqrt{11}$ satisfy $|x| > 1$, giving exactly two real solutions.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $3 \\cdot 2^x + 2^{-x} = 5$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\ln(x^2 - 1) = 1$, A student claims that precisely one real value of the exponent works.`,
      `For $\\log_2(x-1) + \\log_2(x-3) = 2$, A clerk claims that exactly one positive admissible root exists.`,
      `For $5^{2x} = 25^{x-1}$, An examiner claims that the equation has no admissible real solution.`,
      `For $e^x - 3e^{-x} = 2$, A candidate claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $u = 3 > 0$ is valid, giving exactly one real solution, not more than one.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\ln(x+4) = 4$, An examiner claims that exactly one real exponent satisfies the equation.`,
      `For $x = 1 \\text{ or } x = -1$, A candidate claims that the equation has exactly one real solution.`,
      `For $e^{2x} - 5e^x + 6 = 0$, A student claims that precisely one real value of the exponent works.`,
      `For $\\log_9 x = \\frac{1}{2}$, A clerk claims that exactly one positive admissible root exists.`,
      `For $\\log_2(x+1) + \\log_2(x-1) = 3$, An examiner claims that no positive admissible root exists.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Only $x = 3$ exceeds $1$, giving exactly one admissible root, not two.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\log_x 27 = 3$, A clerk claims that exactly one positive admissible root exists.`,
      `For $\\log_9 x = \\frac{\\log_3 x}{2}$, An examiner claims that exactly one positive admissible root exists.`,
      `For $2 \\cdot 2^x + 2^{-x} = 3$, A candidate claims that the equation has exactly one real solution.`,
      `For $3^{x+1} = 3^{2x-4}$, A student claims that precisely one real value of the exponent works.`,
      `For $\\log\\left(\\frac{x+1}{x-1}\\right) = 1$, A clerk claims that exactly one positive admissible root exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one admissible root with $x > 1$ exists.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $e^{2x} - 9e^x + 20 = 0$, A student claims that the equation has exactly one real solution.`,
      `For $5^x = 2^{x+1}$, A clerk claims that precisely one real value of the exponent works.`,
      `For $\\log_x 16 = 2$, An examiner claims that exactly one positive admissible root exists.`,
      `For $\\ln(x^2 - 4) = \\ln 5$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\log_2 x + \\log_8 x = \\frac{4}{3}$, A student claims that exactly one positive admissible root exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
Exactly one positive root exists.`,
  ...
  },
  {
    ...
    statements: [
      `For $\\log_x 8 = 3$, A candidate claims that exactly one positive admissible root exists.`,
      `For $\\log_4 x = \\frac{\\log_2 x}{2}$, A student claims that exactly one positive admissible root exists.`,
      `For $2^x = 3^{x-1}$, A clerk claims that precisely one real value of the exponent works.`,
      `For $e^{2x} - 7e^x + 12 = 0$, An examiner claims that exactly one real exponent satisfies the equation.`,
      `For $3 \\cdot 2^x + 2^{-x} = 5$, A candidate claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
