...
**3.** f(t*) = $P(t*)e^{-0.09 \\times 18.2222}$ = 1,481,481.48 × $e^{-1.64}$ ≈ \\$287{,}377.84.
...
**4.** f(t*) = 853,333.33 × $e^{-0.075 \\times 21.6667}$ = 853,333.33 × $e^{-1.625}$ ≈ \\$168{,}031.30.
...
**5.** Quarter-20 yield = $a \\times k^{19}$ = 10,000 × 0.681230 = 6,812.33 lbs.
