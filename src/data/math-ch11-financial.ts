...
The overview recovered $i_m=0.60\\%$ as the monthly periodic rate. The claim is that same figure, so the statement is True.`,
...
The claim is about $7.44\\%$, so the statement is True.`,
...
The claim is \\$6,446.54, so the statement is True.`,
...
The claim needs $R_{\\mathrm{ann}} > R$. We have $7.20\\% < 7.44\\%$, so the statement is False.`,
...
The claim needs more than $1.00$ percentage point. We have $0.24 < 1.00$, so the statement is False.`,
    ],
...
The overview recovered $i=2.00\\%$ as the quarterly periodic rate. The claim is that same figure, so the statement is True.`,
      `**B) The number of quarterly periods over 6 years is 24.**  (true)

The overview recovered $nt=24$ as the number of quarterly periods over six years. The claim is that same count, so the statement is True.`,
...
The claim needs more than $65\\%$. We have $60.84\\% < 65\\%$, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 2,
...
The claim is about $6.55\\%$, so the statement is True.`,
...
The claim is about $6.61\\%$, so the statement is True.`,
...
Since $6.61\\% > 6.55\\%$, Offer (ii) is the better choice, so the statement is True.`,
...
Offer (i) compounds more often, but $6.55\\% < 6.61\\%$. Frequency alone does not force the higher effective rate, so the statement is False.`,
...
The claim needs more than \\$660. We have $660.56 > 660$, so the statement is True.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 3,
...
The claim is $22.00\\%$. We have $21.00\\% \\ne 22.00\\%$, so the statement is False.`,
...
The claim needs more than $2.00$ percentage points. We have $2.14 > 2.00$, so the statement is True.`,
...
The claim needs $R>20\\%$. We have $19.56\\% < 20\\%$, so the statement is False.`,
    ],
...
The overview recovered $i=1.40\\%$ as the quarterly periodic rate. The claim is that same figure, so the statement is True.`,
...
The claim is about $5.72\\%$, so the statement is True.`,
...
The claim is \\$15,857.81, so the statement is True.`,
...
The claim needs $R_{\\mathrm{mon}} < R_{\\mathrm{q}}$. We have $5.75\\% > 5.72\\%$, so the statement is False.`,
...
The claim needs more than $0.20$ percentage points. We have $0.12 < 0.20$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 5,
...
The same logarithmic method therefore works for any other target growth multiple, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 6,
...
The claim is about $15.56\\%$, so the statement is True.`,
...
The claim is about $15.87\\%$, so the statement is True.`,
...
The claim is about $16.08\\%$, so the statement is True.`,
...
These satisfy $15.56\\% < 15.87\\% < 16.08\\%$, so the statement is True.`,
...
The claim needs $0.31 < 0.21$. We have $0.31 > 0.21$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 7,
...
The overview recovered $i_m=0.50\\%$ as the monthly periodic rate. The claim is that same figure, so the statement is True.`,
      `**B) The number of monthly compounding periods over 10 years, nt, is 120.**  (true)

The overview recovered $nt=120$ as the number of monthly compounding periods over ten years. The claim is that same count, so the statement is True.`,
...
The claim is \\$7,277.60, so the statement is True.`,
...
Since $1.8194 < 2$, the deposit has not doubled, so the statement is False.`,
...
Monthly compounding gave $S(10) \\approx 7{,}277.60$. The claim needs $7{,}163.39 > 7{,}277.60$. We have $7{,}163.39 < 7{,}277.60$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 8,
...
The claim is about $5.92\\%$, so the statement is True.`,
...
The claim is about $1.48\\%$, so the statement is True.`,
...
The claim needs $r_4 < r_8$. We have $11.92\\% > 5.92\\%$, so the statement is False.`,
...
The claim needs $r_{\\mathrm{mon}} > r_{\\mathrm{q}}$. We have $5.89\\% < 5.92\\%$, so the statement is False.`,
...
The claim needs more than $65\\%$. We have $60\\% < 65\\%$, so the statement is False.`,
    ],
...
The claim needs $R_a > R_b$. We have $10.80\\% < 10.81\\%$, so the statement is False.`,
...
The claim is about $10.81\\%$, so the statement is True.`,
...
Option (b) quotes the lower nominal rate, but $10.81\\% > 10.80\\%$. It is not the cheaper option, so the statement is False.`,
...
The claim needs more than $0.05$ percentage points. We have $0.013 < 0.05$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 10,
...
The claim is about $1.302253$, so the statement is True.`,
...
The claim is \\$30,715.86, so the statement is True.`,
...
The claim needs $S_0 < 32{,}000$. We have $30{,}715.86 < 32{,}000$, so the statement is True.`,
...
The $4.5\\%$ deposit was about \\$30,715.86. The claim needs $S_0' > 30{,}715.86$. We have $29{,}009.83 < 30{,}715.86$, so the statement is False.`,
...
The claim is \\$9,284.14, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 11,
...
The claim is about $81.30$ months, so the statement is True.`,
...
The claim needs $t_{1.5} < \\frac{t_2}{2}$. We have $81.30 > 69.49$, so the statement is False.`,
...
The overview recovered $i \\approx 0.011644\\%$ as the daily periodic rate. The claim is that same figure, so the statement is True.`,
...
The claim is about $4.34\\%$, so the statement is True.`,
...
The claim is \\$20,868.26, so the statement is True.`,
...
The claim needs $R_{\\mathrm{mon}} > R_{\\mathrm{day}}$. We have $4.33\\% < 4.34\\%$, so the statement is False.`,
...
The claim needs more than $0.20$ percentage points. We have $0.09 < 0.20$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 13,
...
The claim is $22.80\\%$, so the statement is True.`,
...
The claim is about $25.34\\%$, so the statement is True.`,
...
The claim needs more than $3.00$ percentage points. We have $2.54 < 3.00$, so the statement is False.`,
    ],
...
The claim is about $10.25\\%$, so the statement is True.`,
...
The claim is about $10.38\\%$, so the statement is True.`,
...
The claim is about $10.47\\%$, so the statement is True.`,
      `**D) Increasing the compounding frequency from semi-annual to quarterly to monthly steadily raises the effective rate.**  (true)
...
These satisfy $10.25\\% < 10.38\\% < 10.47\\%$, so the statement is True.`,
...
The claim needs $0.13 < 0.09$. We have $0.13 > 0.09$, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 15,
...
The claim is about $5.01\\%$, so the statement is True.`,
...
The $80$-year rate is about $5.01\\%$. The claim needs $r_{40} < 5.01\\%$. We have $10.27\\% > 5.01\\%$, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 16,
...
The claim is \\$17,629.99, so the statement is True.`,
...
The claim is \\$17,534.28, so the statement is True.`,
...
The claim needs $S_{0,X} < S_{0,Y}$. We have $17{,}629.99 > 17{,}534.28$, so the statement is False.`,
...
Since $5.20\\% > 5.12\\%$, Account Y's effective annual rate is higher, so the statement is True.`,
...
Account X compounds more often but needs the larger deposit, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 17,
...
Rounded to four decimals this is $1.4827$, so the statement is True.`,
...
The claim is \\$40,467.83, so the statement is True.`,
...
The claim needs $S_0 > 45{,}000$. We have $40{,}467.83 < 45{,}000$, so the statement is False.`,
...
The $4.4\\%$ deposit was about \\$40,467.83. The claim needs $S_0' > 40{,}467.83$. We have $38{,}364.55 < 40{,}467.83$, so the statement is False.`,
...
The claim needs more than \\$20,000. We have $19{,}532.17 < 20{,}000$, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 18,
...
The claim is about $6.49\\%$, so the statement is True.`,
...
CD2 gave $R_2 \\approx 6.55\\%$ as well. The two effective rates agree to two hundredths of a point, so the statement is True.`,
...
CD1 also has the lowest nominal rate, $6.30\\%$. Both the nominal ranking and the effective ranking put CD1 last, so the statement is True.`,
...
The claim is approximately \\$13.61, so the statement is True.`,
    ],
...
The claim is about $76.8$ months, so the statement is True.`,
...
Account Q compounds less often but reaches \\$22,000 sooner, so the statement is False.`,
...
The claim needs $R_M > R_Q$. We have $6.17\\% < 6.29\\%$, so the statement is False.`,
...
The time ratio is about $1.81$, not $2$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 20,
...
The claim is \\$4,730.72, so the statement is True.`,
...
The claim is \\$230.72, so the statement is True.`,
...
The claim is \\$5.72, so the statement is True.`,
...
Rounded to four decimals this is $1.0513$, not $1.0400$, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 21,
...
The claim is approximately \\$5,171.44, so the statement is True.`,
...
The claim needs $S(12)<2\\,S(6)$. We have $8{,}357.43 < 10{,}342.88$, so the statement is True.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 22,
...
The claim is about $9.42\\%$, so the statement is True.`,
...
The claim is \\$16,412.61, so the statement is True.`,
...
The claim needs more than $0.75$ percentage points. We have $0.42 < 0.75$, so the statement is False.`,
...
The claim needs $R_{18} > 2R$. We have $19.72\\% > 18.84\\%$, so the statement is True.`,
...
The claim needs $R_{18}>19.5\\%$. We have $19.72\\% > 19.5\\%$, so the statement is True.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 23,
...
The claim is $1.1000$, so the statement is True.`,
...
The claim is $1.1025$, so the statement is True.`,
...
The claim is about $1.1052$, so the statement is True.`,
...
The claim is \\$250.32. We have $200.32 \\ne 250.32$, so the statement is False.`,
...
The claim needs $187.50 > 200.32$. We have $187.50 < 200.32$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 24,
...
The claim is approximately \\$103,946.56, so the statement is True.`,
...
The claim needs $4{,}372.65 > 4{,}573.91$. We have $4{,}372.65 < 4{,}573.91$, so the statement is False.`,
...
That factor does not change from year to year, so the statement is False.`,
...
The claim is approximately \\$40,219.20, so the statement is True.`,
...
The claim is approximately \\$29,795.12, so the statement is True.`,
...
The claim is about $67.03\\%$, so the statement is True.`,
...
The claim needs $v(4)<25{,}000$. We have $26{,}959.74 > 25{,}000$, so the statement is False.`,
...
The claim needs $5{,}709.75 > 4{,}229.89$. We have $5{,}709.75 > 4{,}229.89$, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 26,
...
The overview recovered $t_2 \\approx 12.60$ years as the doubling time at $5.5\\%$. The claim is that same figure, so the statement is True.`,
...
The claim is approximately \\$36,000.00, so the statement is True.`,
...
The claim is a factor of $6$. We have $8 \\ne 6$, so the statement is False.`,
      `**E) A higher interest rate r gives a longer doubling time.**  (false)

The doubling time $t_2=\\frac{\\ln 2}{r}$ falls when $r$ rises. A higher interest rate shortens the wait, it does not lengthen it, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 27,
...
The overview isolated the time to a $40\\%$ remainder as $t=\\frac{\\ln 2.5}{\\delta}$. The claim is that same isolation, so the statement is True.`,
...
The claim is about $5.09$ years, so the statement is True.`,
...
The claim is approximately \\$48,000.00, so the statement is True.`,
...
The original wait was $t \\approx 5.09$, and $10.18 = 2 \\times 5.09$. The claim is that doubled time, so the statement is True.`,
...
The time to lose $60\\%$ was $t_{60}=\\frac{\\ln 2.5}{0.18} \\approx 5.09$. The claim needs $t_{80}>t_{60}$. We have $8.94 > 5.09$, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 28,
...
The claim is approximately \\$11.36, so the statement is True.`,
...
The claim is approximately \\$295.86, so the statement is True.`,
...
The claim needs a ratio greater than $30$. We have $26.04 < 30$, so the statement is False.`,
...
The claim is approximately \\$111.98, so the statement is True.`,
...
The continuous advantage widens as $t$ grows. The claim needs it to become less advantageous over longer holding periods. We have $111.98 > 11.36$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 29,
...
The claim is approximately \\$439,863.54, so the statement is True.`,
...
The claim needs $S_{\\mathrm{day}}>S_A$. We have $439{,}858.10 < 439{,}863.54$, so the statement is False.`,
...
The claim needs the daily gap to be smaller. We have $5.44 < 164.51$, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 30,
...
The overview recovered $r \\approx 6.67\\%$ as the implied continuous rate. The claim is that same figure, so the statement is True.`,
...
The claim is approximately \\$39,078.52, so the statement is True.`,
...
The claim needs $S(3)>34{,}200$. We have $33{,}522.09 < 34{,}200$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 31,
...
The claim is approximately \\$68,740.91, so the statement is True.`,
...
The claim is approximately \\$68,851.32, so the statement is True.`,
...
The claim is approximately \\$68,932.91, so the statement is True.`,
...
These satisfy $S_X < S_Y < S_Z$. Bank X is the lowest of the three, so the statement is True.`,
...
The claim needs $S_X'>S_Z$. We have $69{,}016.43 > 68{,}932.91$, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 32,
...
The overview recovered $r_{\\mathrm{net}}=7\\%$ as the net continuous growth rate. The claim is $11\\%$. We have $7\\% \\ne 11\\%$, so the statement is False.`,
...
At the original $7\\%$ net rate, $t_2=\\frac{\\ln 2}{0.07}\\approx 9.90$. The wait lengthens from $9.90$ to $12.60$, it does not shorten, so the statement is False.`,
...
Raising the fee lowers $r_{\\mathrm{net}}=r-f$ and therefore lowers $S(t)=S_0 e^{r_{\\mathrm{net}} t}$ at every $t>0$. A higher fee reduces both the net growth rate and the cumulative value, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 33,
...
The overview isolated the crossover as $t=\\frac{\\ln\\bigl(\\frac{B_0}{A_0}\\bigr)}{r_A+\\delta_B}$. The claim is that same isolation, so the statement is True.`,
...
The claim is about $t \\approx 10.06$ years and about \\$74,767.44, so the statement is True.`,
...
The claim needs $A(10)>B(10)$. We have $74{,}591.23 < 75{,}298.55$, so the statement is False.`,
...
After that date $A(t)>B(t)$. Asset A does overtake Asset B, so the statement is False.`,
      `**E) For any time beyond the crossover point, Asset A's value remains higher than Asset B's value.**  (true)

For $t$ larger than the crossover $t_*\\approx 10.06$, the exponent $(r_A+\\delta_B)(t-t_*)$ is positive, so $A(t)>B(t)$ stays in force. Asset A remains ahead after the crossing, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 34,
...
The claim is \\$42,800.00, so the statement is True.`,
...
The claim is about \\$42,874.36 and about \\$42,891.60, so the statement is True.`,
...
These satisfy $S_1 < S_4 < S_{12} < S_{\\mathrm{c}}$, so the statement is True.`,
...
The claim needs $17.24 < 8.73$. We have $17.24 > 8.73$, so the statement is False.`,
...
Every finite $m$ gives $S_m < S_{\\mathrm{c}}$. No schedule can exceed \\$42,900.33 at this same nominal rate, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 35,
...
The claim is approximately \\$69,767.63, so the statement is True.`,
...
The claim is approximately \\$61,878.34, so the statement is True.`,
...
The claim needs $S_{0,2}>S_{0,1}$. We have $61{,}878.34 < 69{,}767.63$, so the statement is False.`,
...
The claim needs $S_0'<S_{0,1}$. We have $83{,}527.02 > 69{,}767.63$, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 36,
...
The claim is approximately \\$2,685,284.46, so the statement is True.`,
...
The claim is approximately \\$3,027,649.77, so the statement is True.`,
...
The claim is about $7.43\\%$, so the statement is True.`,
...
The claim needs $r_* > 7\\%$. We have $7.43\\% > 7\\%$, so the statement is True.`,
...
That equals the original $S(7)$. The year-7 revenue is unchanged, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 37,
...
The claim needs $v_1(6)>v_2(6)$. We have $32{,}000 < 34{,}558.42$, so the statement is False.`,
...
The original implied rate was $16.28\\%$. The claim needs $\\delta'>16.28\\%$. We have $12.56\\% < 16.28\\%$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 38,
...
The claim is about $10.66$ years, so the statement is True.`,
...
The claim is about $16.90$ years, so the statement is True.`,
...
The quadrupling time is about $21.33$ years and equals twice the doubling time, so the statement is True.`,
...
At the quadrupling time the fund is worth exactly \\$48,000.00, so the statement is True.`,
...
The claim is approximately \\$202,478.82, so the statement is True.`,
...
The claim is approximately \\$140,278.19, so the statement is True.`,
...
The original principals sum to $150{,}000+220{,}000+100{,}000=470{,}000$. The claim needs $477{,}742.89 < 470{,}000$. We have $477{,}742.89 > 470{,}000$, so the statement is False.`,
...
The claim needs $B^{+}(5)>340{,}000$. We have $345{,}028.68 > 340{,}000$, so the statement is True.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 40,
...
The overview recovered the one-year discount factor $(1.05)^{-1}\\approx 0.9524$. The claim is that same figure, so the statement is True.`,
      `**B) The PDV of the \\$8,000 bonus is approximately \\$7,619.05.**  (true)

The overview recovered $\\mathrm{PDV}\\approx 7{,}619.05$. The claim is \\$7,619.05, so the statement is True.`,
...
The overview recovered $\\mathrm{PDV}\\approx 7{,}619.05$ at $5\\%$. We have $7{,}272.73<7{,}619.05$, so the statement is False.`,
...
The claim is \\$423.81, so the statement is False.`,
...
The claim is \\$7,500, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 41,
...
The overview recovered the continuous factor $e^{-0.18}\\approx 0.8353$. The claim is that same figure, so the statement is True.`,
      `**B) The PDV of the \\$12,000 payment is approximately \\$10,023.24.**  (true)

The overview recovered $\\mathrm{PDV}\\approx 10{,}023.24$. The claim is \\$10,023.24, so the statement is True.`,
...
The overview recovered the continuous value $\\mathrm{PDV}\\approx 10{,}023.24$ and the annual value $\\mathrm{PDV}_{\\mathrm{ann}}\\approx 10{,}075.43$. We have $10{,}023.24<10{,}075.43$, so the statement is False.`,
...
The overview recovered $\\mathrm{PDV}\\approx 10{,}023.24$ at $3$ years. We have $8{,}372.12<10{,}023.24$, so the statement is True.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 42,
...
The overview recovered the annual factor $(1.07)^{-8}\\approx 0.5820$. The claim is that same figure, so the statement is True.`,
      `**B) The present value under annual compounding is approximately \\$26,190.41.**  (true)

The overview recovered $\\mathrm{PDV}_{\\mathrm{ann}}\\approx 26{,}190.41$. The claim is \\$26,190.41, so the statement is True.`,
      `**C) The present value under continuous compounding is approximately \\$24,900.00.**  (false)

The overview recovered $\\mathrm{PDV}_{\\mathrm{cont}}\\approx 25{,}704.41$. The claim is \\$24,900.00, so the statement is False.`,
...
The claim is \\$650.00, so the statement is False.`,
...
The claim is \\$40,000, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 43,
...
The overview recovered the continuous factor $e^{-0.225}\\approx 0.7985$. The claim is $0.8125$, so the statement is False.`,
      `**B) The practice must deposit approximately \\$119,777.40 today to reach its \\$150,000 goal in 5 years.**  (true)

The overview recovered $A\\approx 119{,}777.40$. The claim is \\$119,777.40, so the statement is True.`,
...
That balance is below \\$150,000, so the statement is False.`,
...
The overview recovered the continuous deposit $A\\approx 119{,}777.40$. We have $120{,}367.66>119{,}777.40$, so the statement is False.`,
...
We have $95{,}644.22\\neq 59{,}888.70$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 44,
...
The overview recovered $\\frac{K}{\\mathrm{PDV}}\\approx 1.3514$. The claim is that same figure, so the statement is True.`,
      `**B) The implied maturity time, assuming annual compounding, is approximately 5.17 years.**  (true)

The overview recovered $t\\approx 5.17$ years under annual compounding. The claim is that same figure, so the statement is True.`,
...
The overview recovered $t\\approx 5.17$ at \\$18,500. We have $3.83<5.17$, so the statement is False.`,
...
The overview recovered $t_{\\mathrm{cont}}\\approx 5.02$ years. The claim is $5.45$ years, so the statement is False.`,
      `**E) The continuous-compounding implied maturity time is longer than the annual-compounding implied maturity time.**  (false)

The overview recovered $t_{\\mathrm{cont}}\\approx 5.02$ and $t\\approx 5.17$. We have $5.02<5.17$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 45,
...
The overview recovered $\\frac{\\mathrm{PDV}}{K}=0.45$. The claim is that same figure, so the statement is True.`,
      `**B) The implied continuous discount rate is approximately 6.65% per year.**  (true)

The overview recovered $r\\approx 6.65\\%$ per year. The claim is that same figure, so the statement is True.`,
...
The claim is \\$40,249.20, so the statement is True.`,
...
The overview recovered $6.65\\%$ at \\$27,000. We have $5.78\\%<6.65\\%$, so the statement is False.`,
...
The claim is $3.33\\%$, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 46,
...
The overview recovered $\\mathrm{PDV}_1\\approx 36{,}281.18$. The claim is \\$36,281.18, so the statement is True.`,
      `**B) The present value of the \\$65,000 payment is approximately \\$50,930.87.**  (true)

The overview recovered $\\mathrm{PDV}_2\\approx 50{,}930.87$. The claim is \\$50,930.87, so the statement is True.`,
      `**C) The combined present value of both payments together is approximately \\$87,212.05.**  (true)

The overview recovered $\\mathrm{PDV}\\approx 87{,}212.05$. The claim is \\$87,212.05, so the statement is True.`,
      `**D) The \\$65,000 payment has a smaller present value than the \\$40,000 payment.**  (false)

The overview recovered $\\mathrm{PDV}_2\\approx 50{,}930.87$ and $\\mathrm{PDV}_1\\approx 36{,}281.18$. We have $50{,}930.87>36{,}281.18$, so the statement is False.`,
...
The claim needs a combined value below \\$86,000. We have $86{,}815.55>86{,}000$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 47,
...
The overview recovered $\\mathrm{PDV}_B\\approx 21{,}410.30$. The claim is \\$21,410.30, so the statement is True.`,
      `**B) Option A has a higher present value than Option B at the 6% rate.**  (true)

Option A is worth \\$22,000 today. The overview recovered $\\mathrm{PDV}_B\\approx 21{,}410.30$. We have $22{,}000>21{,}410.30$, so the statement is True.`,
...
The claim is \\$22,780.00, so the statement is False.`,
      `**D) The present value of Option B exceeds \\$22,000 regardless of which interest rate is used to discount it.**  (false)

The overview recovered $\\mathrm{PDV}_B\\approx 21{,}410.30$ at $6\\%$. That already sits below \\$22,000, so the statement is False.`,
...
The claim is \\$23,500.00, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 48,
...
The overview recovered $t^{*}=23$. The claim is that same figure, so the statement is True.`,
      `**B) The optimal harvest time is found by setting $P'(t^*)$ equal to $P(t^*)$ divided by r.**  (false)

The overview used $P'(t^{*})=rP(t^{*})$. The claim instead sets $P'(t^{*})$ equal to $\\frac{P(t^{*})}{r}$, so the statement is False.`,
      `**C) At the optimal time, the present value of the stand is approximately \\$623,000.**  (false)

The overview recovered $f(23)\\approx 496{,}304.46$. The claim is \\$623,000, so the statement is False.`,
...
The overview recovered $t^{*}=\\frac{2}{r}-2$. Raising $r$ lowers $t^{*}$, so the statement is False.`,
...
The overview recovered $f(23)\\approx 496{,}304.46$. We have $493{,}297.11<496{,}304.46$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 49,
...
The overview recovered $\\mathrm{PDV}_1\\approx 14{,}445.34$. The claim is \\$14,445.34, so the statement is True.`,
      `**B) The present value of the \\$30,000 obligation is approximately \\$18,287.13.**  (true)

The overview recovered $\\mathrm{PDV}_2\\approx 18{,}287.13$. The claim is \\$18,287.13, so the statement is True.`,
      `**C) The combined lump-sum payment the winery should make today is approximately \\$32,732.47.**  (true)

The overview recovered $\\mathrm{PDV}\\approx 32{,}732.47$. The claim is \\$32,732.47, so the statement is True.`,
      `**D) The \\$30,000 obligation contributes a smaller present value than the \\$18,000 obligation.**  (false)

The overview recovered $\\mathrm{PDV}_2\\approx 18{,}287.13$ and $\\mathrm{PDV}_1\\approx 14{,}445.34$. We have $18{,}287.13>14{,}445.34$, so the statement is False.`,
...
The claim is \\$48,000, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 50,
...
The overview recovered $\\mathrm{PDV}\\approx 35{,}234.40$. The claim is \\$33,100.00, so the statement is False.`,
      `**B) The equivalent nominal annual rate that yields the identical present value is exactly 5.00%.**  (false)

The overview recovered $r_a\\approx 5.13\\%$. The claim is $5.00\\%$, so the statement is False.`,
      `**C) The equivalent annual rate is approximately 5.87% per year.**  (false)

The overview recovered $r_a\\approx 5.13\\%$. The claim is $5.87\\%$, so the statement is False.`,
...
The claim is \\$43,035.40, so the statement is True.`,
...
The claim needs a gap above $1.00$ percentage point. We have $0.13<1.00$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 51,
...
The overview recovered $\\mathrm{PV}_1\\approx 35{,}264.01$. The claim is \\$35,264.01, so the statement is True.`,
      `**B) The present value still required from the second receivable is approximately \\$64,735.99.**  (true)

The overview recovered $\\mathrm{PV}_2\\approx 64{,}735.99$. The claim is \\$64,735.99, so the statement is True.`,
      `**C) The required face amount of the second receivable, due in 6 years, is approximately \\$91,829.24.**  (true)

The overview recovered $K_2\\approx 91{,}829.24$. The claim is \\$91,829.24, so the statement is True.`,
...
The overview recovered $K_2\\approx 91{,}829.24$ at $6$ years. We have $77{,}101.60<91{,}829.24$, so the statement is False.`,
...
The claim is \\$102,727.88, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 52,
...
The overview recovered $e^{-0.26}\\approx 0.7711$. The claim is $0.8112$, so the statement is False.`,
      `**B) The future payment that makes the firm indifferent between the two options is approximately \\$49,850.75.**  (false)

The overview recovered $K\\approx 45{,}392.55$. The claim is \\$49,850.75, so the statement is False.`,
...
The claim needs an excess above \\$11,000. We have $10{,}392.55<11{,}000$, so the statement is False.`,
...
The overview recovered $K\\approx 45{,}392.55$ at $4$ years. We have $39{,}858.99<45{,}392.55$, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 53,
...
The overview showed that $P'(t^{*})=rP(t^{*})$ has no solution for $t^{*}>0$, and that $f$ is maximized at $t^{*}=0$. The claim is that same conclusion, so the statement is True.`,
      `**B) The present value of the batch if sold today (t = 0) is \\$40,000.**  (true)

The overview recovered $f(0)=40{,}000$. The claim is \\$40,000, so the statement is True.`,
...
The claim is \\$29,632.73, so the statement is True.`,
...
The overview recovered $f(t)=40{,}000e^{-0.03t}$, which falls as $t$ rises even though $P(t)$ itself is increasing. Waiting therefore lowers present value at this $8\\%$ rate, so the statement is False.`,
...
This rises with $t$, so the optimum is not $t^{*}=0$, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 54,
...
The overview checked $0.09\\times 520{,}000=46{,}800$, which matches $P'(t^{*})$. The first-order condition holds, so the statement is True.`,
      `**B) The value of $P''(t^*) - r P'(t^*)$ is -\\$1,092.**  (true)

The overview recovered $P''(t^{*})-rP'(t^{*})=-1{,}092$. The claim is that same figure, so the statement is True.`,
      `**C) $\\frac{dt^*}{dr}$ is approximately -476.19.**  (true)

The overview recovered $\\frac{dt^{*}}{dr}\\approx -476.19$. The claim is that same figure, so the statement is True.`,
      `**D) An increase in the interest rate would lengthen the optimal harvest time $t^*$.**  (false)

The overview recovered $\\frac{dt^{*}}{dr}\\approx -476.19<0$. A higher $r$ therefore shortens $t^{*}$, so the statement is False.`,
      `**E) The second-order condition $P''(t^*) - r P'(t^*) < 0$ is satisfied here.**  (true)

The overview recovered $P''(t^{*})-rP'(t^{*})=-1{,}092<0$. The second-order condition holds, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 55,
...
The overview recovered $t^{*}\\approx 18.22$. The claim is that same figure, so the statement is True.`,
...
The claim is \\$250,000.00, so the statement is False.`,
      `**C) The second-order quantity $P''(t^*) - r P'(t^*)$ evaluates to +\\$6,000.**  (false)

The overview recovered $P''(t^{*})-rP'(t^{*})=-6{,}000$. The claim is +\\$6,000, so the statement is False.`,
...
The claim is $+246.91$, so the statement is False.`,
...
The overview recovered $\\mathrm{PV}_1\\approx 189{,}893.03$. The claim is \\$189,893.03, so the statement is True.`,
      `**B) The present value of the \\$40,000 side payment is approximately \\$37,513.95.**  (true)

The overview recovered $\\mathrm{PV}_2\\approx 37{,}513.95$. The claim is \\$37,513.95, so the statement is True.`,
      `**C) The combined present value of both payments is approximately \\$230,000.00.**  (false)

The overview recovered $\\mathrm{PDV}\\approx 227{,}406.98$. The claim is \\$230,000.00, so the statement is False.`,
...
The claim needs a haircut above $10\\%$. We have $6.2\\%<10\\%$, so the statement is False.`,
...
The claim is \\$290,000, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 57,
...
The overview recovered $\\frac{\\mathrm{PDV}}{K}=0.625$. The claim is that same figure, so the statement is True.`,
      `**B) The implied continuous discount rate is approximately 10.44% per year.**  (true)

The overview recovered $r\\approx 10.44\\%$ per year. The claim is that same figure, so the statement is True.`,
...
The overview recovered $10.44\\%$ at \\$3,200,000. We have $13.06\\%>10.44\\%$, so the statement is True.`,
...
The overview recovered $10.44\\%$ at $4.5$ years. We have $15.67\\%>10.44\\%$, so the statement is False.`,
...
The claim is $5.22\\%$, so the statement is True.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 58,
...
The overview recovered $t^{*}=\\frac{2}{r}-k$. The claim is that same formula, so the statement is True.`,
      `**B) Using A = 1,200, k = 5, and r = 7.5%, the optimal harvest time is approximately $t^* = 21.67$ years.**  (true)

The overview recovered $t^{*}\\approx 21.67$ at $A=1{,}200$, $k=5$, and $r=7.5\\%$. The claim is that same figure, so the statement is True.`,
...
The claim is \\$195,500.00, so the statement is False.`,
...
The overview's original time is $t^{*}\\approx 21.67$. We have $18.67<21.67$, so the statement is True.`,
...
Half of the original $21.67$ is $10.83$. We have $8.33<10.83$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 59,
...
The overview recovered $e^{-0.4}\\approx 0.6703$. The claim is that same figure, so the statement is True.`,
      `**B) The discount factor for the 10-year payment is approximately 0.4493.**  (true)

The overview recovered $e^{-0.8}\\approx 0.4493$. The claim is that same figure, so the statement is True.`,
      `**C) The present value of the \\$30,000 payment is approximately \\$21,500.00.**  (false)

The overview recovered $\\mathrm{PV}_1\\approx 20{,}109.60$. The claim is \\$21,500.00, so the statement is False.`,
      `**D) The present value of the \\$55,000 payment is approximately \\$26,000.00.**  (false)

The overview recovered $\\mathrm{PV}_2\\approx 24{,}713.09$. The claim is \\$26,000.00, so the statement is False.`,
      `**E) The combined present value the investor should pay today for both payments is approximately \\$47,500.00.**  (false)

The overview recovered $\\mathrm{PDV}\\approx 44{,}822.69$. The claim is \\$47,500.00, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 60,
...
The claim is \\$55.00 million, so the statement is True.`,
...
The claim is about \\$73.21 million, so the statement is True.`,
      `**C) The total revenue expected over the 5-year period is approximately \\$305.26 million.**  (true)

The overview recovered $s_5 \\approx 305.26$ as the five-year total. The claim is that same figure, so the statement is True.`,
...
The claim is an extra of exactly \\$60.00 million. The extra is \\$55.26 million, so the statement is False.`,
      `**E) The total revenue expected over the 5-year period is approximately \\$328.86 million.**  (false)

The overview recovered $s_5 \\approx 305.26$. The claim is about \\$328.86 million. Those totals disagree, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 61,
...
The overview recovered $|k|=0.5<1$, so the infinite profit series converges to a finite sum. The claim is that same test, so the statement is True.`,
      `**B) The infinite sum of all future monthly profits is \\$4,000.00.**  (true)

The overview recovered $s_{\\infty}=4{,}000$. The claim is \\$4,000.00, so the statement is True.`,
      `**C) The sum of just the first 4 months' profits is \\$3,750.00.**  (true)

The overview recovered $s_4=3{,}750$. The claim is \\$3,750.00, so the statement is True.`,
...
The four-month sum does not exceed the infinite sum, so the statement is False.`,
...
so the infinite geometric formula does not apply. The terms $2{,}000$, $3{,}000$, $4{,}500$, $\\ldots$ grow without bound, and the partial sums diverge. Plugging into $\\frac{a}{1-k}$ would give $-4{,}000$, but that algebraic extension is not a sum of profits. The series does not converge, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 62,
...
The overview recovered $|k|=0.90<1$, so the infinite deposit series converges. The claim is that same test, so the statement is True.`,
      `**B) The infinite sum of all deposits is \\$8,000.00.**  (true)

The overview recovered $s_{\\infty}=8{,}000$. The claim is \\$8,000.00, so the statement is True.`,
      `**C) The sum of the first 10 deposits is approximately \\$5,210.57.**  (true)

The overview recovered $s_{10}\\approx 5{,}210.57$. The claim is that same ten-deposit total, so the statement is True.`,
...
The claim is about $65\\%$, so the statement is True.`,
...
so the convergence test fails. Growing deposits of \\$800, \\$880, \\$968, $\\ldots$ have partial sums that run to infinity. The series diverges, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 63,
...
The claim is $60$ years, so the statement is True.`,
...
The claim is $36$ years, so the statement is True.`,
...
The overview already identified constant extraction as the $k=1$ case, where the $n$-year total is $an$. The claim is that identity, so the statement is True.`,
...
The overview recovered $s_{10}\\approx 3{,}773{,}368$ tons under $5\\%$ growth. The claim is about $3{,}900{,}000$ tons. Those totals disagree, so the statement is False.`,
...
The extra is not more than $1{,}000{,}000$ tons, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 64,
...
The claim is $174.6$ million tons, so the statement is True.`,
      `**B) The infinite total extracted over all future years, under the 3% decline, is 6,000 million tons.**  (true)

The overview recovered $s_{\\infty}=6{,}000$ under the $3\\%$ decline. The claim is $6{,}000$ million tons, so the statement is True.`,
      `**C) The reserves will never be fully exhausted, leaving 3 billion tons as permanently “stranded assets.”**  (true)

The overview recovered an infinite extraction of $6{,}000$ million tons against a reserve of $9{,}000$ million tons, leaving $3{,}000$ million tons stranded. The claim is that $3$ billion tons remain unmined, so the statement is True.`,
...
The overview recovered $3{,}000$ million tons stranded under the $3\\%$ decline. A $5\\%$ decline strands more coal, not less, so the statement is False.`,
...
The overview recovered $s_{\\infty}=6{,}000$. Since $2{,}737.3<6{,}000$, the $20$-year total does not exceed the infinite total, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 65,
...
The overview recovered $|k|=0.5<1$, so the alternating adjustment series converges to a finite sum. The claim is that same test, so the statement is True.`,
      `**B) The infinite sum of all adjustments is approximately \\$2,666.67.**  (true)

The overview recovered $s_{\\infty}\\approx 2{,}666.67$. The claim is that same infinite sum, so the statement is True.`,
...
The claim is \\$3,000.00. The four-term sum is \\$2,500.00, so the statement is False.`,
      `**D) The series necessarily diverges regardless of its magnitude.**  (false)

The overview recovered $|k|=0.5<1$, so this series converges. A negative quotient does not force divergence: the test uses $|k|$, not the sign of $k$. The claim says the series necessarily diverges, so the statement is False.`,
...
Odd $n$ returns \\$4,000 and even $n$ returns \\$0, forever. The claim is that oscillation, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 66,
...
The equal-payment plan is the $k=1$ case already written in the overview, so the $15$-year total is $a\\times n$. The claim is that identity, so the statement is True.`,
      `**B) The total contributions over the 15 years of equal \\$12 million payments equal \\$180.00 million.**  (true)

The overview recovered $s_{15}=180$ under equal payments. The claim is \\$180.00 million, so the statement is True.`,
      `**C) Under the 4%-growth alternative, the 15-year total is approximately \\$240.11 million.**  (false)

The overview recovered a growing $15$-year total of about \\$240.28 million. The claim is about \\$240.11 million. Those totals disagree, so the statement is False.`,
...
The extra is not more than \\$65.00 million, so the statement is False.`,
...
so that formula is undefined. The equal-payment case must use $s_n=an$ instead. The claim is that division by zero, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 67,
...
The claim is \\$13,200.00, so the statement is True.`,
      `**B) The total of the 8 finite payments is approximately \\$80,045.68.**  (true)

The overview recovered $s_8\\approx 80{,}045.68$. The claim is that same eight-payment total, so the statement is True.`,
      `**C) If the payments continued forever under the same 88% quotient, the infinite total would be \\$130,000.00.**  (false)

The overview recovered $s_{\\infty}=125{,}000$. The claim is \\$130,000.00. Those totals disagree, so the statement is False.`,
...
The eight-payment total is not more than $75\\%$ of the infinite total, so the statement is False.`,
...
The overview recovered \\$125,000 at $k=0.88$. Since $300{,}000>125{,}000$, a less steep decline makes the infinite total larger, not smaller, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 68,
...
The finite-sum formula needs $k\\ne 1$. Here $k=1.08\\ne 1$, so $s_{12}$ is well-defined. The claim is that this $12$-year total exists, so the statement is True.`,
      `**B) The total royalties collected over the 12 years are approximately \\$175,000.00.**  (false)

The overview recovered $s_{12}\\approx 170{,}794.15$. The claim is about \\$175,000.00. Those totals disagree, so the statement is False.`,
...
so that formula does not apply, and a growing royalty stream has no finite infinite total. The claim treats the infinite formula as legitimate, so the statement is False.`,
...
The claim is about \\$20,715.85. The year-$12$ royalty is about \\$20,984.75, so the statement is False.`,
...
The claim is that the flat total sits \\$62,794.15 below the growing total, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 69,
...
The overview recovered $s_6=39.72$. The claim is about \\$39.72 million, so the statement is True.`,
      `**B) Year-6 revenue alone is approximately \\$9.95 million.**  (true)

The overview recovered $a_6\\approx 9.95$. The claim is about \\$9.95 million, so the statement is True.`,
      `**C) The finite 6-year series has no valid sum via the finite-sum formula.**  (false)

The finite-sum formula needs $k\\ne 1$. Here $k=1.20\\ne 1$, so $s_6$ is well-defined. The claim says the six-year series has no valid finite sum, so the statement is False.`,
...
The claim is about \\$66.36 million, so the statement is True.`,
...
The combined value is not less than \\$100 million, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 70,
...
The claim is \\$1,150.00, so the statement is True.`,
      `**B) Solving for the first-month cost gives approximately \\$6,625.74.**  (true)

The overview recovered $a\\approx 6{,}625.74$. The claim is that same first-month cost, so the statement is True.`,
...
The claim is about \\$13,326.73, so the statement is True.`,
...
The claim is about \\$37,930.00. The three-month total is about \\$34,992.12, so the statement is False.`,
...
The overview recovered $a\\approx 6{,}625.74$. Since $9{,}666.67>6{,}625.74$, the flat monthly figure exceeds the growing first-month cost, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 71,
...
The claim is \\$490,000.00, so the statement is True.`,
      `**B) The infinite total of all future payouts converges to \\$25,000,000.00.**  (true)

The overview recovered $s_{\\infty}=25{,}000{,}000$. The claim is \\$25,000,000.00, so the statement is True.`,
      `**C) The cumulative payout over just the first 10 years is approximately \\$4,800,000.00.**  (false)

The overview recovered $s_{10}\\approx 4{,}573{,}179.83$. The claim is about \\$4,800,000.00. Those totals disagree, so the statement is False.`,
...
The claim is about $18\\%$, so the statement is True.`,
...
The steeper-decline total is not more than half of \\$25,000,000, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 72,
...
The claim is \\$224,000.00, so the statement is True.`,
...
nine years remain below the target, so the statement is True.`,
      `**C) The cumulative spend after 10 years is approximately \\$3,600,000.00.**  (false)

The overview recovered $s_{10}\\approx 3{,}509{,}747.01$. The claim is about \\$3,600,000.00. Those totals disagree, so the statement is False.`,
      `**D) The smallest n for which cumulative spend surpasses \\$3,000,000 is n = 9.**  (false)

The overview recovered $s_9\\approx 2{,}955{,}131.26$ still below \\$3,000,000 and $s_{10}\\approx 3{,}509{,}747.01$ already above it. The smallest such $n$ is therefore $10$, not $9$, so the statement is False.`,
...
The ten-year total still misses the target, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 73,
...
The claim is \\$48,000.00, so the statement is True.`,
      `**B) The infinite total of all future grants is \\$1,250,000.00.**  (true)

The overview recovered $s_{\\infty}=1{,}250{,}000$. The claim is \\$1,250,000.00, so the statement is True.`,
      `**C) The total of the first 15 grants is approximately \\$572,392.03.**  (true)

The overview recovered $s_{15}\\approx 572{,}392.03$. The claim is that same fifteen-grant total, so the statement is True.`,
...
The first $15$ grants are not less than $40\\%$ of the infinite total, so the statement is False.`,
...
The steeper-decline total is less than half of \\$1,250,000, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 74,
...
The claim is $9{,}800.00$ lbs, so the statement is True.`,
      `**B) The total yield over the full 5-year span is approximately 166,196.01 lbs.**  (true)

The overview recovered $s_{20}=166{,}196.01$ as the $20$-quarter, five-year total. The claim is that same yield, so the statement is True.`,
...
That figure is the first five quarters, not five years. Five years are $20$ quarters, whose total the overview recovered as $166{,}196.01$ lbs. Using $n=5$ is not the correct five-year total, so the statement is False.`,
...
The claim is about $6{,}812.33$ lbs, so the statement is True.`,
...
The overview recovered $s_{20}=166{,}196.01$. Since $500{,}000>166{,}196.01$, the infinite total is larger than the $20$-quarter total, not smaller, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 75,
...
The overview recovered $s_{A,8}\\approx 791{,}797.43$. The claim is that same eight-year total, so the statement is True.`,
      `**B) Territory B's 8-year total royalties are approximately \\$815,382.06.**  (true)

The overview recovered $s_{B,8}\\approx 815{,}382.06$. The claim is that same eight-year total, so the statement is True.`,
...
Territory A's total does not exceed Territory B's total, so the statement is False.`,
...
Territory A's year-$8$ payment exceeds Territory B's, so the statement is True.`,
...
The lead is not more than \\$30,000, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 76,
...
The claim is about \\$650.00. The fourth benefit is \\$625.00, so the statement is False.`,
...
so $\\sum \\frac{5{,}000}{n^{1.5}}$ converges to a finite total. The claim is that convergence, so the statement is True.`,
...
The test requires $p>1$, and $1>1$ is false, so the series diverges. There is no finite total to compare with the $p=1.5$ case, so the statement is False.`,
...
so the named term \\$5.00 is correct. Terms tending to $0$ is necessary for convergence, not sufficient. The harmonic case $p=1$ also has $a_n\\to 0$ and still diverges. One small term does not guarantee a finite sum, so the statement is False.`,
...
so $\\sum \\frac{5{,}000}{n^{0.5}}$ diverges by the $p$-series test, even though $a_n\\to 0$. The claim is that divergence, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 77,
...
The overview recovered $s_{R,12}\\approx 1{,}902{,}375.45$. The claim is that same $12$-year revenue total, so the statement is True.`,
      `**B) The cumulative 12-year maintenance cost is approximately \\$1,703,043.55.**  (true)

The overview recovered $s_{C,12}\\approx 1{,}703{,}043.55$. The claim is that same $12$-year maintenance total, so the statement is True.`,
      `**C) The cumulative 12-year profit is approximately \\$199,331.90.**  (true)

The overview recovered $\\Pi_{12}=199{,}331.90$. The claim is about \\$199,331.90, so the statement is True.`,
...
Revenue still exceeds maintenance in year $12$ by about \\$1,242.19, so the statement is True.`,
...
The overview recovered $\\Pi_{12}=199{,}331.90$. Since $78{,}405.66<199{,}331.90$, the $20$-year profit sits below the $12$-year profit, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 78,
...
The overview recovered $s_{\\infty}=40{,}000{,}000$ under the recession scenario. The claim is \\$40,000,000.00, so the statement is True.`,
...
The overview recovered $s_{15}\\approx 24{,}188{,}328.05$ for the first $15$ recession years. The claim is about \\$22,000,000.00. Those totals disagree, so the statement is False.`,
...
The claim is about $75\\%$. The share is not $75\\%$, so the statement is False.`,
...
The overview recovered a recession infinite total of \\$40,000,000. Since $20{,}145{,}210.36<40{,}000{,}000$, the seven-year recovery total does not exceed the infinite recession total, so the statement is False.`,
...
The claim is about \\$2,900,000.00. Year-$7$ cash flow is about \\$3,404,445.87, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 79,
...
The overview recovered $s_1=225{,}000$ for the equal-coupon tranche. The claim is \\$225,000.00, so the statement is True.`,
      `**B) Tranche 2 totals approximately \\$215,603.80.**  (true)

The overview recovered $s_2\\approx 215{,}603.80$ for the growing tranche. The claim is that same nine-year total, so the statement is True.`,
      `**C) Tranche 3, valued as an infinite declining perpetuity, totals \\$375,000.00.**  (true)

The overview recovered $s_3=375{,}000$ for the declining perpetuity. The claim is \\$375,000.00, so the statement is True.`,
...
The claim excludes Tranche 3 and stops at \\$440,603.80. The combined portfolio is \\$815,603.80, so the statement is False.`,
...
so the named term \\$10.00 is correct. The full stream is $1{,}000$ times the harmonic series, and $p=1$ fails the $p$-series test $p>1$. Terms tending to $0$ do not guarantee convergence, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 80,
...
The overview recovered $x\\approx 4{,}081.49$ as the required deposit today. The claim is that same figure, so the statement is True.`,
...
The claim needs $4{,}319.19 < 4{,}081.49$. We have $4{,}319.19 > 4{,}081.49$, so the statement is False.`,
...
The claim is \\$928.51. We have $918.51 \\ne 928.51$, so the statement is False.`,
...
The claim is \\$8,162.98, so the statement is True.`,
...
The overview recovered $F(5)\\approx 8{,}698.47$ as the five-year balance. The claim is that same figure, so the statement is True.`,
...
The claim is \\$2,198.47, so the statement is True.`,
...
The claim needs $2{,}942.04 < 2{,}198.47$. We have $2{,}942.04 > 2{,}198.47$, so the statement is False.`,
...
The overview recovered $F_6\\approx 13{,}603.84$ as the six-year future value. The claim is that same figure, so the statement is True.`,
...
The claim is \\$1,703.84. We have $1{,}603.84 \\ne 1{,}703.84$, so the statement is False.`,
...
The claim is \\$18,230.45. We have $10{,}151.40 \\ne 18{,}230.45$, so the statement is False.`,
...
The claim needs $F_{12} < 27{,}207.68$. We have $31{,}834.24 > 27{,}207.68$, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 83,
...
The overview recovered $F_{10}\\approx 50{,}702.97$ as the ten-year future value. The claim is that same figure, so the statement is True.`,
...
The claim is \\$15,702.97, so the statement is True.`,
...
The claim needs $F_{20} < 101{,}405.94$. We have $160{,}166.87 > 101{,}405.94$, so the statement is False.`,
...
The claim needs $15{,}702.97 > 35{,}000$. We have $15{,}702.97 < 35{,}000$, so the statement is False.`,
...
The claim needs $F_{10}^{10\\%} > 55{,}000$. We have $55{,}780.97 > 55{,}000$, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 84,
...
The overview recovered $P_{15}=25{,}775.15$ as the required deposit today. The claim is that same figure, so the statement is True.`,
...
The overview recovered $P_{15}=25{,}775.15$. Then $36{,}000 > 25{,}775.15$, so the statement is True.`,
...
The claim needs $23{,}309.40 > 25{,}775.15$. We have $23{,}309.40 < 25{,}775.15$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 85,
...
The overview recovered $P_{20}=57{,}349.67$ as the 20-year present value. The claim is that same figure, so the statement is True.`,
...
The claim is that same gap, so the statement is True.`,
...
The claim needs a share above $95\\%$. We have $90.28\\% < 95\\%$, so the statement is False.`,
...
The claim is that same limit, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 86,
...
The overview recovered $P_9=16{,}288.18$ as Option 2's present-value cost. The claim is that same figure, so the statement is True.`,
...
The claim needs $18{,}588.31 < 16{,}288.18$. We have $18{,}588.31 > 16{,}288.18$, so the statement is False.`,
...
The claim is \\$4,600. We have $4{,}500 \\ne 4{,}600$, so the statement is False.`,
...
The claim needs $F>34{,}000$. We have $33{,}092.26 < 34{,}000$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 87,
...
The overview recovered $F_A=19{,}126.18$ as Strategy A's eight-year balance. The claim is that same figure, so the statement is True.`,
      `**B) Strategy B's future value after 8 years is approximately \\$14,856.46.**  (false)

The overview recovered $F_B=13{,}856.46$ as Strategy B's eight-year balance. The claim is \\$14,856.46. We have $13{,}856.46 \\ne 14{,}856.46$, so the statement is False.`,
...
The claim needs $11{,}200 > 12{,}000$. We have $11{,}200 < 12{,}000$, so the statement is False.`,
...
The claim needs $F_B' < 19{,}126.18$. We have $14{,}846.20 < 19{,}126.18$, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 88,
...
The overview recovered $F_{\\mathrm{due}}=21{,}426.05$ as the year-6 due future value. The claim is that same figure, so the statement is True.`,
...
The overview recovered $F_{\\mathrm{due}}=F_{\\mathrm{ordinary}}(1+r)$. That factor is one extra period of growth, and it does not use $n$. The claim is that same identity, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 89,
...
The overview recovered $P_{\\mathrm{due}}=107{,}162.61$ as the lease's present value today. The claim is that same figure, so the statement is True.`,
...
The claim is \\$7,065.81. We have $6{,}065.81 \\ne 7{,}065.81$, so the statement is False.`,
...
That matches the recovered $P_{\\mathrm{due}}=107{,}162.61$ within rounding, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 90,
...
The overview recovered $V=166{,}666.67$ as the perpetuity's value at the end of year 4. The claim is that same figure, so the statement is True.`,
      `**B) Discounting this year-4 value back 4 years to today at 6% gives a present value of approximately \\$132,015.61.**  (true)

The overview recovered $PV_0=132{,}015.61$ as today's present value of that year-4 fund. The claim is that same figure, so the statement is True.`,
...
The claim needs $166{,}666.67 < 132{,}015.61$. We have $166{,}666.67 > 132{,}015.61$, so the statement is False.`,
...
The claim needs $PV_0' < 66{,}007.81$. We have $104{,}568.80 > 66{,}007.81$, so the statement is False.`,
...
The claim is $0.8321$. We have $0.7921 \\ne 0.8321$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 91,
...
The overview recovered $P\\approx 60.71$ as the fair value per share. The claim is that same figure, so the statement is True.`,
...
The claim needs the stock to be undervalued. We have $65.00 > 60.71$, so the statement is False.`,
...
The claim is \\$116.25. We have $106.25 \\ne 116.25$, so the statement is False.`,
...
The claim needs an increase of more than $75\\%$. We have exactly $75\\%$, so the statement is False.`,
...
The claim is \\$50.57. We have $48.57 \\ne 50.57$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 92,
...
The overview recovered $P=333{,}333.33$ as the present value of the maintenance perpetuity. The claim is that same figure, so the statement is True.`,
...
The overview recovered the combined funding $383{,}333.33$ after adding the \\$50,000 renovation. The claim is that same total, so the statement is True.`,
...
The claim is \\$300,000.00, so the statement is True.`,
...
The claim needs more than $25\\%$. We have $21.74\\% < 25\\%$, so the statement is False.`,
...
The claim needs $250{,}000 < 191{,}666.67$. We have $250{,}000 > 191{,}666.67$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 93,
...
The overview recovered $P=436{,}363.64$ as the growing-perpetuity fair value. The claim is that same figure, so the statement is True.`,
...
The claim needs $300{,}000 > 436{,}363.64$. We have $300{,}000 < 436{,}363.64$, so the statement is False.`,
...
The claim needs $P'>872{,}727.28$. We have $600{,}000 < 872{,}727.28$, so the statement is False.`,
...
The growing-perpetuity formula uses the denominator $r-g$. When $g\\ge 8\\%$ that denominator is zero or negative, so the constant-growth model does not apply. The claim is that restriction, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 94,
...
The overview recovered $D_1=3.09$ as next year's dividend. The claim is that same figure, so the statement is True.`,
      `**B) The fair value per share is approximately \\$54.50.**  (false)

The overview recovered $P=51.50$ as the fair value per share. The claim is about \\$54.50. We have $51.50 \\ne 54.50$, so the statement is False.`,
...
The claim is \\$2.50. We have $1.50 \\ne 2.50$, so the statement is False.`,
...
Double the original \\$51.50 is $103.00$. The claim needs $P'>103.00$. We have $78.75 < 103.00$, so the statement is False.`,
...
If $g=r$, the denominator $r-g$ is zero and the growing-perpetuity formula is undefined. The present value does not become $0$. The claim is \\$0.00, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 95,
...
Deal 1 is a good buy, so the statement is True.`,
...
The claim needs more than \\$60,000. We have $63{,}333.33 > 60{,}000$, so the statement is True.`,
      `**C) Deal 1 offers the larger "margin of safety" of the two deals.**  (false)

Deal 1's margin is $180{,}000-170{,}000=10{,}000$. Deal 2's margin is $63{,}333.33$. The claim needs Deal 1's cushion to be larger. We have $10{,}000 < 63{,}333.33$, so the statement is False.`,
...
The claim needs $P_2' < 170{,}000$. We have $155{,}555.56 < 170{,}000$, so the statement is True.`,
      `**E) Comparing the two original deals, Deal 1's fair value is MORE than Deal 2's fair value.**  (false)

The overview recovered $P_1=180{,}000$ and $P_2=233{,}333.33$. The claim needs $P_1>P_2$. We have $180{,}000 < 233{,}333.33$, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 96,
...
The overview recovered $S_0=129{,}213.75$ as the continuous present value today. The claim is that same figure, so the statement is True.`,
...
The overview recovered $S_0=129{,}213.75$ and $S_0^{\\mathrm{ann}}\\approx 131{,}495.10$. The claim needs $129{,}213.75 > 131{,}495.10$. We have $129{,}213.75 < 131{,}495.10$, so the statement is False.`,
...
The claim needs $S_0' < 64{,}606.88$. We have $179{,}731.00 > 64{,}606.88$, so the statement is False.`,
...
The claim is that same factor and that same one-year loss, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 97,
...
The overview recovered $S_{\\mathrm{cont}}=131{,}629.13$ as the continuous lump-sum future value. The claim is that same figure, so the statement is True.`,
...
The claim needs more than \\$30,000. We have $34{,}871.53 > 30{,}000$, so the statement is True.`,
...
The lump sum earns 6.25% on the full \\$75,000 from day one. The annuity's later deposits sit for fewer years, so they accumulate less. That timing gap is why $S_{\\mathrm{cont}}$ exceeds $F_9$, so the statement is True.`,
...
The claim needs $S_{\\mathrm{ann}} > 96{,}757.60$. We have $129{,}426.15 > 96{,}757.60$, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 98,
...
The overview recovered $P_{\\mathrm{due}}=18{,}110.94$ as the present value of the due lease. The claim is that same figure, so the statement is True.`,
...
The overview recovered $S=30{,}439.24$ as the seven-year continuous balance. The claim is \\$31,439.24. We have $30{,}439.24 \\ne 31{,}439.24$, so the statement is False.`,
...
The claim needs $37{,}500 < 36{,}221.88$. We have $37{,}500 > 36{,}221.88$, so the statement is False.`,
...
The overview recovered $S=30{,}439.24$ and $P_{\\mathrm{perp}}=37{,}500$. The claim needs $S>P_{\\mathrm{perp}}$. We have $30{,}439.24 < 37{,}500$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 99,
...
The overview recovered $S=247{,}308.20$ as Component 1's ten-year continuous balance. The claim is that same figure, so the statement is True.`,
      `**B) Component 2's required deposit today, using discrete annual compounding, is approximately \\$57,396.85.**  (false)

The overview recovered $x=56{,}396.85$ as Component 2's required deposit today. The claim is \\$57,396.85. We have $56{,}396.85 \\ne 57{,}396.85$, so the statement is False.`,
      `**C) Component 3's present value, the 12-year ordinary annuity of \\$10,000 at 7%, is approximately \\$79,429.40.**  (true)

The overview recovered $P_{12}=79{,}429.40$ as Component 3's present value. The claim is that same figure, so the statement is True.`,
...
The overview recovered $P=100{,}000$ as Component 4's growing-perpetuity present value. The claim is \\$100,000.00, so the statement is True.`,
...
The claim needs a total above \\$500,000. We have $385{,}826.25 < 500{,}000$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 100,
...
The overview recovered $r=0.12$ as the periodic rate. Annual compounding with year-end instalments keeps the annual quote intact, so the statement is True.`,
      `**B) The required equal annual payment is approximately \\$14,593.54.**  (true)

The overview recovered $a \\approx 14{,}593.54$ as the equal annual payment. The claim is that same figure, so the statement is True.`,
      `**C) The interest portion of the first payment is exactly \\$7,200.00.**  (true)

The overview recovered first-year interest as \\$7,200. Interest in year 1 is the opening balance times the rate, independent of the instalment size. The claim is \\$7,200.00, so the statement is True.`,
...
Then $7{,}393.54 > 7{,}296.77$, so the statement is True.`,
...
The claim is \\$45,000.00. We have about \\$44,325.69, so the statement is False.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 101,
...
The overview recovered the monthly periodic rate as $0.0075 = 0.75\\%$. The claim is that same split, so the statement is True.`,
      `**B) The required monthly payment is approximately \\$597.24.**  (true)

The overview recovered $a \\approx 597.24$ as the monthly payment. The claim is that same figure, so the statement is True.`,
...
The claim is \\$29,500.00. We have about \\$28,667.57, so the statement is False.`,
...
The claim is \\$4,667.57, so the statement is True.`,
...
The claim needs this annual payment below \\$2,388.96. We have about \\$7,408.05, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 102,
...
The overview recovered $a \\approx 11{,}870.89$ as the equal annual payment. The claim is that same figure, so the statement is True.`,
      `**B) The interest portion of the first payment is \\$5,000.00.**  (false)

Year-1 interest is the opening balance times the rate. The overview recovered that interest as \\$4,500.00. The claim is \\$5,000.00, so the statement is False.`,
      `**C) The outstanding balance immediately after the third payment is approximately \\$20,602.37.**  (true)

The overview recovered the outstanding balance after payment 3 as \\$20,602.37. The claim is that same figure, so the statement is True.`,
...
Then $2{,}060.24 < 9{,}810.65$, so the statement is False.`,
      `**E) Adding up the principal-repayment portions of all 5 payments gives a total of exactly \\$46,200.00.**  (false)

Principal portions retire the original loan and nothing else, so they sum to $K=45{,}000$. The claim is \\$46,200.00, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 103,
...
The overview recovered the combined present-value factor as about $6.537048$. The claim is that same figure, so the statement is True.`,
      `**B) The required equal payment a is approximately \\$22,946.14.**  (true)

The overview recovered the annuity-due payment as $a \\approx 22{,}946.14$. The claim is that same figure, so the statement is True.`,
...
The ordinary payment is higher, not lower, so the statement is False.`,
...
The claim is \\$2,524.08, so the statement is True.`,
...
The claim is \\$220,000.00. We have about \\$229,461.39, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 104,
...
The overview recovered the continuous payoff threshold as about $4.9663$ years, so the smallest integer that retires the loan is $n=5$. The claim is that same count, so the statement is True.`,
...
The claim is that same total, so the statement is True.`,
      `**C) The fifth and final payment is approximately \\$9,682.53.**  (true)

The overview recovered the fifth and final payment as \\$9,682.53. The claim is that same figure, so the statement is True.`,
...
The claim is \\$49,682.53, so the statement is True.`,
...
Then $14{,}682.53 < 35{,}000$, so the statement is True.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 105,
...
The overview recovered the $10\\%$ present value of Option B as about \\$535,526.07. The claim is that same figure, so the statement is True.`,
...
Option A is cheaper at $10\\%$, so the statement is True.`,
      `**C) At a 14% annual rate, the present value of Option B is approximately \\$495,000.00.**  (false)

The overview recovered the $14\\%$ present value of Option B as about \\$488,866.75. The claim is \\$495,000.00, so the statement is False.`,
...
Option B is cheaper at $14\\%$, so the statement is True.`,
      `**E) Option B must always be the more expensive choice in present-value terms, no matter what the interest rate is.**  (false)

At $10\\%$ Option B costs about \\$535,526, above cash. At $14\\%$ it costs about \\$488,867, below cash. The cheaper choice depends on the rate, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 106,
...
The overview recovered the year-end equivalent as \\$1,030. The claim is \\$1,100.00, so the statement is False.`,
      `**B) The account balance after 4 years is approximately \\$4,700.00.**  (false)

The overview recovered the $4$-year balance as about \\$4,641.30. The claim is \\$4,700.00, so the statement is False.`,
...
The claim is \\$3,500.00. We have about \\$3,343.79, so the statement is False.`,
...
The overview recovered the simplified $4$-year balance as about \\$4,506.11. The claim is that same figure, so the statement is True.`,
...
The claim is \\$200.00. We have about \\$135.18, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 107,
...
The overview recovered the monthly payment as $a \\approx 1{,}432.86$. The claim is that same figure, so the statement is True.`,
      `**B) The outstanding balance immediately after the 60th monthly payment is approximately \\$169,799.20.**  (true)

The overview recovered the outstanding balance after the $60$th payment as $B_{60} \\approx 169{,}799.20$. The claim is that same figure, so the statement is True.`,
...
The claim needs more than $25\\%$. We have about $15.10\\%$, so the statement is False.`,
...
which rounds to the claimed \\$55,770.92, so the statement is True.`,
...
The claim is \\$120,000.00. We have about \\$143,886.91, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 108,
...
The overview recovered the payoff threshold as about $8.508$ years, so the smallest integer that retires the loan is $n=9$. The claim is that same count, so the statement is True.`,
      `**B) The ninth and final payment is approximately \\$13,100.16.**  (true)

The overview recovered the ninth and final payment as about \\$13,100.16. The claim is that same figure, so the statement is True.`,
...
The claim is \\$105,000.00. We have about \\$93,100.16, so the statement is False.`,
...
The claim is \\$210,000.00. We have about \\$213,100.16, so the statement is False.`,
...
Then $11{,}899.84 > 10{,}000$, so the statement is True.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 109,
...
The overview recovered the annuity-due payment as $a \\approx 16{,}176.12$. The claim is that same figure, so the statement is True.`,
      `**B) The interest portion of the second loan payment is approximately \\$8,858.87.**  (true)

The overview recovered the interest portion of the second loan payment as about \\$8,858.87. The claim is that same figure, so the statement is True.`,
...
Then $7{,}980.80 < 8{,}858.87$, so the statement is False.`,
...
The overview recovered the reserve's year-end equivalent as \\$1,240.50 and the three-year balance as about \\$4,066.48. Both claimed figures match, so the statement is True.`,
...
The reserve after three years is about \\$4,066.48. Then $48{,}528.36 > 4{,}066.48$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 110,
...
The overview recovered the $9\\%$ present value of Schedule II as about \\$521,162.27. The claim is that same figure, so the statement is True.`,
      `**B) At a 9% annual rate, the present value of Schedule III is approximately \\$540,000.00.**  (false)

The overview recovered the $9\\%$ present value of Schedule III as about \\$535,059. The claim is \\$540,000.00, so the statement is False.`,
...
Schedule I is cheapest at $9\\%$, so the statement is True.`,
      `**D) At a 13% annual rate, the present value of Schedule II is approximately \\$474,767.23.**  (true)

The overview recovered the $13\\%$ present value of Schedule II as about \\$474,767.23. The claim is that same figure, so the statement is True.`,
...
Schedule II is cheapest at $13\\%$, not III, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 111,
...
The overview recovered the $8\\%$ present value of Schedule II as about \\$944,529.45. The claim is that same figure, so the statement is True.`,
      `**B) At an 8% annual rate, the present value of Schedule III is approximately \\$871,117.14.**  (true)

The overview recovered the $8\\%$ present value of Schedule III as about \\$871,117.14. The claim is that same figure, so the statement is True.`,
...
Schedule I is cheapest at $8\\%$, so the statement is True.`,
      `**D) At a 12% annual rate, the present value of Schedule III is approximately \\$775,015.93.**  (true)

The overview recovered the $12\\%$ present value of Schedule III as about \\$775,015.93. The claim is that same figure, so the statement is True.`,
...
The overview recovered the $7.5\\%$ present value of Schedule II as about \\$2,508,821.59. The claim is that same figure, so the statement is True.`,
      `**B) At a 7.5% annual rate, the present value of Schedule III is approximately \\$2,250,000.00.**  (false)

The overview recovered the $7.5\\%$ present value of Schedule III as about \\$2,194,722. The claim is \\$2,250,000.00, so the statement is False.`,
...
Schedule I is cheaper than Schedule II at $7.5\\%$, so the statement is True.`,
      `**D) At an 11.5% annual rate, the present value of Schedule II is approximately \\$2,100,000.00.**  (false)

The overview recovered the $11.5\\%$ present value of Schedule II as about \\$2,186,562. The claim is \\$2,100,000.00, so the statement is False.`,
...
Schedule I is no longer cheaper than Schedule II, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 113,
...
The overview recovered the internal rate as $r=20\\%$. The claim is that same rate, so the statement is True.`,
...
Then $347.83 > 0$, so the statement is True.`,
...
Then $-320 < 0$. The claim needs a positive NPV, so the statement is False.`,
...
Then $25\\% > 24\\%$, so the statement is True.`,
      `**E) This project has a unique internal rate of return greater than -1.**  (true)

One negative outlay followed by one positive return is a cash-flow polynomial $-8{,}000 + 9{,}600 s$ with a single sign change, hence a unique $r > -1$. The recovered $20\\%$ is that unique admissible root, so the statement is True.`,
    ],
    difficulty_level: `1/5`,
    sort_order: 114,
...
The overview recovered the internal rate as about $10.92\\%$. The claim is that same figure, so the statement is True.`,
...
Then $482.85 > 0$, so the statement is True.`,
...
Then $-169.64 < 0$. The claim needs a positive NPV, so the statement is False.`,
...
Then $15.87\\% > 13\\%$, so the statement is True.`,
...
The claim is $21.84\\%$, twice the original rate. We have about $81\\%$, so the statement is False.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 115,
...
The overview recovered the internal rate as about $11.98\\%$. The claim is that same figure, so the statement is True.`,
...
Then $578.51 > 0$, so the statement is True.`,
...
Then $-563.25 < 0$. The claim needs a positive NPV, so the statement is False.`,
...
Then $42.6\\% > 30\\%$, so the statement is True.`,
...
The claim is \\$4,000, so the statement is True.`,
    ],
    difficulty_level: `2/5`,
    sort_order: 116,
...
The overview recovered Project X's internal rate as $15\\%$. The claim is that same rate, so the statement is True.`,
      `**B) The internal rate of return of Project Y is exactly 12.5%.**  (true)

The overview recovered Project Y's internal rate as $12.5\\%$. The claim is that same rate, so the statement is True.`,
...
The IRR criterion prefers X, not Y, so the statement is False.`,
...
Both are positive. The claim needs Y negative, so the statement is False.`,
...
Then $13.64\\% < 15\\%$, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 117,
...
The overview recovered NPV at $8\\%$ as about \\$4,012. The claim is that same figure, so the statement is True.`,
      `**B) At r = 12%, the net present value of the project is positive.**  (false)

The overview recovered NPV at $12\\%$ as about $-444.83$. Then $-444.83 < 0$. The claim needs a positive NPV, so the statement is False.`,
      `**C) The internal rate of return of this project lies between 12% and 15%.**  (false)

NPV is positive at $8\\%$ (about \\$4,012) and already negative at $12\\%$ (about -\\$445). The unique conventional root therefore sits between $8\\%$ and $12\\%$, not between $12\\%$ and $15\\%$, so the statement is False.`,
      `**D) At r = 15%, the net present value of the project is approximately -\\$3,424.**  (true)

The overview recovered NPV at $15\\%$ as about $-3{,}423.60$, which rounds to the claimed $-\\$3,424$, so the statement is True.`,
      `**E) $a_1$, $a_2$, and $a_3$ are all positive.**  (false)

Year 1 is an installation outflow, so $a_1 = -3{,}000$. The later cash flows are not all positive, so the statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 118,
...
The overview recovered the internal rate as about $10.78\\%$. The claim is $14.5\\%$, so the statement is False.`,
...
Then $879.22 > 0$. The claim needs a negative NPV, so the statement is False.`,
...
Then $-1{,}045.19 < 0$, so the statement is True.`,
...
Then $3.76\\% < 10.78\\%$. The new IRR is lower, not higher, so the statement is False.`,
...
Then $20\\% > 10.78\\%$. The IRR rises, it does not fall, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 119,
...
The overview recovered NPV at $15\\%$ as $0$ to the nearest dollar. The claim is that same figure, so the statement is True.`,
...
Then $2{,}809.92 > 0$, so the statement is True.`,
...
Then $-2{,}500 < 0$, so the statement is True.`,
...
The claim is \\$9,600, so the statement is True.`,
      `**E) This project has a unique internal rate of return greater than -1.**  (true)

The cash-flow signs are $-,+,+$, one sign change, hence a unique $r > -1$. The recovered $15\\%$ is that unique admissible root, so the statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 120,
...
The overview recovered $r \\approx 10.69\\%$ as the renovation project's internal rate of return. The claim is that same figure, so the statement is True.`,
...
The claim needs $NPV > 0$. We have $1{,}543.22 > 0$, so the statement is True.`,
...
The claim needs $NPV > 0$. We have $-1{,}160.72 < 0$, so the statement is False.`,
...
Since $77.4\\% > 21.38\\%$, the new internal rate more than doubles, so the statement is True.`,
...
The overview recovered the original rate $10.69\\%$. Since $16.67\\% > 10.69\\%$, the reduced-outlay rate is higher, not lower, so the statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 121,
...
The overview recovered Option 1's limiting internal rate $r=12\\%$. The claim is that same figure, so the statement is True.`,
      `**B) The internal rate of return of Option 2 is approximately -58.84%.**  (true)

The overview recovered Option 2's internal rate $r \\approx -58.84\\%$. The claim is that same figure, so the statement is True.`,
      `**C) Option 2 has a unique internal rate of return greater than -1.**  (true)

The overview recovered one admissible root $r \\approx -58.84\\%$ and discarded the root with $r < -1$. That kept root is unique and greater than $-1$, so the statement is True.`,
...
The claim is -\\$40,000. We have -\\$38,000, so the statement is False.`,
...
The overview recovered Option 2's two-year rate $r \\approx -58.84\\%$. Since $-88\\% < -58.84\\%$, the truncated project has an even lower internal rate, so the statement is True.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 122,
...
The overview recovered Design A's internal rate $r_A \\approx 11.04\\%$. The claim is that same figure, so the statement is True.`,
      `**B) The internal rate of return of Design B is exactly 16%.**  (true)

The overview recovered Design B's one-year internal rate $r_B = 16\\%$. The claim is that same figure, so the statement is True.`,
...
Design B has the higher internal rate, so the statement is True.`,
...
The claim needs $NPV_A < 0$ and $NPV_B > 0$. We have $-3{,}295.48 < 0$ and $1{,}858.41 > 0$, so the statement is True.`,
...
The overview recovered Design B's rate $r_B = 16\\%$. Since $5.91\\% < 16\\%$, the cut-return rate does not exceed $16\\%$, so the statement is False.`,
    ],
    difficulty_level: `5/5`,
    sort_order: 123,
