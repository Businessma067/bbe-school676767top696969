...
$7 + 8 = 15$. The statement is True.`,
  ...
  },
  {
    id: `math-4-37`,
    case_id: `MATH 4.37`,
    title: `Five separate rectangle and Pythagoras stories`,
    subsection: `4.2`,
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has area $60$ cm$^{2}$, and its length is $7$ cm more than its width. Then the width is $5$ cm.`,
      `A rectangle has area $60$ cm$^{2}$, and its length is $7$ cm more than its width. Then the length is $11$ cm.`,
      `A $5$ cm by $12$ cm rectangle has perimeter $40$ cm.`,
      `A right triangle with legs $5$ cm and $12$ cm has hypotenuse $13$ cm.`,
      `A rectangle has area $60$ cm$^{2}$, and its length is $7$ cm more than its width. Then the width is $6$ cm.`,
    ],
    answer_key: [true, false, false, true, false],
    tactical_explanations: [
      `**A.** → True

$$w(w + 7) = 60 \\Rightarrow w^{2} + 7w - 60 = 0$$

The positive root is $w = 5$. Check: $5 \\cdot 12 = 60$.

The statement is True.`,
      `**B.** → False

Length $5 + 7 = 12$ cm, not $11$. Eleven with width $5$ would give area $55$, not $60$.
...
Width $6$ would give length $13$ and area $78$, not $60$. The recovered width is $5$ cm.

The statement is False.`,
    ],
    difficulty_level: `3/5`,
    sort_order: 37,
    solution_overview: `Five independent claims. Area $60$ with length $7$ more than width recovers sides $5$ cm and $12$ cm. A $5$-$12$-$13$ hypotenuse is a separate Pythagoras check.`,
  },
  {
    id: `math-4-38`,
    case_id: `MATH 4.38`,
...
The two integer solutions are $n = 11$ and $n = -18$. The statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `A rectangle has area $36$ cm$^{2}$, and its length is $1$ cm more than twice its width. Then the width is $4$ cm, so the length is $9$ cm.`,
    ],
    answer_key: [false, false, false, false, true],
    tactical_explanations: [
      `**A.** → False

$w(2w + 1) = 36$ gives $2w^{2} + w - 36 = 0$, so $w = 4$, not $6$.

The statement is False.`,
      `**B.** → False

$w(2w) = 48$ gives $w^{2} = 24$, not a length of $12$. If length were $12$ then width would be $6$ and area $72$, not $48$.

The statement is False.`,
      `**C.** → False

Width $4$ and length $9$ give $P = 2(4 + 9) = 26$, not $40$.

The statement is False.`,
      `**D.** → False

$5 \\cdot 11 = 55$, not $36$, and $11$ is not $1$ more than twice $5$.

The statement is False.`,
      `**E.** → True

The positive root of $2w^{2} + w - 36 = 0$ is $w = 4$. Check: $4 \\cdot 9 = 36$.

The statement is True.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 44,
    solution_overview: `Five independent rectangle claims. $w(2w + 1) = 36$ has positive width $4$ cm and length $9$ cm. A second double-width story is a trap.`,
  },
  {
    id: `math-4-45`,
    case_id: `MATH 4.45`,
...
The statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `A $10$ m ladder leans against a wall. Its foot is $2$ m farther from the wall than the height it reaches. Then the foot is $8$ m from the wall.`,
      `A right triangle of wall $6$ m, ground $8$ m, and ladder $10$ m has area $24$ m$^{2}$.`,
...
Let the height be $h$. Then $h^{2} + (h + 2)^{2} = 100$, so $h^{2} + 2h - 48 = 0$ and $h = 6$.

The statement is True.`,
      `**B.** → False

$5^{2} + b^{2} = 13^{2}$ gives $b^{2} = 144$, so $b = 12$, not $7$.

The statement is False.`,
      `**C.** → True

Height $6$ m forces the foot $8$ m from the wall.
...
The foot is $8$ m from the wall, not $9$. Nine would fail Pythagoras with height $7$: $49 + 81 = 130 \\neq 100$.

The statement is False.`,
    ],
    difficulty_level: `4/5`,
    sort_order: 50,
    solution_overview: `Five independent ladder claims. Foot $2$ m more than height with hypotenuse $10$ m recovers height $6$ m and foot $8$ m. A $5$-$12$-$13$ ladder is a separate story.`,
  },
  {
    id: `math-4-51`,
    case_id: `MATH 4.51`,
