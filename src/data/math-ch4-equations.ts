...
export const MATH_CH4_EQUATIONS: MathTask[] = [
  {
    ...
    statements: [
      `A shop doubles a price and then adds $6$ EUR. The till shows $14$ EUR. An examiner claims that the equation has no real solution.`,
      `In a practice item, 5 times an unknown, decreased by $3$, equals $12$. A candidate claims that the sum of all admissible roots equals $10$.`,
      `After $7$ EUR is taken off a bill, the remainder is split into two equal shares of $4$ EUR. A student claims that the sum of all admissible roots equals $15$.`,
      `In a practice item, 3 times the quantity unknown plus $1$, equals $12$. A clerk claims that the product of all admissible roots equals $5$.`,
      `Four times a recorded temperature change, plus $2$ degrees, equals $14$ degrees. An examiner claims that the equation has no admissible real solution.`,
    ],
...
which is not $14$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A purse holds some coins and then $5$ EUR more. The total is $11$ EUR. The stallholder. A clerk claims that the roots multiply to $6$.`,
      `In a practice item, 7 times an unknown equals $21$. An examiner claims that the equation has no real solution.`,
      `After $8$ litres are poured out of a tank, the remainder is split into two equal drums of $5$ litres each. A candidate claims that the sum of all admissible roots equals $20$.`,
      `In a practice item, 6 times an unknown equals $30$. A student claims that the solutions add up to $8$.`,
      `A scale shows a mass with no extra weight and reads $9$ kg. The mass in kilograms equals that scale reading. A clerk claims that the sum of all admissible roots equals $9$.`,
    ],
...
That $9$ is the mass in kilograms, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A number increased by $4$ equals $11$. Translating the sentence into a linear equation and undoing the addition, the number. A student claims that the solutions add up to $7$.`,
      `Three times a number equals $18$. A clerk claims that the equation has two distinct admissible real solutions.`,
      `After $8$ is subtracted from a number, the remainder is split into two equal parts of $6$. An examiner claims that the roots multiply to $20$.`,
      `In a practice item, an equation equivalent to $\\frac{x}{2} = 9$ is posed. A candidate claims that the equation has exactly one admissible real solution.`,
      `A number decreased by $6$, then halved, equals $5$. A student claims that the solutions add up to $19$.`,
    ],
...
which is not $5$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A baker doubles a batch after adding $3$ g of starter. The scale then shows $14$ g. A candidate claims that exactly one admissible root satisfies the equation.`,
      `In a practice item, 5 times the quantity unknown minus $2$, equals $20$. A student claims that the sum of all admissible roots equals $6$.`,
      `A chemist takes twice a sample, adds $1$ ml, then triples the result. The flask shows $21$ ml. A clerk claims that the equation has two distinct admissible real solutions.`,
      `In a practice item, 4 times the quantity unknown minus $5$, equals $12$. An examiner claims that the product of all admissible roots equals $8$.`,
      `Two rods are laid end to end. One is $3$ cm longer than a marked length, the other $1$ cm shorter than that same length. Together they measure $10$ cm. A candidate claims that the roots multiply to $4$.`,
    ],
...
which matches the total, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A jug is filled to one-fourth. That share is $5$ litres. An examiner claims that the equation has exactly one admissible real solution.`,
      `Solving $\\dfrac{x}{3} + 2 = 6$ by first subtracting $2$ and then multiplying by $3$,. A candidate claims that the product of all admissible roots equals $14$.`,
      `Two-fifths of a tank is $6$ litres. A student claims that the equation has no admissible real solution.`,
      `In a practice item, an equation equivalent to $\\frac{x + 1}{2} = 5$ is posed. A clerk claims that the sum of all admissible roots equals $9$.`,
      `One and a half times a wage equals $9$ EUR. An examiner claims that the equation has no real solution.`,
    ],
...
which is not $9$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has width $4$ cm and length $3$ cm more than the width. Writing the perimeter as twice the sum of the sides, that perimeter is $22$ cm. A clerk claims that the product of all admissible roots equals $22$.`,
      `Three times a number, minus $5$, equals $16$. An examiner claims that the solutions add up to $10$.`,
      `The sum of three consecutive integers is $42$. A candidate claims that the equation has exactly one admissible real solution.`,
      `Splitting $30$ into two parts where one part is $4$ more than the other gives the parts $17$ and $13$. A student claims that the equation has exactly one real solution.`,
      `A tank is first emptied of one-quarter of its contents, then a further $10$ litres, after which $20$ litres remain. The tank started with more than $35$ litres. A clerk claims that exactly one admissible root satisfies the equation.`,
    ],
...
That $40$ is the starting volume in litres. Check: a quarter of $40$ is $10$, so $30$ litres are left, then $10$ more leave $20$. The claim matches, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Twice a wage plus $3$ EUR equals three times the same wage minus $5$ EUR. A student claims that the sum of all admissible roots equals $8$.`,
      `In a practice item, an equation equivalent to $5 - x = 2x + 8$ is posed. A clerk claims that the solutions add up to $-1$.`,
      `Four identical boxes, after $1$ unit is taken from each, match two boxes after $5$ extra units are added to each. A storekeeper. An examiner claims that the product of all admissible roots equals $7$.`,
      `The two linear equations $x + 3 = 10$ and $2x = 14$ are claimed to have the same unique real solution. A candidate claims that the roots multiply to $7$.`,
      `Seven times a length, minus $2$ cm, minus three times the same length, equals $10$ cm. The length satisfying the equation is a positive integer less than $5$ cm. A student claims that the equation has exactly one admissible real solution.`,
    ],
...
which matches the right-hand side, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Half a tank plus one-third of the same tank is $5$ litres. A candidate claims that the equation has two distinct admissible real solutions.`,
      `The proportion $\\dfrac{x - 1}{3} = \\dfrac{x + 1}{5}$ is cross-multiplied. A student claims that the equation has no real solution.`,
      `Two-thirds of a bottle is $8$ ml. A clerk claims that the sum of all admissible roots equals $14$.`,
      `In a practice item, an equation equivalent to $\\frac{x}{4} - \\frac{x}{6} = 1$ is posed. An examiner claims that the solutions add up to $14$.`,
      `A clerk triples a fee, adds $1$ EUR, and then divides the total into four equal parts of $4$ EUR. The original fee is less than $10$ EUR. A candidate claims that the product of all admissible roots equals $5$.`,
    ],
...
which matches the right-hand side, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has perimeter $22$ cm and one side is $3$ cm longer than the other. An examiner claims that the equation has no admissible real solution.`,
      ...
      `. An examiner claims that the sum of all admissible roots equals $7$.`,
    ],
...
The unique real solution is $7$, which is an odd integer, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x + 3 = x + 5$, A clerk claims that exactly one admissible root satisfies the equation.`,
      `For $2(x + 4) = 2x + 8$, An examiner claims that every real number satisfies the equation.`,
      `Three times a temperature change, taken with the opposite sign, equals $12$ degrees. A candidate claims that the equation has two distinct admissible real solutions.`,
      `For $5x + 2 = 5x + 2$, A student claims that exactly one admissible root satisfies the equation.`,
      `For $x = x + 1$, A clerk claims that the equation has exactly one real solution.`,
    ],
...
which is never true. So the equation has no real solution, not infinitely many. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $s + 28 + 8 = 2(s + 8)$, A student claims that the equation has exactly one real solution.`,
      ...
      `A purse holds only $2$ EUR coins and $5$ EUR coins. There are $16$ coins in all, worth $53$ EUR. An examiner claims that the solutions add up to $7$.`,
      ...
      `If a number is increased by one-third of itself, the result is $48$. A student claims that the equation has no real solution.`,
    ],
...
The width does not enter that difference. The perimeter increases by $4$ cm, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A stall sells apples at $2$ EUR per kilogram and pears at $3$ EUR per kilogram. A customer buys some kilograms of each, pays $21$ EUR in total, and takes $3$ kg more apples than pears. The customer therefore bought $3$ kg of pears. A clerk claims that the sum of all admissible roots equals $3$.`,
...
and $3 < \\frac{11}{3}$. Milk made up less than one-third of the bill, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A chemist has a vat of $20\\%$ acid. Two litres are drawn off and replaced with water, after which the mixture is $16\\%$ acid. The chemist. A student claims that the equation has exactly one real solution.`,
...
That $24$ is the head-start distance in kilometres, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A metal rod is $2.4$ m long. It is cut into two pieces so that one piece is $60$ cm longer than the other. An examiner claims that the solutions add up to $90$.`,
      ...
      `Three-fifths of a number is $12$ more than one-fifth of the same number. An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
which is not $12$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `In a practice item, an equation equivalent to $\\frac{3x - 1}{4} + \\frac{x + 3}{2} = 5$ is posed. A clerk claims that exactly one admissible root satisfies the equation.`,
      `In a practice item, an equation equivalent to $\\frac{x + 1}{2} - \\frac{x - 1}{3} = 2$ is posed. An examiner claims that the sum of all admissible roots equals $7$.`,
      ...
      `Half a wage plus one-third of the same wage is $5$ EUR. A student claims that the equation has no admissible real solution.`,
      `In a practice item, an equation equivalent to $\\frac{2x + 1}{5} = \\frac{x - 4}{3}$ is posed. A clerk claims that the equation has two distinct admissible real solutions.`,
    ],
...
The hiker covers $12$ km. The claim is that same distance, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $4s + 20 = 2(s + 20)$, An examiner claims that the equation has exactly one real solution.`,
...
The conversion is $10$ metres per second, not $12$. The claimed $12$ m/s would be the conversion of $43.2$ km/h, not of $36$ km/h, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Starting from that $50$ litre mixture at $16\\%$, a $50\\%$ acid stock is poured in until the mixture is $25\\%$ acid. Then $18$ litres of stock must be added. A clerk claims that the equation has exactly one admissible real solution.`,
...
When $A$ has run $100$ m, $B$ has run $80$ m. That is the opening handicap of $A$ against $B$. The claim matches that reading, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x - 3}{4} = \\frac{x}{3} - 2$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\frac{x + 5}{2} = x - 3$, A student claims that the equation has no real solution.`,
      ...
      `For $\\frac{x + 1}{5} = \\frac{x}{2} - 3$, An examiner claims that the equation has no real solution.`,
      `In a practice item, a linear equation in one unknown is posed. A candidate claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
    ],
...
The difference is $9$, not $7$. The claimed $7$ would be $5 + 2$, not $25 - 16$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x - 2)(x - 5) = 0$, A clerk claims that the equation has no real solution.`,
      `For $x^{2} - 5x + 6 = 0$, An examiner claims that the larger root exceeds the smaller by $1$.`,
      `For $x^{2} - 9 = 0$, A candidate claims that the equation has no real solution.`,
      ...
      `For $x^{2} = 5x$, A clerk claims that the larger root exceeds the smaller by $6.47213595499958$.`,
    ],
...
Then $x = 0$ or $x = 5$. One root is zero, which is not positive. Both roots cannot be positive, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $s^{2} = 81$, A student claims that the equation has exactly one real solution.`,
...
The claim $8$ cm does not match, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} - 4x = 0$, A candidate claims that the larger root exceeds the smaller by $6$.`,
      `For $x(x - 4) = 0$, A student claims that the equation has no real solution.`,
      `For $\\Delta = (-4)^{2} - 4 \\cdot 1 \\cdot 4$, the discriminant equals $20$.`,
      `For $x^{2} - 4x + 4 = 0$, An examiner claims that the equation has no real solution.`,
      `For $(x - 2)^{2} = 0$, A candidate claims that the roots multiply to $2$.`,
    ],
    answer_key: [false, false, false, false, true],
    tactical_explanations: [
      `**A.** → False
...
The root $x = 2$ appears twice, so the equation has a repeated root. The claim matches that count, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x - 2)(x - 5) = x^{2} - 7x + 10$, An examiner claims that the equation has exactly one real solution.`,
      `For $x^{2} - 9x + 20 = 0$, A candidate claims that the equation admits two distinct real roots.`,
      `For $x^{2} - 7x + 10 = 0$, A student claims that the sum of the solutions equals $10$.`,
      `For $x^{2} - 7x + 10 = 0$, A clerk claims that the two roots sum to $10$.`,
...
Then $5 > 4$, but $2$ is not greater than $4$. Both greater than $4$ would require a different pair. The claim fails for the smaller number, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} - 5x + 6 = 0$, A clerk claims that the sum of the solutions equals $5$.`,
      `For $x^{2} + 2x + 5 = 0$, An examiner claims that the equation has exactly one real solution.`,
      `For $x^{2} - 4x + 4 = 0$, A candidate claims that the equation has exactly one real solution.`,
      `For $x^{2} + 3x - 10 = 0$, A student claims that the equation has two distinct real solutions.`,
      `For $x^{2} - 2x - 8 = 0$, A clerk claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
so real roots exist. The claim of no real solutions is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} + 2x - 48 = 0$, A student claims that the larger root exceeds the smaller by $14$.`,
...
which is not $45$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x - 5)(x + 3) = 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $x^{2} + (x^{2} + 2x + 1) = 25$, An examiner claims that the equation has exactly one real solution.`,
...
The legs are $3$ cm and $4$ cm, so the longer leg is $4$ cm. The claim is that same length, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $2x^{2} + 4x + 2 = 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $x^{2} + x - 12 = 0$, An examiner claims that the equation has exactly one real solution.`,
      `For $x^{2} + 2x + 3 = 0$, A candidate claims that the equation has exactly one real solution.`,
      `For $3x^{2} - 2x + 1 = 0$, A student claims that the equation has no admissible real solution.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
Since $\\Delta < 0$, there are no real solutions. The claim matches that count, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(t - 4)(t - 8) = 0$, A candidate claims that the equation has exactly one real solution.`,
      `For $(t - 2)(t - 7) = 0$, A student claims that the equation has exactly one real solution.`,
      `For $(t - 3)(t - 8) = 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $(t - 4)(t - 9) = 0$, An examiner claims that the equation has no real solution.`,
      `For $(t - 3)(t - 5) = 0$, A candidate claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The numbers are $3$ and $5$, both positive. A negative pair with product $15$ would need a negative sum as well, because a negative times a negative is positive and the sum of two negatives is negative. The sum here is $8 > 0$, so both numbers are positive. The claim that each is negative is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} + 6x + 5 = 0$, An examiner claims that the equation has two distinct real solutions.`,
      `For $x^{2} - 8x + 12 = 0$, A candidate claims that the equation admits two distinct real roots.`,
      `For $x^{2} - 4x - 1 = 0$, A student claims that the larger root exceeds the smaller by $4.47213595499958$.`,
      `For $x^{2} + 5x + 6 = 0$, A clerk claims that the larger root exceeds the smaller by $3$.`,
      `For $x^{2} - 3x - 4 = 0$, An examiner claims that the sum of the solutions equals $5$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The two real roots are $4$ and $-1$. One of them is negative, so they cannot both be positive. The claim fails, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $384 + 48x + 32x + 4x^{2} = 768$, A clerk claims that the sum of the solutions equals $0$.`,
...
So $384$ cm$^{2}$ of wood is exactly what "outer area twice the picture" required, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $(t - 5)(t - 8) = 0$, A candidate claims that the equation has no real solution.`,
      `For $(t - 3)(t - 7) = 0$, A student claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
which is below the maximum of $32$ m at $t = 4$, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $(t - 4)(t - 8) = 0$, An examiner claims that the equation has exactly one real solution.`,
      ...
      `For $(x + 1)(y + 1) = xy + x + y + 1$, A student claims that the equation has exactly one real solution.`,
      `For $x^{2} + y^{2} = 13^{2} - 2 \\cdot 36$, A clerk claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
The claimed sum of squares is $145$, not $97$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} + x^{2} + 14x + 49 = 169$, A student claims that the equation has exactly one real solution.`,
...
The claimed area is $84$ cm$^{2}$, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $(t - 7)(t - 8) = 0$, A candidate claims that the equation has no real solution.`,
    ],
...
so the sides are $7$ cm and $8$ cm, not $6$ cm and $9$ cm. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $s^{2} + 20s - 125 = 0$, An examiner claims that the equation has exactly one real solution.`,
      `For $s^{2} + 12s - 160 = 0$, A candidate claims that the equation has no real solution.`,
      ...
      `For $(s + 15 + t) - (s + t) = 15$, A clerk claims that the equation has exactly one real solution.`,
...
The height is $5$ m, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x + \\dfrac{2}{x} = 3$, A student claims that the equation has exactly one real solution.`,
      `For $x^{2} - 4x + 3 = 0$, A clerk claims that the two roots sum to $4$.`,
      `For $x + \\dfrac{5}{x} = 6$, An examiner claims that the equation has exactly one real solution.`,
      `For $x + \\dfrac{1}{x} = 3$, A candidate claims that the equation has exactly one real solution.`,
      `For $x + \\dfrac{4}{x} = 5$, A student claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
confirming two roots, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{4} - 10x^{2} + 9 = 0$, A candidate claims that the equation has exactly one real solution.`,
      `For $x^{4} - 8x^{2} + 15 = 0$, A student claims that the equation has exactly one real solution.`,
      `For $x^{4} - 5x^{2} + 4 = 0$, A clerk claims that the equation has exactly one real solution.`,
      `For $x^{4} - 3x^{2} + 2 = 0$, An examiner claims that the equation has no real solution.`,
      `For $x^{4} - 13x^{2} + 36 = 0$, A candidate claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The area is $30$ cm$^{2}$. The claim is that same figure, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $4(t + 6) + 4t = t(t + 6)$, A clerk claims that the equation has exactly one real solution.`,
      `For $6(t + 5) + 6t = t(t + 5)$, An examiner claims that the equation has exactly one real solution.`,
      `For $5(t + 4) + 5t = t(t + 4)$, A candidate claims that the equation has no real solution.`,
...
of a job per hour. That is the claimed rate, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x + \\dfrac{4}{x} = 4$, A student claims that the equation has exactly one real solution.`,
      `For $x + \\dfrac{3}{x} = 4$, A clerk claims that the equation has exactly one real solution.`,
      `For $x^{2} - 6x + 8 = 0$, An examiner claims that the equation has two distinct real solutions.`,
      `For $x + \\dfrac{2}{x} = 3$, A candidate claims that the equation has no real solution.`,
      `For $x + \\dfrac{12}{x} = 7$, A student claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
so there are two distinct real solutions, $3$ and $4$. Both check in the original equation. The claim of no real solutions is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{4} - 13x^{2} + 36 = 0$, A candidate claims that the equation has exactly one real solution.`,
      `For $(x - 3)(x - 5) = 8$, A student claims that the equation has exactly one real solution.`,
      `For $x^{2} + x + 1 = 0$, A clerk claims that exactly one admissible root satisfies the equation.`,
      `For $(t - 2)(t - 7) = 0$, An examiner claims that the equation has no real solution.`,
      `For $2x^{2} - 3x - 2 = 0$, A candidate claims that the roots multiply to $-2$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
Two distinct real roots, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{3}{x} = \\frac{1}{4}$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\frac{3}{x} = \\frac{1}{4}$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\frac{5}{x} = 1$, A student claims that the equation has no real solution.`,
      `For $\\frac{4}{x + 1} = \\frac{2}{3}$, A clerk claims that the solutions add up to $5$.`,
      `For $x = -12$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $-\\frac{1}{4} \\neq \\frac{1}{4}$. The two sides of $\\frac{3}{x} = \\frac{1}{4}$ do not match, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x}{x + 3} = \\frac{2}{5}$, A clerk claims that the roots multiply to $2$.`,
      `For $\\frac{x}{x + 1} = \\frac{3}{4}$, An examiner claims that the equation has exactly one admissible real solution.`,
      `For $\\frac{x + 1}{x + 3} = \\frac{1}{2}$, A candidate claims that the equation has two distinct admissible real solutions.`,
      `For $\\dfrac{x}{x - 2} = 1$, A student claims that the equation has no real solution.`,
      `For $\\frac{2x}{x + 5} = -\\frac{4}{3}$, A clerk claims that the sum of all admissible roots equals $-2$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{2}{x - 3} = \\frac{8}{x - 3}$, A student claims that the equation has no admissible real solution.`,
      `For $\\dfrac{5}{x + 2} = \\dfrac{5}{x + 2}$, A clerk claims that exactly one admissible root satisfies the equation.`,
      `For $\\dfrac{7}{x - 2} = 0$, An examiner claims that the equation has no real solution.`,
      `For $\\frac{1}{x} + \\frac{1}{x} = \\frac{3}{x}$, A candidate claims that the equation has no admissible real solution.`,
      `For $\\frac{4}{x} = \\frac{1}{3}$, A student claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Check: $\\frac{4}{12} = \\frac{1}{3}$. The tank holds $12$ litres, not the claimed $8$ litres, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $\\sqrt{x + 3} = 4$, A student claims that the sum of all admissible roots equals $13$.`,
      `A square of area $13$ m$^{2}$ has side length greater than $3$ m.`,
      `For $\\sqrt{x + 7} = 5$, An examiner claims that the product of all admissible roots equals $18$.`,
      `For $\\sqrt{x + 5} = 4$, A candidate claims that the equation has two distinct admissible real solutions.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\lvert x - 7 \\rvert = 4$, An examiner claims that the roots add up to $14$.`,
      `For $\\lvert x + 2 \\rvert = 5$, A candidate claims that the two roots sum to $-1$.`,
      `For $\\lvert 2x - 6 \\rvert = 10$, A student claims that the product of the roots equals $-16$.`,
      `For $\\lvert x - 1 \\rvert = -3$, A clerk claims that no real root satisfies the equation.`,
      `For $\\lvert 3x + 1 \\rvert = 7$, An examiner claims that the equation has no admissible real solution.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered values are $2$ and $-\\frac{8}{3}$, so there are two real solutions, not exactly one. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{5}{x - 1} = 1$, A clerk claims that the product of all admissible roots equals $6$.`,
      `For $\\frac{4}{x - 3} = 1$, An examiner claims that the roots multiply to $7$.`,
      ...
      `For $\\frac{5}{x - 1} = 1$, A clerk claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
That is the cleared equation named in the claim, and it is valid precisely because $x \\neq 1$, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 7} = 5$, A student claims that the sum of all admissible roots equals $18$.`,
      `For $\\sqrt{3x - 2} = 4$, A clerk claims that the solutions add up to $6$.`,
      `For $\\sqrt{x + 12} = 8$, An examiner claims that the equation has no real solution.`,
      `For $\\sqrt{5x + 1} = 6$, A candidate claims that the sum of all admissible roots equals $10$.`,
      `For $\\sqrt{2x + 9} = 7$, A student claims that the equation has exactly one admissible real solution.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{4x + 5} = 7$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\sqrt{x + 3} = 6$, A student claims that exactly one admissible root satisfies the equation.`,
      `For $\\sqrt{9x - 5} = 10$, A clerk claims that the equation has no real solution.`,
      `For $\\sqrt{x + 20} = 9$, An examiner claims that the equation has no real solution.`,
      `For $\\sqrt{6x + 1} = 5$, A candidate claims that the product of all admissible roots equals $4$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $|2x - 4| = 6$, An examiner claims that the equation has two distinct real solutions.`,
      `Both numbers five units from $3$ on the number line are claimed to be positive.. A candidate claims that the product of all admissible roots equals $11$.`,
      `For $\\lvert 3x - 6 \\rvert = 9$, A student claims that the equation has no real solution.`,
      `For $\\lvert 2x - 4 \\rvert = 6$, A clerk claims that the equation has no real solution.`,
      `For $\\lvert 2x - 4 \\rvert = 6$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
The recorded distance is $6$, not $4$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x}{x - 1} = 3$, A clerk claims that the equation has exactly one real solution.`,
      `For $\\dfrac{1}{x - 2} = \\dfrac{3}{x - 2}$, An examiner claims that the equation has no admissible real solution.`,
      `For $\\frac{x}{x - 4} = 2$, A candidate claims that the roots multiply to $8$.`,
      `For $\\frac{2}{x} = \\frac{3}{x + 3}$, A student claims that the equation has exactly one admissible real solution.`,
      `For $\\frac{x + 3}{x - 3} = 2$, A clerk claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
At $x = 3$ the original is undefined, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 5} + \\sqrt{x - 3} = 4$, A student claims that exactly one admissible root satisfies the equation.`,
      `For $\\sqrt{4x + 5} = 7$, A clerk claims that the sum of all admissible roots equals $11$.`,
      `For $x = 4$, An examiner claims that the equation has no real solution.`,
      `For $\\sqrt{x + 3} = 4$, A candidate claims that the product of all admissible roots equals $16$.`,
      `For $x = 4$, A student claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
Both roots are defined, and the candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A stored temperature is $6^{\\circ}\\mathrm{C}$ away from $4^{\\circ}\\mathrm{C}$. One of the two possible readings is $10^{\\circ}\\mathrm{C}$.. A candidate claims that the equation has exactly one admissible real solution.`,
      `For $\\lvert x - 50 \\rvert = 3$, A student claims that the equation has two distinct real solutions.`,
      `For $\\lvert 2x - 5 \\rvert = \\lvert x + 4 \\rvert$, A clerk claims that the equation has no real solution.`,
      `A gauge error of $9$ units around a reading that is three times a value minus $6$ splits into two cases. Both $5$ and $-1$ check.. An examiner claims that the sum of all admissible roots equals $5$.`,
      `For $\\lvert x \\rvert = -4$, A candidate claims that no real root satisfies the equation.`,
    ],
    answer_key: [true, true, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
asks an absolute value to equal a negative number. There is no real solution, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{2x + 1} = x - 1$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\sqrt{x + 3} = x - 3$, A candidate claims that the equation has no real solution.`,
      `For $\\sqrt{x + 1} = 3 - x$, A student claims that the equation has exactly one real solution.`,
      `For $\\sqrt{3x + 4} = x - 2$, A clerk claims that the equation has exactly one real solution.`,
      `For $\\sqrt{x - 2} = 4 - x$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
There is exactly one real solution, not two, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\lvert x - 3 \\rvert = 5$, A clerk claims that the equation admits two distinct real roots.`,
      `For $\\lvert 2x + 1 \\rvert = 9$, An examiner claims that the larger root exceeds the smaller by $9$.`,
      `For $\\lvert x - 4 \\rvert = \\lvert x + 2 \\rvert$, A candidate claims that the equation has two distinct admissible real solutions.`,
      `For $\\sqrt{x} + 3 = 7$, A student claims that the roots multiply to $16$.`,
      `For $\\lvert x - 6 \\rvert + \\lvert x - 2 \\rvert = 8$, A clerk claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $12 \\neq 8$. The claimed point does not satisfy the equation, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x}{x - 3} = \\frac{x + 6}{x - 1}$, A student claims that the equation has exactly one real solution.`,
      `For $\\frac{x + 2}{x - 4} = \\frac{x + 8}{x - 2}$, A clerk claims that exactly one admissible root satisfies the equation.`,
      `For $\\frac{x}{x + 1} = \\frac{x + 3}{x - 2}$, An examiner claims that the equation has no real solution.`,
      `For $\\frac{2x}{x + 5} = \\frac{x - 1}{x - 3}$, A candidate claims that the equation has no real solution.`,
      `For $\\frac{x - 1}{x + 2} = \\frac{x + 4}{x - 5}$, A student claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $-\\frac{1}{4}$, which is neither hole. That is the unique real solution, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x + 1}{x} + \\frac{x}{x + 1} = \\frac{5}{2}$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\frac{1}{x} + \\frac{1}{x + 1} = \\frac{3}{2}$, A student claims that the equation has exactly one real solution.`,
      `For $\\frac{3}{x} = \\frac{2}{x + 1}$, A clerk claims that the equation has exactly one real solution.`,
      `For $\\frac{1}{x} + \\frac{1}{x + 2} = \\frac{5}{6}$, An examiner claims that the equation has no real solution.`,
      `For $\\frac{x + 3}{x} + \\frac{x}{x + 3} = \\frac{10}{3}$, A candidate claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The discriminant is $12^{2} - 4 \\cdot 4 \\cdot (-27) = 144 + 432 = 576 = 24^{2}$, which is positive. There are two real solutions, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{2x + 1} = 4 - x$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\sqrt{x - 1} = 2 - x$, A candidate claims that the equation has no real solution.`,
      `For $\\sqrt{x + 5} = x - 1$, A student claims that the equation has exactly one real solution.`,
      `For $\\sqrt{3x + 1} = x + 1$, A clerk claims that the equation has no real solution.`,
      `For $\\sqrt{x - 4} = 6 - x$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
There is exactly one real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 12} - \\sqrt{x} = 2$, A clerk claims that exactly one admissible root satisfies the equation.`,
      `For $\\sqrt{x + 24} - \\sqrt{x} = 2$, An examiner claims that the sum of all admissible roots equals $25$.`,
      `For $\\sqrt{x + 8} - \\sqrt{x} = 1$, A candidate claims that the equation has no real solution.`,
      `For $\\sqrt{x + 5} - \\sqrt{x} = 1$, A student claims that the solutions add up to $7$.`,
      `For $\\sqrt{x + 20} - \\sqrt{x} = 4$, A clerk claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $\\frac{1}{4}$, which is not divisible by $3$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 8} + \\sqrt{x} = 6$, A student claims that the equation has exactly one real solution.`,
      `For $\\sqrt{x + 8} + \\sqrt{x} = 6$, A clerk claims that the equation has infinitely many real solutions.`,
      `For $x = \\frac{49}{9}$, An examiner claims that the equation has no real solution.`,
      `For $\\sqrt{x + 8} = 6 - \\sqrt{x}$, A candidate claims that the equation has exactly one real solution.`,
      `For $x = 4$, A student claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered length is $\\frac{49}{9}$ m, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\lvert 3 - 2x \\rvert = x + 1$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\lvert 2x + 1 \\rvert = 5$, A student claims that the equation has two distinct real solutions.`,
      `For $\\lvert 2x - 5 \\rvert = x + 1$, A clerk claims that the equation has two distinct admissible real solutions.`,
      `For $\\lvert x - 4 \\rvert = 2x - 1$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\lvert 5 - x \\rvert = 2x + 3$, A candidate claims that the sum of all admissible roots equals $-5$.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
There is a real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{1}{x - 1} - \\frac{1}{x + 1} = \\frac{1}{4}$, An examiner claims that the sum of all admissible roots equals $3$.`,
      `For $\\sqrt{x + 3} = x - 3$, A candidate claims that the equation has no real solution.`,
      `For $\\lvert x + 2 \\rvert = \\lvert 2x - 7 \\rvert$, A student claims that the product of all admissible roots equals $9$.`,
      `For $\\sqrt{x + 4} = -2$, A clerk claims that the equation has two distinct real solutions.`,
      `For $\\frac{x^{2} - 4}{x - 2} = x$, An examiner claims that exactly one admissible root satisfies the equation.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The identity does not hold at the hole, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{2x + 1}{x - 1} - \\frac{x + 3}{x + 1} = 1$, A clerk claims that the equation has exactly one real solution.`,
      `For $\\frac{3x + 2}{x + 1} - \\frac{2x - 1}{x - 2} = 1$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\dfrac{5x + 1}{x - 2} - \\dfrac{2x + 3}{x + 1} = 2$, A candidate claims that the sum of all admissible roots equals $2$.`,
      `For $\\frac{x + 4}{x - 1} - \\frac{2x}{x + 2} = 1$, A student claims that the equation has exactly one real solution.`,
      `For $\\frac{2x - 1}{x + 3} - \\frac{x + 2}{x - 1} = 1$, A clerk claims that the equation has no real solution.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $-\\frac{1}{5}$, which is neither hole. There is a real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk spends one-fifth of a purse, then one-quarter of what remains, then one-third of what is still left, and finally one-half of the last remainder, and has $18$ EUR. A student claims that the equation has no real solution.`,
      ...
      `For $s + 24 = 5(s - 4)$, A candidate claims that the equation has exactly one real solution.`,
...
The vat starts with $10$ litres of pure acid. Drawing $8$ litres of the $25\\%$ mix removes $2$ litres of acid, leaving $8$ litres of acid in $32$ litres. Adding $8$ litres of $50\\%$ stock adds $4$ litres of acid, so $12$ litres of acid sit in $40$ litres, which is $30\\%$, not $32\\%$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Thirty kilograms of $20\\%$ copper are mixed with some $70\\%$ copper to make a $40\\%$ alloy. Then $20$ kg of the richer alloy must be added. A clerk claims that the roots multiply to $20$.`,
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `For $s + 36 = 2(s + 6)$, A candidate claims that exactly one admissible root satisfies the equation.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The son is now $24$, not $18$. Eighteen would make them $48$ and $24$ in six years, but $48 \\neq 2 \\cdot 24$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $\\frac{3}{4}x + 12 = 2x - 20$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $2 \\cdot 64 - 20 = 108$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $s + 30 - 5 = 3(s - 5)$, A candidate claims that the equation has no real solution.`,
...
minutes, that is $14.4$ minutes, not $15$. Fifteen minutes at the new rate would cover $\\frac{5}{4} \\cdot \\frac{15}{30} = \\frac{5}{8}$ of the tank, which is more than the remaining $\\frac{3}{5}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk spends one-sixth of a purse, then one-fifth of the remainder, then one-quarter of what is still left, then one-third of the last remainder, and has $20$ EUR. A student claims that the solutions add up to $62$.`,
      ...
      `Fifty kilograms of $30\\%$ copper are mixed with some $90\\%$ copper to make a $50\\%$ alloy. Then $20$ kg of the richer alloy must be added. A student claims that the equation has no real solution.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
Twenty-five kilograms of the richer alloy recover $50\\%$, not $20$ kg. Twenty kilograms would give $15 + 18 = 33$ kg of copper in $70$ kg, which is $47.1\\%$, not $50\\%$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      `For $x^{2} = 9$, the sum of the two real roots equals $3$.`,
      `For $(t - 2)(t - 4) = 0$, A student claims that the equation has no real solution.`,
      ...
      `For $x - \\frac{1}{x} = \\frac{8}{3}$, An examiner claims that the equation has no real solution.`,
      `For $(t - 9)(t - 15) = 0$, A candidate claims that the equation has no real solution.`,
    ],
    answer_key: [false, false, true, false, false],
    tactical_explanations: [
      `**A.** → False
...
so the sides are $9$ cm and $15$ cm. A square would need equal sides, hence area $12^{2} = 144$ cm$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $(t - 2)(t - 4) = 0$, A clerk claims that the equation has no real solution.`,
      `For $w = \\frac{-1 + \\sqrt{1 + 960}}{4} = \\frac{-1 + 31}{4} = \\frac{15}{2}$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The width is $7.5$ cm, which does not exceed $8$ cm. An $8$ cm width would give length $17$ cm and area $136$ cm$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $12(t + 7) + 12t = t(t + 7)$, A clerk claims that the equation has exactly one real solution.`,
      ...
      `For $n = \\frac{-1 + \\sqrt{841}}{2} = \\frac{-1 + 29}{2} = 14$, A candidate claims that the equation has no real solution.`,
      `For $96 + 40x + 4x^{2} = 192$, A student claims that the product of the roots equals $-190$.`,
      `For $5t^{2} - 5(t - 3)^{2} = 75$, A clerk claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The tower height is $5 \\cdot 4^{2} = 80$ m. Check: in $1$ second the object falls $5$ m, so the last $3$ seconds of a $4$ second fall cover $80 - 5 = 75$ m. The statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} + x^{2} + 8x + 16 = 400$, A student claims that the equation has exactly one real solution.`,
      ...
      `For $(t - 6)(t - 14) = 0$, An examiner claims that the equation has exactly one real solution.`,
      `For $(t - 2)(t - 6) = 0$, A candidate claims that the equation has no real solution.`,
      `For $384 - 80x + 4x^{2} = 240$, A student claims that the product of the roots equals $-238$.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The root $x = 18$ would make the inner rectangle negative, so the path is $2$ m wide, not $4$ m. Check: inner $20$ by $12$ has area $240$. A $4$ m path would leave $16$ by $8$, which is $128$ m$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x + y)^{2} = x^{2} + 2xy + y^{2}$, A candidate claims that the equation has exactly one real solution.`,
      `For $(x + y)^{2} = x^{2} + 2xy + y^{2} = 73 + 48 = 121$, A student claims that the equation has exactly one real solution.`,
      `For $\\ell^{2} + \\ell^{2} = 200$, A clerk claims that the discriminant equals $6$.`,
      `For $t = \\frac{28 + \\sqrt{784 + 1920}}{10} = \\frac{28 + 52}{10} = 8$, An examiner claims that the equation has no real solution.`,
...
Neither root is a perfect square. The middle integer from the property is not a perfect square, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 21} = 2 + \\sqrt{x + 1}$, An examiner claims that the solutions add up to $17$.`,
      `For $a = \\sqrt{x + 5}$, A candidate claims that the equation has exactly one real solution.`,
      `For $x = -1$, A student claims that the equation has no real solution.`,
      `For $2x + 1 = x^{2} + x - 2$, A clerk claims that the equation has no real solution.`,
      `For $\\sqrt{2x + 6} = x - 1$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
Only $x = 5$ lies in the domain $x \\ge 1$, so there is exactly one real solution, not two. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $a = \\sqrt{x + 12}$, A clerk claims that the equation has no real solution.`,
      `For $\\frac{1}{x - 1} + \\frac{1}{x + 1} = \\frac{(x + 1) + (x - 1)}{(x - 1)(x + 1)}$, An examiner claims that the equation has exactly one real solution.`,
      `For $\\lvert 2x - 4 \\rvert + \\lvert x - 5 \\rvert = 9$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\frac{x + 3}{x - 2} = \\frac{2x}{x + 1}$, A student claims that the equation has no real solution.`,
      `For $\\sqrt{x + 8} = 1 + \\sqrt{x}$, A clerk claims that the equation has no real solution.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
The distance is $\\frac{49}{4}$ m, not $16$ m. Sixteen would give $\\sqrt{24} - 4$, which is not $1$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 5} = 1 + \\sqrt{x - 2}$, A student claims that the sum of all admissible roots equals $11$.`,
      `For $\\lvert x - 3 \\rvert + \\lvert 2x + 1 \\rvert = 11$, A clerk claims that the two roots sum to $7$.`,
      `For $2x - 2 - 3x - 3 = x^{2} - 1$, An examiner claims that the equation has two distinct real solutions.`,
      `For $\\sqrt{4x - 3} = x - 1$, A candidate claims that the equation has no real solution.`,
      `For $\\dfrac{x^{2} - 9}{x - 3} = x + 5$, A student claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
At $x = 3$ the left side is undefined. For $x \\neq 3$ the equation becomes $x + 3 = x + 5$, hence $3 = 5$, which never holds. There are no real solutions. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $a = \\sqrt{x + 15}$, A candidate claims that the equation has exactly one real solution.`,
      `For $\\lvert 3 - 2x \\rvert = \\lvert x + 4 \\rvert$, A student claims that the equation has no real solution.`,
      `For $\\frac{1}{x} - \\frac{1}{x + 3} = \\frac{(x + 3) - x}{x(x + 3)}$, A clerk claims that the equation has no real solution.`,
      `For $\\sqrt{2x + 1} = 4 - x$, An examiner claims that the equation has exactly one real solution.`,
      `For $2x^{2} - 3x + 1 + x^{2} - x - 6 = 3x^{2} + 3x - 6$, A candidate claims that the equation has exactly one real solution.`,
    ],
    answer_key: [true, false, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
This value is allowed because $\\frac{1}{7} \\neq -2$ and $\\frac{1}{7} \\neq 1$. So the equation has exactly one real solution, hence the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 24} = 2 + \\sqrt{x}$, An examiner claims that the roots multiply to $25$.`,
      `For $x = -4$, A candidate claims that the equation has no real solution.`,
      `For $2x + 2 - x + 3 = x^{2} - 2x - 3$, A student claims that the equation has no real solution.`,
      `For $\\sqrt{5x + 1} = x + 1$, A clerk claims that the equation has no real solution.`,
      `For $x^{2} + 8x + 15 - (x^{2} - 3x + 2) = 2(x^{2} + 2x - 3)$, An examiner claims that the equation has no real solution.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
