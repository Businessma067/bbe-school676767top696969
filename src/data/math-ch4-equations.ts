...
export const MATH_CH4_EQUATIONS: MathTask[] = [
  {
    ...
    statements: [
      `A shop doubles a price and then adds $6$ EUR. The till shows $14$ EUR. An examiner claims that 3 times the unknown, increased by $1$, equals $15$.`,
      `In a practice item, 5 times an unknown, decreased by $3$, equals $12$. A candidate claims that 2 times the unknown, decreased by $2$, equals $15$.`,
      `After $7$ EUR is taken off a bill, the remainder is split into two equal shares of $4$ EUR. A student claims that 2 times the unknown, decreased by $2$, equals $28$.`,
      `In a practice item, 3 times the quantity unknown plus $1$, equals $12$. A clerk claims that 2 times the unknown, decreased by $2$, equals $7$.`,
      `Four times a recorded temperature change, plus $2$ degrees, equals $14$ degrees. An examiner claims that 2 times the unknown, decreased by $2$, equals $7$.`,
    ],
...
which is not $14$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A purse holds some coins and then $5$ EUR more. The total is $11$ EUR. The stallholder concludes that the purse started with $6$ EUR. A clerk claims that 4 times the unknown, increased by $3$, equals $27$.`,
      `In a practice item, 7 times an unknown equals $21$. An examiner claims that 2 times the unknown, decreased by $2$, equals $7$.`,
      `After $8$ litres are poured out of a tank, the remainder is split into two equal drums of $5$ litres each. A candidate claims that 4 times the unknown, increased by $3$, equals $77$.`,
      `In a practice item, 6 times an unknown equals $30$. A student claims that the unknown, increased by $5$, equals $13$.`,
      `A scale shows a mass with no extra weight and reads $9$ kg. The mass in kilograms equals that scale reading. A clerk claims that the unknown, increased by $5$, equals $14$.`,
    ],
...
That $9$ is the mass in kilograms, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A number increased by $4$ equals $11$. Translating the sentence into a linear equation and undoing the addition, the number. A student claims that 2 times the unknown, decreased by $2$, equals $12$.`,
      `Three times a number equals $18$. A clerk claims that 4 times the unknown, increased by $3$, equals $29$.`,
      `After $8$ is subtracted from a number, the remainder is split into two equal parts of $6$. Restoring the operations, the original number is $20$. An examiner claims that 3 times the unknown, increased by $1$, equals $61$.`,
      `In a practice item, an equation equivalent to $\\frac{x}{2} = 9$ is posed. A candidate claims that 4 times the unknown, increased by $3$, equals $75$.`,
      `A number decreased by $6$, then halved, equals $5$. A student claims that 3 times the unknown, increased by $1$, equals $51$.`,
    ],
...
which is not $5$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A baker doubles a batch after adding $3$ g of starter. The scale then shows $14$ g. The baker reports that the original batch was $4$ g. A candidate claims that 3 times the unknown, increased by $1$, equals $13$.`,
      `In a practice item, 5 times the quantity unknown minus $2$, equals $20$. A student claims that 4 times the unknown, increased by $3$, equals $27$.`,
      `A chemist takes twice a sample, adds $1$ ml, then triples the result. The flask shows $21$ ml. The chemist reports that the original sample was $4$ ml. A clerk claims that 2 times the unknown, decreased by $2$, equals $7$.`,
      `In a practice item, 4 times the quantity unknown minus $5$, equals $12$. An examiner claims that 3 times the unknown, increased by $1$, equals $25$.`,
      `Two rods are laid end to end. One is $3$ cm longer than a marked length, the other $1$ cm shorter than that same length. Together they measure $10$ cm. A candidate claims that 3 times the unknown, increased by $1$, equals $13$.`,
    ],
...
which matches the total, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A jug is filled to one-fourth. That share is $5$ litres. An examiner claims that 3 times the unknown, increased by $1$, equals $61$.`,
      `Solving $\\dfrac{x}{3} + 2 = 6$ by first subtracting $2$ and then multiplying by $3$, a candidate claims that the unique real solution is odd.. A candidate claims that 3 times the unknown, increased by $1$, equals $39$.`,
      `Two-fifths of a tank is $6$ litres. A student claims that 2 times the unknown, decreased by $2$, equals $31$.`,
      `In a practice item, an equation equivalent to $\\frac{x + 1}{2} = 5$ is posed. A clerk claims that the unknown, increased by $5$, equals $14$.`,
      `One and a half times a wage equals $9$ EUR. An examiner claims that 4 times the unknown, increased by $3$, equals $29$.`,
    ],
...
which is not $9$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has width $4$ cm and length $3$ cm more than the width. Writing the perimeter as twice the sum of the sides, that perimeter is $22$ cm. A clerk claims that 4 times the unknown, increased by $3$, equals $91$.`,
      `Three times a number, minus $5$, equals $16$. An examiner claims that 2 times the unknown, decreased by $2$, equals $15$.`,
      `The sum of three consecutive integers is $42$. A candidate claims that 4 times the unknown, increased by $3$, equals $59$.`,
      `Splitting $30$ into two parts where one part is $4$ more than the other gives the parts $17$ and $13$. A student claims that the unknown, increased by $5$, equals $18$.`,
      `A tank is first emptied of one-quarter of its contents, then a further $10$ litres, after which $20$ litres remain. The tank started with more than $35$ litres. A clerk claims that 3 times the unknown, increased by $1$, equals $121$.`,
    ],
...
That $40$ is the starting volume in litres. Check: a quarter of $40$ is $10$, so $30$ litres are left, then $10$ more leave $20$. The claim matches, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Twice a wage plus $3$ EUR equals three times the same wage minus $5$ EUR. A student claims that 3 times the unknown, increased by $1$, equals $25$.`,
      `In a practice item, an equation equivalent to $5 - x = 2x + 8$ is posed. A clerk claims that the unknown, increased by $5$, equals $4$.`,
      `Four identical boxes, after $1$ unit is taken from each, match two boxes after $5$ extra units are added to each. A storekeeper reports that each box started with $7$ units. An examiner claims that 2 times the unknown, decreased by $2$, equals $12$.`,
      `The two linear equations $x + 3 = 10$ and $2x = 14$ are claimed to have the same unique real solution. A candidate claims that 2 times the unknown, decreased by $2$, equals $12$.`,
      `Seven times a length, minus $2$ cm, minus three times the same length, equals $10$ cm. The length satisfying the equation is a positive integer less than $5$ cm. A student claims that 2 times the unknown, decreased by $2$, equals $4$.`,
    ],
...
which matches the right-hand side, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Half a tank plus one-third of the same tank is $5$ litres. A candidate claims that 4 times the unknown, increased by $3$, equals $29$.`,
      `The proportion $\\dfrac{x - 1}{3} = \\dfrac{x + 1}{5}$ is cross-multiplied. A student claims that 3 times the unknown, increased by $1$, equals $15$.`,
      `Two-thirds of a bottle is $8$ ml. A clerk claims that 3 times the unknown, increased by $1$, equals $39$.`,
      `In a practice item, an equation equivalent to $\\frac{x}{4} - \\frac{x}{6} = 1$ is posed. An examiner claims that 3 times the unknown, increased by $1$, equals $39$.`,
      `A clerk triples a fee, adds $1$ EUR, and then divides the total into four equal parts of $4$ EUR. The original fee is less than $10$ EUR. A candidate claims that the unknown, increased by $5$, equals $10$.`,
    ],
...
which matches the right-hand side, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has perimeter $22$ cm and one side is $3$ cm longer than the other. An examiner claims that 3 times the unknown, increased by $1$, equals $15$.`,
      `A car travels at an average speed of $64$ km/h. At $3$ pm, it has traveled a total distance of $112$ km. Then it started traveling at $1{:}15$ pm. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A recipe calls for $5\\%$ vinegar. If the cook only has $1$ litre of $8\\%$ vinegar, he needs to mix it with $0.6$ litres of water to get the right concentration. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A prize money of $12200$ EUR is supposed to be split among the winners in a way that the $2$nd placed obtains $80\\%$ of the amount the $1$st placed obtains, and the $3$rd placed obtains $80\\%$ of the $2$nd placed. The second-place prize exceeds $3500$ EUR. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The solution of the equation $2x + 1 = x + 8$ is an odd integer. An examiner claims that 2 times the unknown, decreased by $2$, equals $12$.`,
    ],
...
The unique real solution is $7$, which is an odd integer, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk adds $3$ EUR to a bill on one till and $5$ EUR to the same original bill on another till, and claims the two tills can still match if the original bill was $0$ EUR. A clerk claims that 3 times the unknown, increased by $1$, equals $3$.`,
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `Three times a temperature change, taken with the opposite sign, equals $12$ degrees. A candidate claims that 3 times the unknown, increased by $1$, equals $-9$.`,
      `In a practice item, a linear equation in one unknown is posed. A student claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
...
which is never true. So the equation has no real solution, not infinitely many. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A father is $28$ years older than his son. In $8$ years the father will be twice as old as the son will be then. The son is now $20$ years old. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The sum of three consecutive odd integers is $75$. The largest of them is $29$. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A purse holds only $2$ EUR coins and $5$ EUR coins. There are $16$ coins in all, worth $53$ EUR. Then there are $7$ coins of $5$ EUR. An examiner claims that 2 times the unknown, decreased by $2$, equals $12$.`,
      `Water flows into an empty tank at $15$ litres per minute. After $12$ minutes the tank is four-fifths full, so the tank's capacity is $180$ litres. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `If a number is increased by one-third of itself, the result is $48$. A student claims that 3 times the unknown, increased by $1$, equals $111$.`,
    ],
...
which is not $48$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A runner covers $9$ km at $6$ km/h and then $6$ km at $9$ km/h. The whole run takes $2$ hours. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Two printers working together finish a job in $4$ hours. The faster one alone would take $6$ hours. The slower printer alone takes more than $10$ hours. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A train $180$ m long passes a pole in $12$ seconds. Its speed is $54$ km/h. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A car leaves a depot at $8{:}00$ at $60$ km/h. A second car leaves the same depot at $9{:}00$ at $90$ km/h, chasing the first. They meet at noon. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A tap fills a $240$ litre tub in $8$ minutes. Left open for $5$ minutes it pours $150$ litres. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
litres, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `A rectangular garden is $3$ m longer than it is wide. Fencing all four sides uses $54$ m of wire. The width exceeds $10$ m. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The three angles of a triangle, measured in degrees, are consecutive integers. The largest angle is $61^{\\circ}$. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A square and an equilateral triangle have the same side length. The triangle's perimeter is $12$ cm, so the square's perimeter is $16$ cm. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A rectangle has width $8$ cm. If the length is increased by $2$ cm and the width is left unchanged, the perimeter increases by $4$ cm. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
The width does not enter that difference. The perimeter increases by $4$ cm, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A stall sells apples at $2$ EUR per kilogram and pears at $3$ EUR per kilogram. A customer buys some kilograms of each, pays $21$ EUR in total, and takes $3$ kg more apples than pears. The customer therefore bought $3$ kg of pears. A clerk claims that 2 times the unknown, decreased by $2$, equals $4$.`,
      `Notebooks cost $4$ EUR each and pens cost $2$ EUR each. A student buys $5$ more pens than notebooks and pays $22$ EUR in all. The student bought fewer than $5$ notebooks. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Tea is $5$ EUR per kilogram and sugar is $2$ EUR per kilogram. A shopper takes twice as much tea as sugar and pays $24$ EUR. The tea alone accounted for more than $15$ EUR of the bill. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `If a customer buys $5$ kg of apples at $2$ EUR per kilogram and $2$ kg of pears at $3$ EUR per kilogram, the bill is $16$ EUR. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Bread costs $2$ EUR a loaf and milk costs $1.5$ EUR a carton. Four loaves and two cartons come to $11$ EUR, so milk made up less than one-third of that bill. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
and $3 < \\frac{11}{3}$. Milk made up less than one-third of the bill, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A chemist has a vat of $20\\%$ acid. Two litres are drawn off and replaced with water, after which the mixture is $16\\%$ acid. The chemist concludes that the vat originally held $10$ litres. A student claims that 4 times the unknown, increased by $3$, equals $43$.`,
      `A vat holds $8$ litres of $25\\%$ acid. Two litres of pure acid are added without removing any liquid. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `After a $20\\%$ discount a jacket costs $64$ EUR. A shop assistant says the original price must therefore have been $90$ EUR. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A listed price is first raised by $25\\%$ and then reduced by $25\\%$. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A salary of $2400$ EUR is increased by $10\\%$ and then by a further $10\\%$. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
The new salary is $2904$ EUR, not $2880$ EUR. The figure $2880$ would be a single $20\\%$ raise on $2400$, which is not the same as two successive $10\\%$ raises. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Towns $X$ and $Y$ are $132$ km apart. At noon a car leaves $X$ toward $Y$ at $48$ km/h. Thirty minutes later a second car leaves $Y$ toward $X$ at $72$ km/h. They meet $54$ minutes after noon. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A later car starts at $12{:}30$ and the two oncoming cars meet $54$ minutes after noon. A passenger claims the later car has then been driving for a full hour.. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A boat goes $24$ km downstream in $2$ hours and returns the same $24$ km upstream in $3$ hours. The boat's speed in still water is then $12$ km/h. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A cyclist rides to town at $15$ km/h and back at $10$ km/h. If the one-way distance is $30$ km, the round trip takes $4$ hours, because each leg is supposedly two hours if you average the two times. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A car leaves town $X$ at $48$ km/h. After a $30$ minute head start it has covered $24$ km. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, false, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
That $24$ is the head-start distance in kilometres, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A metal rod is $2.4$ m long. It is cut into two pieces so that one piece is $60$ cm longer than the other. The shorter piece is $90$ cm. An examiner claims that 4 times the unknown, increased by $3$, equals $363$.`,
      `The mean of three numbers is $14$. Two of them are $11$ and $15$. The third is $18$. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A recipe for $8$ portions uses $600$ g of flour. For $12$ portions one therefore needs $1000$ g of flour. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A rectangle's length is twice its width. The perimeter is $48$ cm, so the width is $10$ cm. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Three-fifths of a number is $12$ more than one-fifth of the same number. The number is $25$. An examiner claims that 4 times the unknown, increased by $3$, equals $125$.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
which is not $12$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `In a practice item, an equation equivalent to $\\frac{3x - 1}{4} + \\frac{x + 3}{2} = 5$ is posed. A clerk claims that 2 times the unknown, decreased by $2$, equals $4$.`,
      `In a practice item, an equation equivalent to $\\frac{x + 1}{2} - \\frac{x - 1}{3} = 2$ is posed. An examiner claims that 2 times the unknown, decreased by $2$, equals $12$.`,
      `The least common multiple of $3$, $4$, and $6$ is $12$, so multiplying a three-denominator linear equation with those denominators through by $12$ is the economical clearing. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Half a wage plus one-third of the same wage is $5$ EUR. A student claims that 4 times the unknown, increased by $3$, equals $29$.`,
      `In a practice item, an equation equivalent to $\\frac{2x + 1}{5} = \\frac{x - 4}{3}$ is posed. A clerk claims that 2 times the unknown, decreased by $2$, equals $-45$.`,
    ],
...
The recovered solution is $x = -23$, which is not positive. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A workshop bills $40$ EUR per hour for the first $3$ hours of a job and $60$ EUR per hour after that, plus a fixed $50$ EUR for parts. One job comes to $290$ EUR. The job ran for more than $4$ hours. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A plumber charges $45$ EUR per hour plus a $30$ EUR call-out fee. A visit that comes to $165$ EUR therefore lasted $3$ hours. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `On a $290$ EUR workshop job billed at $40$ EUR per hour for the first $3$ hours, $60$ EUR per hour after that, and $50$ EUR for parts, labour was billed at $240$ EUR, with the remaining $50$ EUR being parts. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The two-band tariff of $40$ EUR per hour for the first $3$ hours and $60$ EUR per hour after that, plus $50$ EUR parts, would also cost $290$ EUR for a $4$ hour job, because overtime would already have started. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A $50$ EUR parts charge on a $290$ EUR bill is less than one-fifth of that bill. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
and $50 < 58$. Parts are less than one-fifth of the bill, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A cyclist rides at $15$ km/h for $2$ hours, then at $10$ km/h for $1$ hour. The total distance covered is $40$ km. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Two trains leave stations $120$ km apart and approach each other at $40$ km/h and $20$ km/h. A dispatcher claims they meet after $2$ hours. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A runner completes a $10$ km race at constant speed in $50$ minutes. A coach claims the average speed was $15$ km/h.. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A car travels $180$ km at a steady $60$ km/h. A passenger claims the trip took $2.5$ hours.. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A hiker walks at $5$ km/h for $2.4$ hours. The distance covered is $12$ km. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
The hiker covers $12$ km. The claim is that same distance, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A father is now four times as old as his son. In $20$ years the father will be twice as old as the son will be then. The son is now $10$ years old. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A mother is three times as old as her daughter. In $12$ years the mother will be twice as old as the daughter will be then. The daughter is now $12$ years old. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A father who is now $40$ will be $50$ in $20$ years. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `If a father is now $40$ and his son is now $10$, their ages differ by $30$ years, and that gap does not change as both grow older. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Five years ago a father of $40$ and a son of $10$ were in the ratio five to one. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
They were in the ratio seven to one, not five to one. Five to one would have required ages $35$ and $7$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two trains $180$ m and $320$ m long run toward each other at $72$ km/h and $108$ km/h. From the instant their fronts meet until they have completely passed takes $10$ seconds. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A speed of $54$ km/h equals $15$ m/s because $54 \div 3.6 = 15$.`,
      `Two trains $150$ m and $250$ m long run in the same direction at $90$ km/h and $54$ km/h. The faster train takes $20$ seconds to pass the slower completely. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A courier rides $45$ km at a steady $15$ km/h. The journey lasts $15$ minutes. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Converting $36$ km/h to metres per second gives $12$ m/s. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
The conversion is $10$ metres per second, not $12$. The claimed $12$ m/s would be the conversion of $43.2$ km/h, not of $36$ km/h, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A vat holds $40$ litres of $20\\%$ acid. Ten litres of water are added. The vat is then $16\\%$ acid. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Starting from that $50$ litre mixture at $16\\%$, a $50\\%$ acid stock is poured in until the mixture is $25\\%$ acid. Then $18$ litres of stock must be added. A clerk claims that 4 times the unknown, increased by $3$, equals $75$.`,
      `After that stock is added, the final volume is $68$ litres. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The final $25\\%$ mixture contains $20$ litres of acid. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The final $25\\%$ mixture contains $17$ litres of acid, which is $25\\%$ of $68$ litres. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
The final mixture contains $17$ litres of acid, which is $25\\%$ of $68$ litres. The claim matches that check, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A farmer has a rectangular field that is $8$ m longer than it is wide. Around the outside he lays a gravel path $1.5$ m wide covering $141$ m$^{2}$. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A gardener has a rectangular lawn that is $4$ m longer than it is wide. Around the outside she lays a $1$ m flower border covering $48$ m$^{2}$, and she concludes that the lawn is $9$ m wide. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A sports pitch measures $12$ m by $20$ m. The groundskeeper adds a uniform $2$ m running path around the outside and reports that the outer length is then $24$ m. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A $12$ m by $8$ m patio is given a $1$ m path around the outside. The groundskeeper claims that this path covers $44$ m$^{2}$. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Walking once around a $20$ m by $30$ m rectangular field is claimed to cover a distance of $100$ m. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [false, true, true, true, true],
    tactical_explanations: [
      `**A.** → False
...
The walk covers $100$ m. The claim is that same distance, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `In a practice item, a linear equation in one unknown is posed. A candidate claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `Then all three need $4$ more days to finish. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `In a practice item, a linear equation in one unknown is posed. A clerk claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
    ],
    answer_key: [false, true, true, false, true],
    tactical_explanations: [
...
The three together do $\\frac{13}{72}$ of a job per day. The claim is that same rate, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $240$ km trip is driven in two equal $120$ km legs at $80$ km/h then $60$ km/h. The total driving time exceeds $3$ hours. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A driver covers $90$ km at $45$ km/h and then $60$ km at $60$ km/h. A passenger claims the average speed for the whole drive was $55$ km/h.. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A courier drives $100$ km to a client at $50$ km/h and returns the same route at $25$ km/h. The round trip takes $6$ hours. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `On a $160$ km journey, the first $80$ km are driven at $80$ km/h. That first leg takes exactly $1$ hour. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A motorist covers $200$ km in $4$ hours of clock time, including a $30$ minute rest. Without the rest, the average driving speed would be $50$ km/h. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
km, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `In a $100$ m race, $A$ beats $B$ by $20$ m, and $B$ beats $C$ by $25$ m. When $A$ has run $100$ m, $C$ has run $60$ m. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `The speed ratio of $A$ to $B$ in that race is $4 : 5$. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `The speed ratio of $A$ to $C$ is $5 : 3$. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `When $A$ has run $100$ m, $B$ has run $80$ m, which is the opening handicap of $A$ against $B$. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
When $A$ has run $100$ m, $B$ has run $80$ m. That is the opening handicap of $A$ against $B$. The claim matches that reading, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `If $3$ is taken off a sample and the remainder is split into four equal parts, each part is $2$ ml less than one-third of the original sample. The original sample exceeds $10$ ml. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `If $5$ is added to a number and the sum is halved, the result is $3$ less than the original number. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Three consecutive integers add to $48$. The middle integer is even. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `If $1$ is added to a number and the sum is divided by $5$, the result is $3$ less than half the number. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `In a practice item, a linear equation in one unknown is posed. A candidate claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
    ],
...
The difference is $9$, not $7$. The claimed $7$ would be $5 + 2$, not $25 - 16$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x - 2)(x - 5) = 0$, A clerk claims that expanding gives a quadratic with no real roots.`,
      `For $x^{2} - 5x + 6 = 0$, An examiner claims that the sum of the two roots equals $5$.`,
      `A number squared, minus nine, is zero. A candidate claims that the sum of the two roots equals $8$.`,
      `If a product of two real numbers is zero, then at least one of those numbers is zero. A student claims that the sum of the two roots equals $5$.`,
      `For $x^{2} = 5x$, A clerk claims that the sum of the two roots equals $3$.`,
    ],
...
Then $x = 0$ or $x = 5$. One root is zero, which is not positive. Both roots cannot be positive, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $s^{2} = 81$, A student claims that the positive geometric root equals $9$.`,
      `Two consecutive positive integers multiply to $30$. Their sum is $11$.. A clerk claims that the sum of the two roots equals $5$.`,
      `A $6$ cm by $7$ cm rectangle has perimeter $26$ cm.. An examiner claims that the sum of the two roots equals $5$.`,
      `A rectangle of width $5$ cm and length $8$ cm has area $35$ cm$^{2}$.. A candidate claims that the sum of the two roots equals $8$.`,
...
The claim $8$ cm does not match, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} - 4x = 0$, A candidate claims that the discriminant equals $21$.`,
      `A number squared, minus four times the number, is zero. Zero itself is not allowed.. A student claims that the sum of the two roots equals $8$.`,
      `For $\\Delta = (-4)^{2} - 4 \\cdot 1 \\cdot 4$, the discriminant equals $20$.`,
      `For $x^{2} - 4x + 4 = 0$, An examiner claims that the repeated root satisfies $x^{2} = 5$.`,
      `For $(x - 2)^{2} = 0$, A candidate claims that the repeated root satisfies $x^{2} = 4$.`,
    ],
    answer_key: [false, false, false, false, true],
    tactical_explanations: [
      `**A.** → False
...
The root $x = 2$ appears twice, so the equation has a repeated root. The claim matches that count, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x - 2)(x - 5) = x^{2} - 7x + 10$, An examiner claims that expanding gives a quadratic with two real roots.`,
      `For $x^{2} - 9x + 20 = 0$, A candidate claims that the product of the two roots equals $20$.`,
      `For $x^{2} - 7x + 10 = 0$, A student claims that the product of the two roots equals $12$.`,
      `For $x^{2} - 7x + 10 = 0$, A clerk claims that the product of the two roots equals $12$.`,
      `A coach claims that both scores that add to $7$ and multiply to $10$ are. An examiner claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
Then $5 > 4$, but $2$ is not greater than $4$. Both greater than $4$ would require a different pair. The claim fails for the smaller number, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} - 5x + 6 = 0$, A clerk claims that the product of the two roots equals $6$.`,
      `For $x^{2} + 2x + 5 = 0$, the discriminant equals $6$.`,
      `For $x^{2} - 4x + 4 = 0$, A candidate claims that the repeated root satisfies $x^{2} = 4$.`,
      `For $x^{2} + 3x - 10 = 0$, A student claims that the discriminant equals $49$.`,
      `For $x^{2} - 2x - 8 = 0$, A clerk claims that the discriminant equals $44$.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
so real roots exist. The claim of no real solutions is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} + 2x - 48 = 0$, A student claims that the larger root minus the smaller equals $14$.`,
      `Two consecutive positive integers multiply to $42$. Their sum is $13$.. A clerk claims that the sum of the two roots equals $5$.`,
      `A $6$ cm by $8$ cm rectangle has perimeter $28$ cm.. An examiner claims that the sum of the two roots equals $5$.`,
      `A rectangle of width $6$ cm and length $10$ cm has area $48$ cm$^{2}$.. A candidate claims that the sum of the two roots equals $8$.`,
      `A rectangle of area $48$ cm$^{2}$ whose length is $2$ cm more than its width has sides that differ by $2$ cm.. A student claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
That is the opening relation of the $48$ cm$^{2}$ rectangle. The sides differ by $2$ cm whether or not one first recovers the widths $6$ and $8$. The claim matches that relation, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two consecutive integers multiply to $56$. The equation $n^{2} + n - 56 = 0$ has two distinct integer roots. A candidate claims that the sum of the two roots equals $5$.`,
      `Two consecutive positive integers multiply to $56$. Their sum is $15$.. A student claims that the sum of the two roots equals $5$.`,
      `Two consecutive integers multiply to $56$. Besides the positive pair there is also a negative pair, $-8$ and $-7$.. A clerk claims that the sum of the two roots equals $5$.`,
      `The integers $6$ and $9$ multiply to $54$, not $56$, and they are not consecutive.. An examiner claims that the sum of the two roots equals $5$.`,
      `Two consecutive positive integers that multiply to $56$ add to $15$.. A candidate claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
They add to $15$. The claim is that same sum, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has area $60$ cm$^{2}$, and its length is $7$ cm more than its width. The width is a positive integer. An examiner claims that the sum of the two roots equals $5$.`,
      `A rectangle measuring $5$ cm by $11$ cm is claimed to have area $60$ cm$^{2}$.. A candidate claims that the sum of the two roots equals $8$.`,
      `A rectangle measuring $5$ cm by $12$ cm is claimed to have perimeter $40$ cm.. A student claims that the sum of the two roots equals $8$.`,
      `A right triangle has legs $5$ cm and $12$ cm. Pythagoras is then said to give a hypotenuse of $13$ cm.. A clerk claims that the sum of the two roots equals $5$.`,
      `A garden is $4$ m longer than it is wide and has area $45$ m$^{2}$. A plan claims that the width is $6$ m.. An examiner claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, false, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
which is not $45$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $(x - 5)(x + 3) = 0$, A clerk claims that expanding gives a quadratic with two real roots.`,
      `One leg of a right triangle is $1$ cm longer than the other, and the hypotenuse is $5$ cm. Both legs are positive integers.. An examiner claims that the sum of the two roots equals $5$.`,
      `A triangle with sides $3$ cm, $4$ cm, and $5$ cm is equilateral.. A candidate claims that the sum of the two roots equals $8$.`,
      `A right triangle with legs $3$ cm and $4$ cm has area $12$ cm$^{2}$.. A student claims that the sum of the two roots equals $8$.`,
      `A right triangle with legs $3$ cm and $4$ cm and hypotenuse $5$ cm has longer leg $4$ cm.. A clerk claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The legs are $3$ cm and $4$ cm, so the longer leg is $4$ cm. The claim is that same length, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} - 6x + 10 = 0$, A student claims that the discriminant equals $-4$.`,
      `For $2x^{2} + 4x + 2 = 0$, A clerk claims that the repeated root satisfies $x^{2} = 1$.`,
      `For $x^{2} + x - 12 = 0$, An examiner claims that the discriminant equals $1$.`,
      `For $x^{2} + 2x + 3 = 0$, A candidate claims that the discriminant equals $0$.`,
      `For $3x^{2} - 2x + 1 = 0$, A student claims that the discriminant equals $0$.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
Since $\\Delta < 0$, there are no real solutions. The claim matches that count, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two numbers add to $12$ and multiply to $32$. Both numbers are even.. A candidate claims that the sum of the two roots equals $5$.`,
      `Two numbers add to $9$ and multiply to $14$. Their difference is $5$.. A student claims that the sum of the two roots equals $5$.`,
      `Two numbers add to $11$ and multiply to $24$. One number is odd and the other is even.. A clerk claims that the sum of the two roots equals $5$.`,
      `Two numbers add to $13$ and multiply to $36$. Both are. An examiner claims that the sum of the two roots equals $8$.`,
      `Two numbers add to $8$ and multiply to $15$. Each of them. A candidate claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The numbers are $3$ and $5$, both positive. A negative pair with product $15$ would need a negative sum as well, because a negative times a negative is positive and the sum of two negatives is negative. The sum here is $8 > 0$, so both numbers are positive. The claim that each is negative is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x^{2} + 6x + 5 = 0$, An examiner claims that the larger root minus the smaller equals $4$.`,
      `For $x^{2} - 8x + 12 = 0$, A candidate claims that the larger root minus the smaller equals $4$.`,
      `For $x^{2} - 4x - 1 = 0$, A student claims that the larger root minus the smaller equals $4.47213595499958$.`,
      `For $x^{2} + 5x + 6 = 0$, A clerk claims that the larger root minus the smaller equals $3$.`,
      `For $x^{2} - 3x - 4 = 0$, An examiner claims that the sum of the two roots equals $6$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The two real roots are $4$ and $-1$. One of them is negative, so they cannot both be positive. The claim fails, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $384 + 48x + 32x + 4x^{2} = 768$, A clerk claims that the discriminant equals $3072$.`,
      `A $30$ cm by $20$ cm picture with a uniform $2$ cm frame all round has outer rectangle $34$ cm by $24$ cm.. An examiner claims that the sum of the two roots equals $5$.`,
      `A $24$ cm by $16$ cm picture with a $4$ cm frame has outer area $768$ cm$^{2}$.. A candidate claims that the sum of the two roots equals $5$.`,
      `The wood in a $4$ cm frame around a $24$ cm by $16$ cm picture has area $500$ cm$^{2}$.. A student claims that the sum of the two roots equals $8$.`,
      `A $4$ cm frame around a $24$ cm by $16$ cm picture has wood area $384$ cm$^{2}$, equal to the picture, which is what twice the picture required of the outer area.. A clerk claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
So $384$ cm$^{2}$ of wood is exactly what "outer area twice the picture" required, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two positive integers differ by $5$ and multiply to $84$. Both integers exceed $6$.. A student claims that the sum of the two roots equals $5$.`,
      `Two consecutive positive integers multiply to $56$. Their sum is $15$.. A clerk claims that the sum of the two roots equals $5$.`,
      `A rectangle has width $w$ cm and length $3$ cm more than the width. Its area is $54$ cm$^{2}$. The width is $6$ cm.. An examiner claims that the sum of the two roots equals $5$.`,
      `Two numbers add to $13$ and multiply to $40$. The larger number. A candidate claims that the sum of the two roots equals $8$.`,
      `Two ticket prices add to $10$ EUR and multiply to $21$ EUR. Both prices exceed $4$ EUR.. A student claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A picture frame is $1$ cm longer than twice its width, and the area of the picture is $36$ cm$^{2}$. A candidate claims that the sum of the two roots equals $8$.`,
      `A banner is twice as long as it is wide and has area $48$ cm$^{2}$. A student claims that the sum of the two roots equals $8$.`,
      `A $4$ cm by $9$ cm noticeboard is to be edged with tape. The tape around the perimeter is claimed to measure $40$ cm.. A clerk claims that the sum of the two roots equals $8$.`,
      `A carpenter cuts a board $5$ cm wide and $11$ cm long and claims the area is $36$ cm$^{2}$, with the length $1$ cm more than twice the width.. An examiner claims that the sum of the two roots equals $8$.`,
      `A garden bed has area $45$ cm$^{2}$ and is $4$ cm longer than it is wide. The width that fits the area relation is a positive integer. A candidate claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [false, false, false, false, true],
    tactical_explanations: [
      `**A.** → False
...
The width is $5$ cm, a positive integer with $5 < 6$, so the property claim holds and the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A stone thrown upward has height $h = 24t - 6t^{2}$ metres after $t$ seconds. At $t = 1$ second the height is $18$ m.. An examiner claims that the sum of the two roots equals $5$.`,
      `A ball with height $h = 18t - 3t^{2}$ metres reaches a maximum height of $27$ m.. A candidate claims that the sum of the two roots equals $5$.`,
      `A projectile with height $h = 12t - 3t^{2}$ metres is back at ground level after $4$ seconds.. A student claims that the sum of the two roots equals $5$.`,
      `A stone with height $h = 20t - 4t^{2}$ metres is claimed to be $30$ m high after $2$ seconds.. A clerk claims that the sum of the two roots equals $8$.`,
      `A ball with height $h = 16t - 2t^{2}$ metres is claimed to reach its peak at $t = 5$ seconds.. An examiner claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
which is below the maximum of $32$ m at $t = 4$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two ticket prices add to $15$ EUR and multiply to $44$ EUR. The larger price. A clerk claims that the sum of the two roots equals $5$.`,
      `Two numbers add to $12$ and multiply to $32$. An examiner claims that the sum of the two roots equals $5$.`,
      `Two share amounts add to $9$ EUR and multiply to $14$ EUR. Both amounts exceed $5$ EUR.. A candidate claims that the sum of the two roots equals $8$.`,
      `Two numbers add to $8$ and multiply to $15$. Increasing each by $1$ and multiplying those increased values is claimed to give $24$.. A student claims that the sum of the two roots equals $5$.`,
      `Two numbers add to $13$ and multiply to $36$. The sum of their squares is then claimed to be $145$.. A clerk claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
The claimed sum of squares is $145$, not $97$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `One leg of a right triangle is $7$ cm longer than the other, and the hypotenuse is $13$ cm. The shorter leg is. A student claims that the sum of the two roots equals $5$.`,
      `A right triangle with legs $9$ cm and $12$ cm has hypotenuse $16$ cm.. A clerk claims that the sum of the two roots equals $8$.`,
      `A right triangle with legs $8$ cm and $15$ cm has hypotenuse $17$ cm.. An examiner claims that the sum of the two roots equals $5$.`,
      `A right triangle with legs $6$ cm and $8$ cm has perimeter $22$ cm.. A candidate claims that the sum of the two roots equals $8$.`,
      `A right triangle with legs $7$ cm and $24$ cm has area $84$ cm$^{2}$.. A student claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, false, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
The claimed area is $84$ cm$^{2}$, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has perimeter $40$ cm and area $96$ cm$^{2}$. The sides are $8$ cm and $12$ cm.. A candidate claims that the sum of the two roots equals $5$.`,
      `A rectangle is $3$ cm longer than it is wide, and its area is $54$ cm$^{2}$. The width is $6$ cm.. A student claims that the sum of the two roots equals $5$.`,
      `A square with perimeter $40$ cm has area $100$ cm$^{2}$.. A clerk claims that the sum of the two roots equals $5$.`,
      `A rectangle of width $7$ cm and length $11$ cm has area $77$ cm$^{2}$.. An examiner claims that the sum of the two roots equals $5$.`,
      `A rectangle of perimeter $30$ cm and area $56$ cm$^{2}$ has sides $6$ cm and $9$ cm.. A candidate claims that the sum of the two roots equals $8$.`,
    ],
...
so the sides are $7$ cm and $8$ cm, not $6$ cm and $9$ cm. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A parent is $20$ years older than a child, and the product of their present ages is $125$. The child is $5$ years old.. An examiner claims that the sum of the two roots equals $5$.`,
      `A parent is $12$ years older than a child, and the product of their present ages is $160$. The parent is $22$ years old.. A candidate claims that the sum of the two roots equals $8$.`,
      `A child is $7$ years old and a parent is $35$ years old. In $3$ years their ages will multiply to $304$.. A student claims that the sum of the two roots equals $8$.`,
      `If a parent is $15$ years older than a child, that age gap stays $15$ years as both grow older.. A clerk claims that the sum of the two roots equals $5$.`,
      `A child is $4$ years old and a parent is $24$ years old. Their present ages are in the ratio $5 : 1$.. An examiner claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, false, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
so the ratio is $6 : 1$, not $5 : 1$. The claim does not match the ratio, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $10$ m ladder leans against a wall. Its foot is $2$ m farther from the wall than the height it reaches. A clerk claims that the sum of the two roots equals $5$.`,
      `A $13$ m ladder leans against a warehouse wall and reaches $5$ m up. A worker claims the foot is $7$ m from the wall.. An examiner claims that the sum of the two roots equals $8$.`,
      `A $10$ m ladder reaches $6$ m up a wall. It is claimed that the foot therefore sits $8$ m from the base of the wall.. A candidate claims that the sum of the two roots equals $5$.`,
      `A right triangle with legs $9$ m and $12$ m has area $54$ m$^{2}$.. A student claims that the sum of the two roots equals $5$.`,
      `A $13$ m ladder stands with its foot $12$ m from a wall. A clerk claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The height is $5$ m, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `If $x + \\dfrac{2}{x} = 3$ with $x \\neq 0$, then $x^{2} + \\dfrac{4}{x^{2}} = 5$.. A student claims that the sum of the two roots equals $5$.`,
      `For $x^{2} - 4x + 3 = 0$, A clerk claims that the larger root minus the smaller equals $2$.`,
      `For $x + \\dfrac{5}{x} = 6$, An examiner claims that the larger root minus the smaller equals $4$.`,
      `If $x + \\dfrac{1}{x} = 3$ with $x \\neq 0$, then $x^{3} + \\dfrac{1}{x^{3}} = 27$.. A candidate claims that the sum of the two roots equals $8$.`,
      `For $x + \\dfrac{4}{x} = 5$, A student claims that the larger root minus the smaller equals $4$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
confirming two roots, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `All four solutions of $x^{4} - 10x^{2} + 9 = 0$ are integers.. A candidate claims that the sum of the two roots equals $5$.`,
      `For $x^{4} - 8x^{2} + 15 = 0$, A student claims that the discriminant equals $1$.`,
      `The sum of all four roots of $x^{4} - 5x^{2} + 4 = 0$ is $0$.. A clerk claims that the sum of the two roots equals $5$.`,
      `For $x^{4} - 3x^{2} + 2 = 0$, An examiner claims that the discriminant equals $6$.`,
      `For $x^{4} - 13x^{2} + 36 = 0$, A candidate claims that the discriminant equals $6$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
Then $x^{2} = 4$ gives $x = \\pm 2$, and $x^{2} = 9$ gives $x = \\pm 3$. The roots include $-2$ and $-3$, which are negative real numbers. The claim of no negative real solutions is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle is $8$ cm longer than it is wide, and its area is $240$ cm$^{2}$. The width is $12$ cm.. An examiner claims that the sum of the two roots equals $5$.`,
      `A rectangle is $5$ cm longer than it is wide, and its area is $84$ cm$^{2}$. Its diagonal is $13$ cm.. A candidate claims that the sum of the two roots equals $8$.`,
      `A rectangle of width $9$ cm and length $16$ cm has perimeter $50$ cm.. A student claims that the sum of the two roots equals $5$.`,
      `A rectangle of width $6$ cm whose length is $10$ cm more than its width has area $96$ cm$^{2}$.. A clerk claims that the sum of the two roots equals $5$.`,
      `A right triangle with legs $5$ cm and $12$ cm has area $30$ cm$^{2}$.. An examiner claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, false, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
The area is $30$ cm$^{2}$. The claim is that same figure, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two workers finish a job together in $4$ hours. One of them, working alone, is $6$ hours slower than the other. The faster worker alone takes. A clerk claims that the sum of the two roots equals $5$.`,
      `Two workers finish a job together in $6$ hours. One of them, working alone, is $5$ hours slower than the other. The slower worker alone takes more than $10$ hours.. An examiner claims that the sum of the two roots equals $5$.`,
      `For $\\frac{1}{t} + \\frac{1}{t + 4} = \\frac{1}{5}$, A candidate claims that the discriminant equals $6$.`,
      `Two pipes fill a tank together in $6$ hours. In $3$ hours together they fill half the tank.. A student claims that the sum of the two roots equals $5$.`,
      `Two workers who finish a job together in $4$ hours have combined rate $\\frac{1}{4}$ of a job per hour.. A clerk claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, true, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
of a job per hour. That is the claimed rate, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $x + \\dfrac{4}{x} = 4$, A student claims that the repeated root satisfies $x^{2} = 4$.`,
      `For $x + \\dfrac{3}{x} = 4$, A clerk claims that the discriminant equals $1$.`,
      `For $x^{2} - 6x + 8 = 0$, An examiner claims that the product of the two roots equals $8$.`,
      `For $x + \\dfrac{2}{x} = 3$ with $x \\neq 0$, the product of the two cleared solutions is $3$.. A candidate claims that the sum of the two roots equals $8$.`,
      `For $x + \\dfrac{12}{x} = 7$, A student claims that the discriminant equals $6$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
so there are two distinct real solutions, $3$ and $4$. Both check in the original equation. The claim of no real solutions is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `All four solutions of $x^{4} - 13x^{2} + 36 = 0$ are integers.. A candidate claims that the sum of the two roots equals $5$.`,
      `For $(x - 3)(x - 5) = 8$, A student claims that expanding gives a quadratic with two real roots.`,
      `For $x^{2} + x + 1 = 0$, A clerk claims that the discriminant equals $6$.`,
      `Two numbers that add to $9$ and multiply to $14$ are both. An examiner claims that the sum of the two roots equals $8$.`,
      `For $2x^{2} - 3x - 2 = 0$, A candidate claims that the product of the two roots equals $-2$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
Two distinct real roots, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{3}{x} = \\frac{1}{4}$, An examiner claims that twice the admissible solution, decreased by four, equals $20$.`,
      `For $\\frac{3}{x} = \\frac{1}{4}$, A candidate claims that twice the admissible solution, decreased by four, equals $-4$.`,
      `For $\\frac{5}{x} = 1$, A student claims that twice the admissible solution, decreased by four, equals $-1$.`,
      `For $\\frac{4}{x + 1} = \\frac{2}{3}$, A clerk claims that twice the admissible solution, decreased by four, equals $6$.`,
      `For $\\frac{3}{-12} = -\\frac{1}{4}$, An examiner claims that twice the admissible solution, decreased by four, equals $-25$.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $-\\frac{1}{4} \\neq \\frac{1}{4}$. The two sides of $\\frac{3}{x} = \\frac{1}{4}$ do not match, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x}{x + 3} = \\frac{2}{5}$, A clerk claims that twice the admissible solution, decreased by four, equals $0$.`,
      `For $\\frac{x}{x + 1} = \\frac{3}{4}$, An examiner claims that twice the admissible solution, decreased by four, equals $2$.`,
      `For $\\frac{x + 1}{x + 3} = \\frac{1}{2}$, A candidate claims that twice the admissible solution, decreased by four, equals $1$.`,
      `Clearing denominators in $\\dfrac{x}{x - 2} = 1$ allows the excluded value where $x - 2 = 0$ to still be a solution.. A student claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $\\frac{2x}{x + 5} = -\\frac{4}{3}$, A clerk claims that twice the admissible solution, decreased by four, equals $-8$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{2}{x - 3} = \\frac{8}{x - 3}$, A student claims that twice the admissible solution, decreased by four, equals $2$.`,
      `For $\\dfrac{5}{x + 2} = \\dfrac{5}{x + 2}$, A clerk claims that every admissible solution makes all denominators nonzero.`,
      `For $\\dfrac{7}{x - 2} = 0$, An examiner claims that clearing denominators yields a linear equation with no admissible root.`,
      `For $\\frac{1}{x} + \\frac{1}{x} = \\frac{3}{x}$, A candidate claims that twice the admissible solution, decreased by four, equals $-4$.`,
      `For $\\frac{4}{x} = \\frac{1}{3}$, A student claims that twice the admissible solution, decreased by four, equals $23$.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Check: $\\frac{4}{12} = \\frac{1}{3}$. The tank holds $12$ litres, not the claimed $8$ litres, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `For $\\sqrt{x + 3} = 4$, A student claims that after squaring both sides, checking whether $x + 5$ equals $18$ succeeds.`,
      `A square of area $13$ m$^{2}$ has side $\sqrt{13}$ m, and $\sqrt{13} > 3$.`,
      `For $\\sqrt{x + 7} = 5$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $23$ succeeds.`,
      `For $\\sqrt{x + 5} = 4$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $17$ succeeds.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\lvert x - 7 \\rvert = 4$, An examiner claims that the two solutions differ by $8$ units.`,
      `For $\\lvert x + 2 \\rvert = 5$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert 2x - 6 \\rvert = 10$, A student claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert x - 1 \\rvert = -3$, A clerk claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert 3x + 1 \\rvert = 7$, An examiner claims that twice the solution plus one equals $7$.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered values are $2$ and $-\\frac{8}{3}$, so there are two real solutions, not exactly one. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{5}{x - 1} = 1$, A clerk claims that twice the admissible solution, decreased by four, equals $8$.`,
      `For $\\frac{4}{x - 3} = 1$, An examiner claims that twice the admissible solution, decreased by four, equals $10$.`,
      `For $\\frac{5}{5} = 1$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\frac{8}{t} = 2$, A student claims that every admissible solution makes all denominators nonzero.`,
      `For $\\frac{5}{x - 1} = 1$, A clerk claims that twice the admissible solution, decreased by four, equals $-2$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
That is the cleared equation named in the claim, and it is valid precisely because $x \\neq 1$, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 7} = 5$, A student claims that after squaring both sides, checking whether $x + 5$ equals $23$ succeeds.`,
      `For $\\sqrt{3x - 2} = 4$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $11$ succeeds.`,
      `For $\\sqrt{x + 12} = 8$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $58$ succeeds.`,
      `For $\\sqrt{5x + 1} = 6$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $13$ succeeds.`,
      `For $\\sqrt{2x + 9} = 7$, A student claims that after squaring both sides, checking whether $x + 5$ equals $25$ succeeds.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{4x + 5} = 7$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $16$ succeeds.`,
      `For $\\sqrt{x + 3} = 6$, A student claims that after squaring both sides, checking whether $x + 5$ equals $38$ succeeds.`,
      `For $\\sqrt{9x - 5} = 10$, A clerk claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{x + 20} = 9$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $67$ succeeds.`,
      `For $\\sqrt{6x + 1} = 5$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A gauge should show twice a true reading. The absolute error from $4$ is $6$. The equation $|2x - 4| = 6$ has two distinct integer solutions. An examiner claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `Both numbers five units from $3$ on the number line are claimed to be positive.. A candidate claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $\\lvert 3x - 6 \\rvert = 9$, A student claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert 2x - 4 \\rvert = 6$, A clerk claims that twice the solution plus one equals $7$.`,
      `A student claims that the distance from twice a reading to $4$ is $4$, not $6$.. An examiner claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
The recorded distance is $6$, not $4$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x}{x - 1} = 3$, A clerk claims that twice the admissible solution, decreased by four, equals $-2$.`,
      `For $\\dfrac{1}{x - 2} = \\dfrac{3}{x - 2}$, An examiner claims that twice the admissible solution, decreased by four, equals $0$.`,
      `For $\\frac{x}{x - 4} = 2$, A candidate claims that twice the admissible solution, decreased by four, equals $12$.`,
      `For $\\frac{2}{x} = \\frac{3}{x + 3}$, A student claims that twice the admissible solution, decreased by four, equals $8$.`,
      `For $\\frac{x + 3}{x - 3} = 2$, A clerk claims that twice the admissible solution, decreased by four, equals $14$.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
At $x = 3$ the original is undefined, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 5} + \\sqrt{x - 3} = 4$, A student claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
      `For $\\sqrt{4x + 5} = 7$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $16$ succeeds.`,
      `For $\\sqrt{8 + 5} + \\sqrt{8 - 3} = \\sqrt{13} + \\sqrt{5}$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $10$ succeeds.`,
      `For $\\sqrt{x + 3} = 4$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $19$ succeeds.`,
      `For $\\sqrt{9} + \\sqrt{1} = 3 + 1 = 4$, A student claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
Both roots are defined, and the candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A stored temperature is $6^{\\circ}\\mathrm{C}$ away from $4^{\\circ}\\mathrm{C}$. One of the two possible readings is $10^{\\circ}\\mathrm{C}$.. A candidate claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `A machine part is specified at $50$ mm. The inspector flags pieces whose length is $3$ mm off that specification. The two boundary lengths are $47$ mm and $53$ mm.. A student claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $\\lvert 2x - 5 \\rvert = \\lvert x + 4 \\rvert$, A clerk claims that twice the solution plus one equals $21$.`,
      `A gauge error of $9$ units around a reading that is three times a value minus $6$ splits into two cases. Both $5$ and $-1$ check.. An examiner claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $\\lvert x \\rvert = -4$, A candidate claims that every admissible solution makes all denominators nonzero.`,
    ],
    answer_key: [true, true, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
asks an absolute value to equal a negative number. There is no real solution, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{2x + 1} = x - 1$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $5$ succeeds.`,
      `For $\\sqrt{x + 3} = x - 3$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $7$ succeeds.`,
      `For $\\sqrt{x + 1} = 3 - x$, A student claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{3x + 4} = x - 2$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $5$ succeeds.`,
      `For $\\sqrt{x - 2} = 4 - x$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
There is exactly one real solution, not two, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\lvert x - 3 \\rvert = 5$, A clerk claims that the two solutions differ by $10$ units.`,
      `For $\\lvert 2x + 1 \\rvert = 9$, An examiner claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert x - 4 \\rvert = \\lvert x + 2 \\rvert$, A candidate claims that twice the solution plus one equals $5$.`,
      `For $\\sqrt{x} + 3 = 7$, A student claims that after squaring both sides, checking whether $x + 5$ equals $21$ succeeds.`,
      `For $\\lvert x - 6 \\rvert + \\lvert x - 2 \\rvert = 8$, A clerk claims that twice the solution plus one equals $23$.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $12 \\neq 8$. The claimed point does not satisfy the equation, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x}{x - 3} = \\frac{x + 6}{x - 1}$, A student claims that twice the admissible solution, decreased by four, equals $2$.`,
      `For $\\frac{x + 2}{x - 4} = \\frac{x + 8}{x - 2}$, A clerk claims that twice the admissible solution, decreased by four, equals $10$.`,
      `For $\\frac{x}{x + 1} = \\frac{x + 3}{x - 2}$, An examiner claims that twice the admissible solution, decreased by four, equals $-3$.`,
      `For $\\frac{2x}{x + 5} = \\frac{x - 1}{x - 3}$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $1$ succeeds.`,
      `For $\\frac{x - 1}{x + 2} = \\frac{x + 4}{x - 5}$, A student claims that twice the admissible solution, decreased by four, equals $-8$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $-\\frac{1}{4}$, which is neither hole. That is the unique real solution, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{x + 1}{x} + \\frac{x}{x + 1} = \\frac{5}{2}$, A candidate claims that twice the admissible solution, decreased by four, equals $-4$.`,
      `For $\\frac{1}{x} + \\frac{1}{x + 1} = \\frac{3}{2}$, A student claims that twice the admissible solution, decreased by four, equals $-4$.`,
      `For $\\frac{3}{x} = \\frac{2}{x + 1}$, A clerk claims that twice the admissible solution, decreased by four, equals $-10$.`,
      `For $\\frac{1}{x} + \\frac{1}{x + 2} = \\frac{5}{6}$, An examiner claims that twice the admissible solution, decreased by four, equals $-1$.`,
      `For $\\frac{x + 3}{x} + \\frac{x}{x + 3} = \\frac{10}{3}$, A candidate claims that twice the admissible solution, decreased by four, equals $-1$.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The discriminant is $12^{2} - 4 \\cdot 4 \\cdot (-27) = 144 + 432 = 576 = 24^{2}$, which is positive. There are two real solutions, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{2x + 1} = 4 - x$, An examiner claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{x - 1} = 2 - x$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{x + 5} = x - 1$, A student claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
      `For $\\sqrt{3x + 1} = x + 1$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $6$ succeeds.`,
      `For $\\sqrt{x - 4} = 6 - x$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $11$ succeeds.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
There is exactly one real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 12} - \\sqrt{x} = 2$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
      `For $\\sqrt{x + 24} - \\sqrt{x} = 2$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $30$ succeeds.`,
      `For $\\sqrt{x + 8} - \\sqrt{x} = 1$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{x + 5} - \\sqrt{x} = 1$, A student claims that after squaring both sides, checking whether $x + 5$ equals $10$ succeeds.`,
      `For $\\sqrt{x + 20} - \\sqrt{x} = 4$, A clerk claims that every admissible solution makes all denominators nonzero.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $\\frac{1}{4}$, which is not divisible by $3$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The square root of a length plus $8$ m, plus the square root of the length itself, equals $6$ m. The length. A student claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `If $\\sqrt{x + 8} + \\sqrt{x} = 6$ and the recovered length is $\\frac{49}{9}$ m, then $\\sqrt{x} = \\frac{7}{3}$ at that length.. A clerk claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $\\sqrt{9 + 8} + \\sqrt{9} = \\sqrt{17} + 3$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $15$ succeeds.`,
      `Isolating $\\sqrt{x + 8} = 6 - \\sqrt{x}$ requires $6 - \\sqrt{x} \\ge 0$, otherwise the isolated side could not be a principal square root.. A candidate claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $\\sqrt{4 + 8} + \\sqrt{4} = \\sqrt{12} + 2$, A student claims that after squaring both sides, checking whether $x + 5$ equals $10$ succeeds.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered length is $\\frac{49}{9}$ m, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\lvert 3 - 2x \\rvert = x + 1$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert 2x + 1 \\rvert = 5$, A student claims that every admissible solution makes all denominators nonzero.`,
      `For $\\lvert 2x - 5 \\rvert = x + 1$, A clerk claims that twice the solution plus one equals $15$.`,
      `For $\\lvert x - 4 \\rvert = 2x - 1$, An examiner claims that twice the solution plus one equals $-5$.`,
      `For $\\lvert 5 - x \\rvert = 2x + 3$, A candidate claims that twice the solution plus one equals $-13$.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
There is a real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{1}{x - 1} - \\frac{1}{x + 1} = \\frac{1}{4}$, An examiner claims that twice the admissible solution, decreased by four, equals $2$.`,
      `For $\\sqrt{x + 3} = x - 3$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $7$ succeeds.`,
      `For $\\lvert x + 2 \\rvert = \\lvert 2x - 7 \\rvert$, A student claims that twice the solution plus one equals $19$.`,
      `For $\\sqrt{x + 4} = -2$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $6$ succeeds.`,
      `The simplified identity $\\frac{x^{2} - 4}{x - 2} = x$ is valid even where its denominator equals $0$, so that point is a root.. An examiner claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The identity does not hold at the hole, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\frac{2x + 1}{x - 1} - \\frac{x + 3}{x + 1} = 1$, A clerk claims that twice the admissible solution, decreased by four, equals $-14$.`,
      `For $\\frac{3x + 2}{x + 1} - \\frac{2x - 1}{x - 2} = 1$, An examiner claims that twice the admissible solution, decreased by four, equals $-6$.`,
      `For $\\dfrac{5x + 1}{x - 2} - \\dfrac{2x + 3}{x + 1} = 2$, A candidate claims that twice the admissible solution, decreased by four, equals $0$.`,
      `For $\\frac{x + 4}{x - 1} - \\frac{2x}{x + 2} = 1$, A student claims that twice the admissible solution, decreased by four, equals $-2$.`,
      `For $\\frac{2x - 1}{x + 3} - \\frac{x + 2}{x - 1} = 1$, A clerk claims that twice the admissible solution, decreased by four, equals $-7$.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $-\\frac{1}{5}$, which is neither hole. There is a real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk spends one-fifth of a purse, then one-quarter of what remains, then one-third of what is still left, and finally one-half of the last remainder, and has $18$ EUR. A student claims that 4 times the unknown, increased by $3$, equals $365$.`,
      `The tens digit of a two-digit number is $2$ more than the units digit, and the number plus its reverse equals $132$. The number exceeds $70$. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Pipe $A$ fills a tank in $20$ minutes and pipe $B$ in $30$ minutes. A leak empties the full tank in $60$ minutes. $A$ runs alone for $4$ minutes, $B$ then joins with the leak still closed for $3$ minutes, and finally the leak opens while both pipes stay on. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A father is $28$ years older than his son. Four years ago the father was five times as old as the son was then. The son is now a positive integer less than $15$ years old. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A vat holds $40$ litres of $25\\%$ acid. Eight litres are drawn off and replaced by $50\\%$ acid. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [false, true, false, true, false],
    tactical_explanations: [
      `**A.** → False
...
The vat starts with $10$ litres of pure acid. Drawing $8$ litres of the $25\\%$ mix removes $2$ litres of acid, leaving $8$ litres of acid in $32$ litres. Adding $8$ litres of $50\\%$ stock adds $4$ litres of acid, so $12$ litres of acid sit in $40$ litres, which is $30\\%$, not $32\\%$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A train $150$ m long passes a $250$ m platform in $24$ seconds. The train's speed exceeds $50$ km/h. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Between $2$ o'clock and $3$ o'clock the hands of a clock next overlap at $2{:}10$. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Thirty kilograms of $20\\%$ copper are mixed with some $70\\%$ copper to make a $40\\%$ alloy. Then $20$ kg of the richer alloy must be added. A clerk claims that 3 times the unknown, increased by $1$, equals $61$.`,
      `In a practice item, a linear equation in one unknown is posed. An examiner claims that isolating the unknown requires undoing exactly one multiplication or division step.`,
      `In $6$ years a father will be twice as old as his son will be then, and the father is now $30$ years older than the son. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The son is now $24$, not $18$. Eighteen would make them $48$ and $24$ in six years, but $48 \\neq 2 \\cdot 24$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The digits of a two-digit number add to $9$. If the digits are reversed, the new number is $9$ more than the original. The original number exceeds $40$. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A boat goes $36$ km downstream in $2$ hours and returns the same $36$ km upstream in $4$ hours. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A prize of $8000$ EUR is split so that second place gets half of first place and third place gets half of second place. Then second place is $2000$ EUR. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Fifteen workers finish a job in $10$ days. After $4$ days, $5$ workers leave. Then $5$ extra workers must be hired so that the remaining work still finishes on the original day $10$. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Three-quarters of a wage, plus $12$ EUR, equals twice the wage minus $20$ EUR. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
    answer_key: [true, false, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $2 \\cdot 64 - 20 = 108$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $60$ litre vat of $10\\%$ acid loses $12$ litres of water by evaporation, then $12$ litres of $40\\%$ acid are poured in. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Towns $180$ km apart send cars toward each other at $50$ km/h and $40$ km/h. The slower car starts $20$ minutes later. Then they meet $2$ hours after the faster car starts. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Five years ago a father was three times as old as his son. The father is now $30$ years older than the son. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A shop marks a price up by $20\\%$, then discounts the marked price by $10\\%$, then a loyalty card takes a further $2\\%$ off that discounted price. After these three adjustments the customer pays more than the original list price but less than $6\\%$ above it. A student claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `A tank is $\\dfrac{2}{5}$ full after $12$ minutes at a constant fill rate. The rate then increases by one-quarter. The remaining three-fifths fill in $15$ minutes. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
    ],
...
minutes, that is $14.4$ minutes, not $15$. Fifteen minutes at the new rate would cover $\\frac{5}{4} \\cdot \\frac{15}{30} = \\frac{5}{8}$ of the tank, which is more than the remaining $\\frac{3}{5}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk spends one-sixth of a purse, then one-fifth of the remainder, then one-quarter of what is still left, then one-third of the last remainder, and has $20$ EUR. A student claims that 3 times the unknown, increased by $1$, equals $183$.`,
      `Two litres of $12\\%$ vinegar are diluted with water to $8\\%$ vinegar. Then $1$ litre of water must be added. A clerk claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Pipes $A$, $B$, and $C$ finish a job in $6$, $8$, and $24$ hours. $A$ and $B$ run together for $2$ hours, then $C$ joins. Then $4$ more hours finish the job. An examiner claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Five consecutive integers have the property that four times the smallest exceeds the largest by $17$. The middle integer exceeds $15$. A candidate claims that translating the story and isolating the unknown requires undoing two inverse operations in order.`,
      `Fifty kilograms of $30\\%$ copper are mixed with some $90\\%$ copper to make a $50\\%$ alloy. Then $20$ kg of the richer alloy must be added. A student claims that the unknown, increased by $5$, equals $33$.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
Twenty-five kilograms of the richer alloy recover $50\\%$, not $20$ kg. Twenty kilograms would give $15 + 18 = 33$ kg of copper in $70$ kg, which is $47.1\\%$, not $50\\%$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      `For $x^{2} = 9$, the sum of the two real roots equals $3$.`,
      `A stone thrown upward has height $h = 30t - 5t^{2}$ metres after $t$ seconds. Then it is $40$ m high only at $t = 2$ seconds.. A student claims that the sum of the two roots equals $8$.`,
      `Two consecutive odd positive integers multiply to $143$. Their sum is $24$.. A clerk claims that the sum of the two roots equals $5$.`,
      `A positive number exceeds its reciprocal by $\\dfrac{8}{3}$. The positive solution is less than $2$. An examiner claims that the sum of the two roots equals $8$.`,
      `A rectangle of perimeter $48$ cm and area $135$ cm$^{2}$ is a square.. A candidate claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [false, false, true, false, false],
    tactical_explanations: [
      `**A.** → False
...
so the sides are $9$ cm and $15$ cm. A square would need equal sides, hence area $12^{2} = 144$ cm$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $26$ m ladder stands with its foot $10$ m from a wall. Then it reaches $24$ m up the wall.. An examiner claims that the sum of the two roots equals $5$.`,
      `A $13$ m ladder stands with its foot $5$ m from a wall. After the foot slips out to $9$ m from the wall, the top has dropped $4$ m.. A candidate claims that the sum of the two roots equals $8$.`,
      `Three consecutive even positive integers have the property that the sum of their squares is $200$. The middle integer. A student claims that the sum of the two roots equals $5$.`,
      `A stone has height $h = 24t - 4t^{2}$ metres. Then it is $32$ m high only at $t = 2$ seconds.. A clerk claims that the sum of the two roots equals $8$.`,
      `A rectangle has area $120$ cm$^{2}$ and its length is $1$ cm more than twice its width. The width. An examiner claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The width is $7.5$ cm, which does not exceed $8$ cm. An $8$ cm width would give length $17$ cm and area $136$ cm$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two workers finish a job together in $12$ hours. One of them, working alone, is $7$ hours slower than the other. The faster worker alone takes more than $15$ hours.. A clerk claims that the sum of the two roots equals $5$.`,
      `A rectangle has diagonal $13$ cm and area $60$ cm$^{2}$. Both sides are positive integers.. An examiner claims that the sum of the two roots equals $5$.`,
      `The product of two consecutive positive integers is $210$. The smaller integer. A candidate claims that the sum of the two roots equals $8$.`,
      `For $96 + 40x + 4x^{2} = 192$, A student claims that the sum of the two roots equals $3$.`,
      `An object falls from a tower with distance $5t^{2}$ metres in $t$ seconds. In the last $3$ seconds it covers $75$ m. The tower height. A clerk claims that the sum of the two roots equals $5$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The tower height is $5 \\cdot 4^{2} = 80$ m. Check: in $1$ second the object falls $5$ m, so the last $3$ seconds of a $4$ second fall cover $80 - 5 = 75$ m. The statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `One leg of a right triangle is $4$ cm longer than the other, and the hypotenuse is $20$ cm. The shorter leg. A student claims that the sum of the two roots equals $5$.`,
      `The area of a right triangle with hypotenuse $20$ cm and one leg $12$ cm is $100$ cm$^{2}$.. A clerk claims that the sum of the two roots equals $8$.`,
      `Two numbers add to $20$ and multiply to $84$. Both numbers are even.. An examiner claims that the sum of the two roots equals $5$.`,
      `A stone has height $h = 16t - 2t^{2}$ metres. Then it is $24$ m high at $t = 3$ seconds and at no other positive time.. A candidate claims that the sum of the two roots equals $8$.`,
      `For $384 - 80x + 4x^{2} = 240$, A student claims that the product of the two roots equals $-242$.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The root $x = 18$ would make the inner rectangle negative, so the path is $2$ m wide, not $4$ m. Check: inner $20$ by $12$ has area $240$. A $4$ m path would leave $16$ by $8$, which is $128$ m$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two numbers add to $15$ and the sum of their squares is $117$. Both numbers are divisible by $3$.. A candidate claims that the sum of the two roots equals $5$.`,
      `Two numbers have product $24$ and the sum of their squares is $73$. One of the numbers is prime.. A student claims that the sum of the two roots equals $5$.`,
      `For $\\ell^{2} + \\ell^{2} = 200$, A clerk claims that the discriminant equals $6$.`,
      `For $\\frac{1}{t} + \\frac{1}{t + 4} = \\frac{5}{24}$, An examiner claims that the discriminant equals $6$.`,
      `Three consecutive positive integers have the property that four times the middle one exceeds the product of the other two by $2$. The middle integer is a perfect square. A candidate claims that the sum of the two roots equals $8$.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
Neither root is a perfect square. The middle integer from the property is not a perfect square, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 21} = 2 + \\sqrt{x + 1}$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $21$ succeeds.`,
      `For $a = \\sqrt{x + 5}$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $9$ succeeds.`,
      `A depot on a straight road has distances to kilometre-post $1$ and kilometre-post $7$ that add to $10$ km. A student claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $2x + 1 = x^{2} + x - 2$, A clerk claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{2x + 6} = x - 1$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $11$ succeeds.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
Only $x = 5$ lies in the domain $x \\ge 1$, so there is exactly one real solution, not two. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $a = \\sqrt{x + 12}$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $19$ succeeds.`,
      `For $\\frac{1}{x - 1} + \\frac{1}{x + 1} = \\frac{(x + 1) + (x - 1)}{(x - 1)(x + 1)}$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $8$ succeeds.`,
      `For $\\lvert 2x - 4 \\rvert + \\lvert x - 5 \\rvert = 9$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\frac{x + 3}{x - 2} = \\frac{2x}{x + 1}$, A student claims that every admissible solution makes all denominators nonzero.`,
      `A surveyor records that the square root of a distance plus $8$ m, minus the square root of the distance itself, equals $1$ m. A clerk claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
The distance is $\\frac{49}{4}$ m, not $16$ m. Sixteen would give $\\sqrt{24} - 4$, which is not $1$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 5} = 1 + \\sqrt{x - 2}$, A student claims that after squaring both sides, checking whether $x + 5$ equals $16$ succeeds.`,
      `For $\\lvert x - 3 \\rvert + \\lvert 2x + 1 \\rvert = 11$, A clerk claims that twice the admissible solution, decreased by four, equals $13$.`,
      `For $2x - 2 - 3x - 3 = x^{2} - 1$, An examiner claims that clearing denominators yields a linear equation with no admissible root.`,
      `For $\\sqrt{4x - 3} = x - 1$, A candidate claims that every admissible solution makes all denominators nonzero.`,
      `For $\\dfrac{x^{2} - 9}{x - 3} = x + 5$, A student claims that twice the admissible solution, decreased by four, equals $5$.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
At $x = 3$ the left side is undefined. For $x \\neq 3$ the equation becomes $x + 3 = x + 5$, hence $3 = 5$, which never holds. There are no real solutions. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $a = \\sqrt{x + 15}$, A candidate claims that after squaring both sides, checking whether $x + 5$ equals $6$ succeeds.`,
      `For $\\lvert 3 - 2x \\rvert = \\lvert x + 4 \\rvert$, A student claims that twice the solution plus one equals $17$.`,
      `For $\\frac{1}{x} - \\frac{1}{x + 3} = \\frac{(x + 3) - x}{x(x + 3)}$, A clerk claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{2x + 1} = 4 - x$, An examiner claims that every admissible solution makes all denominators nonzero.`,
      `For $2x^{2} - 3x + 1 + x^{2} - x - 6 = 3x^{2} + 3x - 6$, A candidate claims that every admissible solution makes all denominators nonzero.`,
    ],
    answer_key: [true, false, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
This value is allowed because $\\frac{1}{7} \\neq -2$ and $\\frac{1}{7} \\neq 1$. So the equation has exactly one real solution, hence the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `For $\\sqrt{x + 24} = 2 + \\sqrt{x}$, An examiner claims that after squaring both sides, checking whether $x + 5$ equals $30$ succeeds.`,
      `A depot on a straight road has distances to kilometre-post $-2$ and kilometre-post $6$ that add to $12$ km. A candidate claims that clearing fractions leads to a linear equation whose solution makes every denominator nonzero.`,
      `For $2x + 2 - x + 3 = x^{2} - 2x - 3$, A student claims that every admissible solution makes all denominators nonzero.`,
      `For $\\sqrt{5x + 1} = x + 1$, A clerk claims that after squaring both sides, checking whether $x + 5$ equals $6$ succeeds.`,
      `For $x^{2} + 8x + 15 - (x^{2} - 3x + 2) = 2(x^{2} + 2x - 3)$, An examiner claims that every admissible solution makes all denominators nonzero.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
