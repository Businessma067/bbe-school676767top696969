...
export const MATH_CH4_EQUATIONS: MathTask[] = [
  {
    ...
    statements: [
      `A shop doubles a price and then adds $6$ EUR. The till shows $14$ EUR. An examiner claims that the recovered value exceeds $11$.`,
      `In a practice paper the equation $5x - 3 = 12$ appears. A candidate claims that its unique real solution is an even integer.`,
      `After $7$ EUR is taken off a bill, the remainder is split into two equal shares of $4$ EUR. A student claims that the original bill exceeds $10$ EUR.`,
      `The equation $3(x + 1) = 12$. A clerk claims the unique real solution is even.`,
      `Four times a recorded temperature change, plus $2$ degrees, equals $14$ degrees. An examiner claims that the recovered value exceeds $10$.`,
    ],
...
which is not $14$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A purse holds some coins and then $5$ EUR more. The total is $11$ EUR. The stallholder concludes that the purse started with $6$ EUR. A clerk claims that the recovered value exceeds $4$.`,
      `In a practice paper the equation $7x = 21$ appears. A candidate claims that its unique real solution is even.`,
      `After $8$ litres are poured out of a tank, the remainder is split into two equal drums of $5$ litres each. A candidate claims that the recovered value exceeds $32$.`,
      `The equation $6x = 30$. A student claims the recovered value exceeds $13$.`,
      `A scale shows a mass with no extra weight and reads $9$ kg. The mass in kilograms equals that scale reading. A clerk claims that the unique real solution is an odd integer.`,
    ],
...
That $9$ is the mass in kilograms, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A number increased by $4$ equals $11$. Translating the sentence into a linear equation and undoing the addition, the number is an odd integer greater than $5$. A student claims that the unique real solution is an odd integer.`,
      `Three times a number equals $18$. A clerk claims that the recovered value exceeds $14$.`,
      `After $8$ is subtracted from a number, the remainder is split into two equal parts of $6$. Restoring the operations, the original number is $20$. An examiner claims that the unique real solution is an even integer.`,
      `The equation $\\frac{x}{2} = 9$. A candidate claims the unique real solution exceeds $14$.`,
...
which is not $5$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A baker doubles a batch after adding $3$ g of starter. The scale then shows $14$ g. The baker reports that the original batch was $4$ g. A candidate claims that the recovered value exceeds $2$.`,
      `The equation $5(x - 2) = 20$. A student claims the unique real solution is an even integer.`,
      `A chemist takes twice a sample, adds $1$ ml, then triples the result. The flask shows $21$ ml. The chemist reports that the original sample was $4$ ml. A clerk claims that the recovered value exceeds $10$.`,
      `The equation $4(x - 5) = 12$. An examiner claims the unique real solution exceeds $6$.`,
      `Two rods are laid end to end. One is $3$ cm longer than a marked length, the other $1$ cm shorter than that same length. Together they measure $10$ cm. A candidate claims that the recovered value exceeds $2$.`,
    ],
...
which matches the total, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A jug is filled to one-fourth. That share is $5$ litres. An examiner claims that the recovered value exceeds $3$.`,
      ...
      `Two-fifths of a tank is $6$ litres. A student claims that the recovered value exceeds $14$.`,
      `The equation $\\dfrac{x + 1}{2} = 5$. A clerk claims the unique real solution is an odd integer.`,
      `One and a half times a wage equals $9$ EUR. An examiner claims that the recovered value exceeds $14$.`,
    ],
...
which is not $9$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has width $4$ cm and length $3$ cm more than the width. Writing the perimeter as twice the sum of the sides, that perimeter is $22$ cm. A clerk claims that the recovered value exceeds $2$.`,
      ...
      `Splitting $30$ into two parts where one part is $4$ more than the other gives the parts $17$ and $13$. A student claims that the unique real solution exceeds $10$.`,
      `A tank is first emptied of one-quarter of its contents, then a further $10$ litres, after which $20$ litres remain. The tank started with more than $35$ litres. A clerk claims that the unique real solution exceeds $30$.`,
    ],
...
That $40$ is the starting volume in litres. Check: a quarter of $40$ is $10$, so $30$ litres are left, then $10$ more leave $20$. The claim matches, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Twice a wage plus $3$ EUR equals three times the same wage minus $5$ EUR. A student claims that the recovered value exceeds $6$.`,
      `The equation $5 - x = 2x + 8$. A clerk claims the unique real solution is negative.`,
      `Four identical boxes, after $1$ unit is taken from each, match two boxes after $5$ extra units are added to each. A storekeeper reports that each box started with $7$ units. An examiner claims that the recovered value exceeds $5$.`,
      `The two linear equations $x + 3 = 10$ and $2x = 14$ are claimed to have the same unique real solution. A candidate claims that the unique real solution is an odd integer.`,
      `Seven times a length, minus $2$ cm, minus three times the same length, equals $10$ cm. The length satisfying the equation is a positive integer less than $5$ cm. A student claims that the unique real solution is an even integer.`,
    ],
...
which matches the right-hand side, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Half a tank plus one-third of the same tank is $5$ litres. A candidate claims that the recovered value exceeds $14$.`,
      `The proportion $\\dfrac{x - 1}{3} = \\dfrac{x + 1}{5}$ is cross-multiplied. A candidate claims that its unique real solution is odd.`,
      `Two-thirds of a bottle is $8$ ml. A clerk claims that the recovered value exceeds $23$.`,
      `The equation $\\dfrac{x}{4} - \\dfrac{x}{6} = 1$. An examiner claims the recovered value exceeds $23$.`,
      `A clerk triples a fee, adds $1$ EUR, and then divides the total into four equal parts of $4$ EUR. The original fee is less than $10$ EUR. A candidate claims that the unique real solution is an odd integer.`,
    ],
...
which matches the right-hand side, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has perimeter $22$ cm and one side is $3$ cm longer than the other. An examiner claims that the longer side exceeds $4$ cm.`,
      `A car travels at an average speed of $64$ km/h. At $3$ pm, it has traveled a total distance of $112$ km. Then it started traveling at $1{:}15$ pm. A candidate claims that exactly one real solution exists.`,
      `A recipe calls for $5\\%$ vinegar. If the cook only has $1$ litre of $8\\%$ vinegar, he needs to mix it with $0.6$ litres of water to get the right concentration. A student claims that the unique real solution is positive.`,
      `A prize money of $12200$ EUR is supposed to be split among the winners in a way that the $2$nd placed obtains $80\\%$ of the amount the $1$st placed obtains, and the $3$rd placed obtains $80\\%$ of the $2$nd placed. The second-place prize exceeds $3500$ EUR. A clerk claims that exactly one real solution exists.`,
      `The solution of the equation $2x + 1 = x + 8$ is an odd integer. An examiner claims that the unique real solution is an odd integer.`,
    ],
...
The unique real solution is $7$, which is an odd integer, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk adds $3$ EUR to a bill on one till and $5$ EUR to the same original bill on another till, and claims the two tills can still match if the original bill was $0$ EUR. A clerk claims that the recovered value exceeds $5$.`,
      `The equation $2(x + 4) = 2x + 8$. An examiner claims exactly one real solution exists.`,
      `Three times a temperature change, taken with the opposite sign, equals $12$ degrees. A candidate claims that the recovered value exceeds $11$.`,
      `The equation $5x + 2 = 5x + 2$ has identical sides. A candidate claims that it has no real solution.`,
      `The equation $0 = 1$. A clerk claims at least one real solution exists.`,
    ],
...
which is never true. So the equation has no real solution, not infinitely many. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A father is $28$ years older than his son. In $8$ years the father will be twice as old as the son will be then. The son is now $20$ years old. A student claims that exactly one real solution exists.`,
      `The sum of three consecutive odd integers is $75$. The largest of them is $29$. A clerk claims that no real solution exists.`,
      `A purse holds only $2$ EUR coins and $5$ EUR coins. There are $16$ coins in all, worth $53$ EUR. Then there are $7$ coins of $5$ EUR. An examiner claims that the unique real solution is an odd integer.`,
      `Water flows into an empty tank at $15$ litres per minute. After $12$ minutes the tank is four-fifths full, so the tank's capacity is $180$ litres. A candidate claims that the recovered value exceeds $343$.`,
      `If a number is increased by one-third of itself, the result is $48$. A student claims that the recovered value exceeds $59$.`,
    ],
...
which is not $48$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A runner covers $9$ km at $6$ km/h and then $6$ km at $9$ km/h. The whole run takes $2$ hours. A candidate claims that no real solution exists.`,
      `Two printers working together finish a job in $4$ hours. The faster one alone would take $6$ hours. The slower printer alone takes more than $10$ hours. A student claims that exactly one real solution exists.`,
      `A train $180$ m long passes a pole in $12$ seconds. Its speed is $54$ km/h. A clerk claims that exactly one real solution exists.`,
      `A car leaves a depot at $8{:}00$ at $60$ km/h. A second car leaves the same depot at $9{:}00$ at $90$ km/h, chasing the first. They meet at noon. An examiner claims that no real solution exists.`,
      `A tap fills a $240$ litre tub in $8$ minutes. Left open for $5$ minutes it pours $150$ litres. A candidate claims that exactly one real solution exists.`,
    ],
...
litres, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $2(b + 5) + b = 40$. An examiner claims exactly one real solution exists.`,
      `A rectangular garden is $3$ m longer than it is wide. Fencing all four sides uses $54$ m of wire. The width exceeds $10$ m. A candidate claims that exactly one real solution exists.`,
      `The three angles of a triangle, measured in degrees, are consecutive integers. The largest angle is $61^{\\circ}$. A student claims that exactly one real solution exists.`,
      `A square and an equilateral triangle have the same side length. The triangle's perimeter is $12$ cm, so the square's perimeter is $16$ cm. A clerk claims that exactly one real solution exists.`,
      `A rectangle has width $8$ cm. If the length is increased by $2$ cm and the width is left unchanged, the perimeter increases by $4$ cm. An examiner claims that exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
The width does not enter that difference. The perimeter increases by $4$ cm, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A stall sells apples at $2$ EUR per kilogram and pears at $3$ EUR per kilogram. A customer buys some kilograms of each, pays $21$ EUR in total, and takes $3$ kg more apples than pears. The customer therefore bought $3$ kg of pears. A clerk claims that the unique real solution is an odd integer.`,
      `Notebooks cost $4$ EUR each and pens cost $2$ EUR each. A student buys $5$ more pens than notebooks and pays $22$ EUR in all. The student bought fewer than $5$ notebooks. An examiner claims that the unique real solution is an even integer.`,
      `Tea is $5$ EUR per kilogram and sugar is $2$ EUR per kilogram. A shopper takes twice as much tea as sugar and pays $24$ EUR. The tea alone accounted for more than $15$ EUR of the bill. A candidate claims that the recovered value exceeds $18$.`,
      `If a customer buys $5$ kg of apples at $2$ EUR per kilogram and $2$ kg of pears at $3$ EUR per kilogram, the bill is $16$ EUR. A student claims that the recovered value exceeds $12$.`,
      `Bread costs $2$ EUR a loaf and milk costs $1.5$ EUR a carton. Four loaves and two cartons come to $11$ EUR, so milk made up less than one-third of that bill. A clerk claims that exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
and $3 < \\frac{11}{3}$. Milk made up less than one-third of the bill, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A chemist has a vat of $20\\%$ acid. Two litres are drawn off and replaced with water, after which the mixture is $16\\%$ acid. The chemist concludes that the vat originally held $10$ litres. A student claims that the recovered value exceeds $8$.`,
      ...
      `After a $20\\%$ discount a jacket costs $64$ EUR. A shop assistant says the original price must therefore have been $90$ EUR. An examiner claims that no real solution exists.`,
      `A listed price is first raised by $25\\%$ and then reduced by $25\\%$. A candidate claims that the recovered value exceeds $100$.`,
      `A salary of $2400$ EUR is increased by $10\\%$ and then by a further $10\\%$. A student claims that the recovered value exceeds $100$.`,
    ],
...
The new salary is $2904$ EUR, not $2880$ EUR. The figure $2880$ would be a single $20\\%$ raise on $2400$, which is not the same as two successive $10\\%$ raises. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Towns $X$ and $Y$ are $132$ km apart. At noon a car leaves $X$ toward $Y$ at $48$ km/h. Thirty minutes later a second car leaves $Y$ toward $X$ at $72$ km/h. They meet $54$ minutes after noon. A candidate claims that exactly one real solution exists.`,
      ...
      `A boat goes $24$ km downstream in $2$ hours and returns the same $24$ km upstream in $3$ hours. The boat's speed in still water is then $12$ km/h. A clerk claims that no real solution exists.`,
      `A cyclist rides to town at $15$ km/h and back at $10$ km/h. If the one-way distance is $30$ km, the round trip takes $4$ hours, because each leg is supposedly two hours if you average the two times. An examiner claims that the recovered value exceeds $100$.`,
      `A car leaves town $X$ at $48$ km/h. After a $30$ minute head start it has covered $24$ km. A candidate claims that exactly one real solution exists.`,
    ],
    answer_key: [true, false, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
That $24$ is the head-start distance in kilometres, matching the claim, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A metal rod is $2.4$ m long. It is cut into two pieces so that one piece is $60$ cm longer than the other. The shorter piece is $90$ cm. An examiner claims that the recovered value exceeds $68$.`,
      `The mean of three numbers is $14$. Two of them are $11$ and $15$. The third is $18$. A candidate claims that no real solution exists.`,
      `A recipe for $8$ portions uses $600$ g of flour. For $12$ portions one therefore needs $1000$ g of flour. A student claims that no real solution exists.`,
      `A rectangle's length is twice its width. The perimeter is $48$ cm, so the width is $10$ cm. A clerk claims that the recovered value exceeds $17$.`,
      `Three-fifths of a number is $12$ more than one-fifth of the same number. The number is $25$. An examiner claims that the unique real solution exceeds $50$.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
which is not $12$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{3x - 1}{4} + \\dfrac{x + 3}{2} = 5$. A clerk claims the unique real solution is an odd integer.`,
      `The equation $\\frac{x + 1}{2} - \\frac{x - 1}{3} = 2$. An examiner claims the unique real solution is an odd integer.`,
      `The least common multiple of $3$, $4$, and $6$ is $12$, so multiplying a three-denominator linear equation with those denominators through by $12$ is the economical clearing. A candidate claims that exactly one real solution exists.`,
      `Half a wage plus one-third of the same wage is $5$ EUR. A student claims that the recovered value exceeds $14$.`,
      `The equation $\\dfrac{2x + 1}{5} = \\dfrac{x - 4}{3}$. A clerk claims the unique real solution is negative.`,
    ],
...
The recovered solution is $x = -23$, which is not positive. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A workshop bills $40$ EUR per hour for the first $3$ hours of a job and $60$ EUR per hour after that, plus a fixed $50$ EUR for parts. One job comes to $290$ EUR. The job ran for more than $4$ hours. A student claims that exactly one real solution exists.`,
      `A plumber charges $45$ EUR per hour plus a $30$ EUR call-out fee. A visit that comes to $165$ EUR therefore lasted $3$ hours. A clerk claims that exactly one real solution exists.`,
      `On a $290$ EUR workshop job billed at $40$ EUR per hour for the first $3$ hours, $60$ EUR per hour after that, and $50$ EUR for parts, labour was billed at $240$ EUR, with the remaining $50$ EUR being parts. An examiner claims that exactly one real solution exists.`,
      `The two-band tariff of $40$ EUR per hour for the first $3$ hours and $60$ EUR per hour after that, plus $50$ EUR parts, would also cost $290$ EUR for a $4$ hour job, because overtime would already have started. A candidate claims that no real solution exists.`,
      `A $50$ EUR parts charge on a $290$ EUR bill is less than one-fifth of that bill. A student claims that exactly one real solution exists.`,
    ],
...
and $50 < 58$. Parts are less than one-fifth of the bill, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A cyclist rides at $15$ km/h for $2$ hours, then at $10$ km/h for $1$ hour. The total distance covered is $40$ km. A candidate claims that exactly one real solution exists.`,
      `Two trains leave stations $120$ km apart and approach each other at $40$ km/h and $20$ km/h. A dispatcher claims they meet after $2$ hours. A student claims that exactly one real solution exists.`,
      ...
      `A hiker walks at $5$ km/h for $2.4$ hours. The distance covered is $12$ km. A candidate claims that exactly one real solution exists.`,
    ],
...
The hiker covers $12$ km. The claim is that same distance, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A father is now four times as old as his son. In $20$ years the father will be twice as old as the son will be then. The son is now $10$ years old. An examiner claims that exactly one real solution exists.`,
      `A mother is three times as old as her daughter. In $12$ years the mother will be twice as old as the daughter will be then. The daughter is now $12$ years old. A candidate claims that exactly one real solution exists.`,
      `A father who is now $40$ will be $50$ in $20$ years. A student claims that no real solution exists.`,
      `If a father is now $40$ and his son is now $10$, their ages differ by $30$ years, and that gap does not change as both grow older. A clerk claims that exactly one real solution exists.`,
      `Five years ago a father of $40$ and a son of $10$ were in the ratio five to one. An examiner claims that no real solution exists.`,
    ],
...
They were in the ratio seven to one, not five to one. Five to one would have required ages $35$ and $7$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two trains $180$ m and $320$ m long run toward each other at $72$ km/h and $108$ km/h. From the instant their fronts meet until they have completely passed takes $10$ seconds. A clerk claims that exactly one real solution exists.`,
      `A motorcyclist's steady speed of $54$ km/h is equivalent to $15$ m/s. An examiner claims that the unique real solution is an odd integer.`,
      `Two trains $150$ m and $250$ m long run in the same direction at $90$ km/h and $54$ km/h. The faster train takes $20$ seconds to pass the slower completely. A candidate claims that no real solution exists.`,
      `A courier rides $45$ km at a steady $15$ km/h. The journey lasts $15$ minutes. A student claims that no real solution exists.`,
      `Converting $36$ km/h to metres per second gives $12$ m/s. A clerk claims that no real solution exists.`,
    ],
...
The conversion is $10$ metres per second, not $12$. The claimed $12$ m/s would be the conversion of $43.2$ km/h, not of $36$ km/h, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A vat holds $40$ litres of $20\\%$ acid. Ten litres of water are added. The vat is then $16\\%$ acid. A student claims that exactly one real solution exists.`,
      `Starting from that $50$ litre mixture at $16\\%$, a $50\\%$ acid stock is poured in until the mixture is $25\\%$ acid. Then $18$ litres of stock must be added. A clerk claims that the recovered value exceeds $6$.`,
      `After that stock is added, the final volume is $68$ litres. An examiner claims that the recovered value exceeds $51$.`,
      `The final $25\\%$ mixture contains $20$ litres of acid. A candidate claims that no real solution exists.`,
      `The final $25\\%$ mixture contains $17$ litres of acid, which is $25\\%$ of $68$ litres. A student claims that exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
The final mixture contains $17$ litres of acid, which is $25\\%$ of $68$ litres. The claim matches that check, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A farmer has a rectangular field that is $8$ m longer than it is wide. Around the outside he lays a gravel path $1.5$ m wide covering $141$ m$^{2}$. A candidate claims that the recovered value exceeds $8$.`,
      `A gardener has a rectangular lawn that is $4$ m longer than it is wide. Around the outside she lays a $1$ m flower border covering $48$ m$^{2}$, and she concludes that the lawn is $9$ m wide. A student claims that exactly one real solution exists.`,
      `A sports pitch measures $12$ m by $20$ m. The groundskeeper adds a uniform $2$ m running path around the outside and reports that the outer length is then $24$ m. A clerk claims that the recovered value exceeds $0$.`,
      `A $12$ m by $8$ m patio is given a $1$ m path around the outside. The groundskeeper claims that this path covers $44$ m$^{2}$. An examiner claims that exactly one real solution exists.`,
      `Walking once around a $20$ m by $30$ m rectangular field is claimed to cover a distance of $100$ m. A candidate claims that exactly one real solution exists.`,
    ],
    answer_key: [false, true, true, true, true],
    tactical_explanations: [
      `**A.** → False
...
The walk covers $100$ m. The claim is that same distance, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `$A$ finishes a job in $12$ days, $B$ in $18$ days, and $C$ in $24$ days. $A$ and $B$ work together for $2$ days, then $C$ joins. After $C$ joins, the three still need $6$ days. An examiner claims that no real solution exists.`,
      `The equation $1 - \\frac{5}{18} = \\frac{13}{18}$. A candidate claims exactly one real solution exists.`,
      `Then all three need $4$ more days to finish. A student claims that exactly one real solution exists.`,
      `$C$ alone would finish that remainder in $8$ days. A clerk claims that no real solution exists.`,
      `The equation $= \\frac{6}{72} + \\frac{4}{72} + \\frac{3}{72}$. An examiner claims exactly one real solution exists.`,
    ],
    answer_key: [false, true, true, false, true],
    tactical_explanations: [
      `**A.** → False
...
The three together do $\\frac{13}{72}$ of a job per day. The claim is that same rate, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $240$ km trip is driven in two equal $120$ km legs at $80$ km/h then $60$ km/h. The total driving time exceeds $3$ hours. A clerk claims that exactly one real solution exists.`,
      ...
      `A courier drives $100$ km to a client at $50$ km/h and returns the same route at $25$ km/h. The round trip takes $6$ hours. A candidate claims that exactly one real solution exists.`,
      `On a $160$ km journey, the first $80$ km are driven at $80$ km/h. That first leg takes exactly $1$ hour. A student claims that exactly one real solution exists.`,
      `A motorist covers $200$ km in $4$ hours of clock time, including a $30$ minute rest. Without the rest, the average driving speed would be $50$ km/h. A clerk claims that no real solution exists.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
km, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `In a $100$ m race, $A$ beats $B$ by $20$ m, and $B$ beats $C$ by $25$ m. When $A$ has run $100$ m, $C$ has run $60$ m. A student claims that exactly one real solution exists.`,
      `The speed ratio of $A$ to $B$ in that race is $4 : 5$. A clerk claims that no real solution exists.`,
      `$A$ beats $C$ by $50$ m in a $100$ m race. An examiner claims that no real solution exists.`,
      `The speed ratio of $A$ to $C$ is $5 : 3$. A candidate claims that exactly one real solution exists.`,
      `When $A$ has run $100$ m, $B$ has run $80$ m, which is the opening handicap of $A$ against $B$. A student claims that exactly one real solution exists.`,
    ],
...
When $A$ has run $100$ m, $B$ has run $80$ m. That is the opening handicap of $A$ against $B$. The claim matches that reading, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `If $3$ is taken off a sample and the remainder is split into four equal parts, each part is $2$ ml less than one-third of the original sample. The original sample exceeds $10$ ml. A candidate claims that exactly one real solution exists.`,
      `If $5$ is added to a number and the sum is halved, the result is $3$ less than the original number. A student claims that the recovered value exceeds $100$.`,
      `Three consecutive integers add to $48$. The middle integer is even. A clerk claims that exactly one real solution exists.`,
      `If $1$ is added to a number and the sum is divided by $5$, the result is $3$ less than half the number. An examiner claims that the recovered value exceeds $100$.`,
      `The equation $12 \\cdot \\frac{5}{2} = 30$. A candidate claims exactly one real solution exists.`,
    ],
...
minutes. The tank is full after $30$ minutes. The claim is that same time, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $s^{2} = 49$. An examiner claims exactly one real solution exists.`,
      `The equation $x^{2} = a$. A candidate claims exactly one real solution exists.`,
      `The equation $x^{2} = a$. A student claims exactly one real solution exists.`,
      `The equation $x^{2} = 9$. A clerk claims exactly two distinct real solutions exist.`,
      `$5^{2} - 4^{2}$ equals $7$.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
...
The difference is $9$, not $7$. The claimed $7$ would be $5 + 2$, not $25 - 16$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A product of two factors, one two less than a number and one five less than the same number, is zero. A clerk claims that the recovered value exceeds $13$.`,
      `A number squared, minus five times the number, plus six, is zero. . An examiner claims that the equation has two distinct positive integer roots.`,
      `A number squared, minus nine, is zero. A candidate claims that the recovered value exceeds $10$.`,
      `If a product of two real numbers is zero, then at least one of those numbers is zero. A student claims that exactly one real solution exists.`,
      `The equation $x^{2} = 5x$. A clerk claims the recovered value exceeds $13$.`,
    ],
...
Then $x = 0$ or $x = 5$. One root is zero, which is not positive. Both roots cannot be positive, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $s^{2} = 81$. A student claims exactly one real solution exists.`,
...
The claim $8$ cm does not match, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $x^{2} - 4x = 0$. A candidate claims the recovered value exceeds $11$.`,
      `A number squared, minus four times the number, is zero. Zero itself is not allowed.`,
      `The discriminant of $x^{2} - 4x + 4$ is $4$.`,
      `The equation $x^{2} - 4x + 4 = 0$. An examiner claims exactly one real solution exists.`,
...
The root $x = 2$ appears twice, so the equation has a repeated root. The claim matches that count, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A monic quadratic is written with middle term matching a sum of $7$ and constant term $10$. An examiner claims that exactly one real solution exists.`,
      `For the monic quadratic $x^{2} - 9x + 20 = 0$, the product of the roots is $20$.`,
      `Two integers add to $7$ and multiply to $10$. Both integers are . A student claims that greater than $2$.`,
      `The larger root of $x^{2} - 7x + 10 = 0$ . A clerk claims that exceeds $5$.`,
      `A coach claims that both scores that add to $7$ and multiply to $10$ are . An examiner claims that greater than $4$.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
Then $5 > 4$, but $2$ is not greater than $4$. Both greater than $4$ would require a different pair. The claim fails for the smaller number, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The quadratic equation $x^{2} - 5x + 6 = 0$ has two distinct positive real roots. A clerk claims that exactly two distinct real solutions exist.`,
      `The discriminant of $x^{2} + 2x + 5 = 0$ is $4$.`,
      `The equation $x^{2} - 4x + 4 = 0$. A candidate claims the unique real solution is an even integer.`,
      `The quadratic $x^{2} + 3x - 10 = 0$ has a negative root whose absolute value . A student claims that exceeds $4$.`,
      `The equation $x^{2} - 2x - 8 = 0$. A clerk claims exactly one real solution exists.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
That is the opening relation of the $48$ cm$^{2}$ rectangle. The sides differ by $2$ cm whether or not one first recovers the widths $6$ and $8$. The claim matches that relation, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two consecutive integers multiply to $56$. The equation $n^{2} + n - 56 = 0$ has two distinct integer roots. A candidate claims that exactly one real solution exists.`,
...
They add to $15$. The claim is that same sum, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A rectangle has area $60$ cm$^{2}$, and its length is $7$ cm more than its width. The width is a positive integer . An examiner claims that less than $6$ cm.`,
...
which is not $45$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $(x - 5)(x + 3) = 0$. A clerk claims the unique real solution is positive.`,
...
The legs are $3$ cm and $4$ cm, so the longer leg is $4$ cm. The claim is that same length, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $x^{2} - 6x + 10 = 0$. A student claims no real solution exists.`,
      `The equation $2x^{2} + 4x + 2 = 0$. A clerk claims the unique real solution is an odd integer.`,
      `The equation $x^{2} + x - 12 = 0$. An examiner claims exactly two distinct real solutions exist.`,
      `The equation $x^{2} + 2x + 3 = 0$. A candidate claims at least one real solution exists.`,
      `The equation $3x^{2} - 2x + 1 = 0$. A student claims no real solution exists.`,
    ],
    answer_key: [true, true, true, false, true],
    tactical_explanations: [
      `**A.** → True
...
Since $\\Delta < 0$, there are no real solutions. The claim matches that count, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Two numbers add to $13$ and multiply to $36$. Both are . An examiner claims that greater than $6$.`,
      `Two numbers add to $8$ and multiply to $15$. Each of them . A candidate claims that is negative.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The numbers are $3$ and $5$, both positive. A negative pair with product $15$ would need a negative sum as well, because a negative times a negative is positive and the sum of two negatives is negative. The sum here is $8 > 0$, so both numbers are positive. The claim that each is negative is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Completing the square turns $x^{2} + 6x + 5 = 0$ into $\\left(x + 3\\right)^{2} = 4$. An examiner claims that exactly one real solution exists.`,
      `The quadratic $x^{2} - 8x + 12 = 0$ factors as $(x - 2)(x - 6)$.`,
      `Completing the square turns $x^{2} - 4x - 1 = 0$ into $\\left(x - 2\\right)^{2} = 5$. A student claims that exactly one real solution exists.`,
...
The two real roots are $4$ and $-1$. One of them is negative, so they cannot both be positive. The claim fails, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $24$ cm by $16$ cm picture is surrounded by a uniform frame. The outer area is twice the picture. The frame width is a positive integer . A clerk claims that less than $5$ cm.`,
...
So $384$ cm$^{2}$ of wood is exactly what "outer area twice the picture" required, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Two numbers add to $13$ and multiply to $40$. The larger number . A candidate claims that exceeds $8$.`,
...
so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `A garden bed has area $45$ cm$^{2}$ and is $4$ cm longer than it is wide. The width that fits the area relation is a positive integer . A candidate claims that less than $6$ cm.`,
    ],
    answer_key: [false, false, false, false, true],
    tactical_explanations: [
      `**A.** → False
...
which is below the maximum of $32$ m at $t = 4$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two ticket prices add to $15$ EUR and multiply to $44$ EUR. The larger price . A clerk claims that exceeds $10$ EUR.`,
...
The claimed sum of squares is $145$, not $97$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `One leg of a right triangle is $7$ cm longer than the other, and the hypotenuse is $13$ cm. The shorter leg is . A student claims that less than $6$ cm.`,
...
so the ratio is $6 : 1$, not $5 : 1$. The claim does not match the ratio, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $10$ m ladder leans against a wall. Its foot is $2$ m farther from the wall than the height it reaches. A clerk claims that exactly one real solution exists.`,
      ...
      `A $13$ m ladder stands with its foot $12$ m from a wall. A clerk claims that the recovered value exceeds $100$.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The height is $5$ m, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $x + \\dfrac{5}{x} = 6$. An examiner claims exactly two distinct real solutions exist.`,
      `If $x + \\dfrac{1}{x} = 3$ with $x \\neq 0$, then $x^{3} + \\dfrac{1}{x^{3}} = 27$.`,
      `The equation $x + \\dfrac{4}{x} = 5$. A student claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
confirming two roots, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $x^{4} - 8x^{2} + 15 = 0$. A student claims exactly one real solution exists.`,
      `The sum of all four roots of $x^{4} - 5x^{2} + 4 = 0$ is $0$.`,
      `The equation $x^{4} - 3x^{2} + 2 = 0$. An examiner claims no real solution exists.`,
      `The equation $x^{4} - 13x^{2} + 36 = 0$. A candidate claims no real solution exists.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The area is $30$ cm$^{2}$. The claim is that same figure, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Two workers finish a job together in $4$ hours. One of them, working alone, is $6$ hours slower than the other. The faster worker alone takes . A clerk claims that less than $8$ hours.`,
      ...
      `The equation $\\frac{1}{t} + \\frac{1}{t + 4} = \\frac{1}{5}$. A candidate claims the recovered value exceeds $100$.`,
...
of a job per hour. That is the claimed rate, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $x + \\dfrac{4}{x} = 4$. A student claims the unique real solution is an even integer.`,
      `The equation $x + \\dfrac{3}{x} = 4$. A clerk claims exactly one real solution exists.`,
      ...
      `The equation $x + \\dfrac{12}{x} = 7$. A student claims exactly one real solution exists.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
so there are two distinct real solutions, $3$ and $4$. Both check in the original equation. The claim of no real solutions is incorrect, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $(x - 3)(x - 5) = 8$. A student claims the unique real solution is positive.`,
      `The equation $x^{2} + x + 1 = 0$. A clerk claims exactly one real solution exists.`,
      `Two numbers that add to $9$ and multiply to $14$ are both . An examiner claims that greater than $5$.`,
      `The equation $2x^{2} - 3x - 2 = 0$. A candidate claims exactly two distinct real solutions exist.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
Two distinct real roots, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Three litres of oil, poured as equal shares, fill a jerrycan if each share is one-fourth of the jerrycan. The jerrycan . An examiner claims that holds more than $10$ litres.`,
      `The equation $\\frac{3}{x} = \\frac{1}{4}$. A candidate claims the unique real solution is divisible by $6$.`,
      `Five litres poured as equal shares fill a can if each share is the whole can. A student claims that the recovered value exceeds $13$.`,
      `The equation $\\dfrac{4}{x + 1} = \\dfrac{2}{3}$. A clerk claims the unique real solution is positive.`,
...
and $-\\frac{1}{4} \\neq \\frac{1}{4}$. The two sides of $\\frac{3}{x} = \\frac{1}{4}$ do not match, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{x}{x + 3} = \\dfrac{2}{5}$. A clerk claims the unique real solution is an integer.`,
      `The equation $\\dfrac{x}{x + 1} = \\dfrac{3}{4}$. An examiner claims the unique real solution is positive.`,
      `The equation $\\dfrac{x + 1}{x + 3} = \\dfrac{1}{2}$. A candidate claims the unique real solution exceeds $7$.`,
      `Clearing denominators in $\\dfrac{x}{x - 2} = 1$ allows the excluded value where $x - 2 = 0$ to still be a solution.`,
      `The equation $\\dfrac{2x}{x + 5} = -\\dfrac{4}{3}$. A clerk claims the unique real solution is negative.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{2}{x - 3} = \\dfrac{8}{x - 3}$. A student claims the unique real solution is an odd integer.`,
      `The equation $\\dfrac{5}{x + 2} = \\dfrac{5}{x + 2}$. A clerk claims no real solution exists.`,
      `The equation $\\dfrac{7}{x - 2} = 0$. An examiner claims no real solution exists.`,
      `The equation $\\dfrac{1}{x} + \\dfrac{1}{x} = \\dfrac{3}{x}$. A candidate claims the unique real solution is an even integer.`,
      `Four litres poured as equal shares fill a tank if each share is one-third of the tank. A student claims that the recovered value exceeds $23$.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
Check: $\\frac{4}{12} = \\frac{1}{3}$. The tank holds $12$ litres, not the claimed $8$ litres, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A gardener adds $3$ m$^{2}$ of soil to a square bed. The new bed is still square, and each side is $4$ m. A candidate claims that the new area exceeds $15$ m$^{2}$.`,
      `The equation $\\sqrt{x + 3} = 4$. A student claims the unique real solution is an odd integer.`,
      `A square of area $13$ m$^{2}$ has side $\\sqrt{13}$ m. A student claims that the side length is positive.`,
      `The equation $\\sqrt{x + 7} = 5$. An examiner claims the unique real solution is positive.`,
      `The equation $\\sqrt{x + 5} = 4$. A candidate claims the unique real solution exceeds $20$.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\lvert x - 7 \\rvert = 4$. An examiner claims exactly two distinct real solutions exist.`,
      `The equation $\\lvert x + 2 \\rvert = 5$. A candidate claims the unique real solution is negative.`,
      `The equation $\\lvert 2x - 6 \\rvert = 10$. A student claims the unique real solution is negative.`,
      `The equation $\\lvert x - 1 \\rvert = -3$. A clerk claims no real solution exists.`,
      `The equation $\\lvert 3x + 1 \\rvert = 7$. An examiner claims the unique real solution is an odd integer.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered values are $2$ and $-\\frac{8}{3}$, so there are two real solutions, not exactly one. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `Five kilograms of flour, packed into bags of one kilogram less than a certain number of kilograms, fill exactly one such bag-count. That number of kilograms is $6$. A clerk claims that the unique real solution is an even integer.`,
      `The equation $\\frac{4}{x - 3} = 1$. An examiner claims the unique real solution exceeds $5$.`,
      `The equation $\\frac{5}{5} = 1$. A candidate claims exactly one real solution exists.`,
      `The equation $\\frac{8}{t} = 2$. A student claims exactly one real solution exists.`,
...
That is the cleared equation named in the claim, and it is valid precisely because $x \\neq 1$, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\sqrt{x + 7} = 5$. A student claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{3x - 2} = 4$. A clerk claims the unique real solution is an integer.`,
      `The equation $\\sqrt{x + 12} = 8$. An examiner claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{5x + 1} = 6$. A candidate claims the unique real solution is positive.`,
      `The equation $\\sqrt{2x + 9} = 7$. A student claims the unique real solution is divisible by $6$.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\sqrt{4x + 5} = 7$. A candidate claims the unique real solution is an odd integer.`,
      `The equation $\\sqrt{x + 3} = 6$. A student claims the unique real solution exceeds $25$.`,
      `The equation $\\sqrt{9x - 5} = 10$. A clerk claims no real solution exists.`,
      `The equation $\\sqrt{x + 20} = 9$. An examiner claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{6x + 1} = 5$. A candidate claims the unique real solution is an even integer.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A gauge should show twice a true reading. The absolute error from $4$ is $6$. The equation $|2x - 4| = 6$ has two distinct integer solutions. An examiner claims that the equation has two distinct integer solutions.`,
      `Both numbers five units from $3$ on the number line are claimed to be positive.`,
      `The equation $\\lvert 3x - 6 \\rvert = 9$. A student claims exactly one real solution exists.`,
      `The equation $\\lvert 2x - 4 \\rvert = 6$. A clerk claims the equation has exactly one integer solution.`,
...
The recorded distance is $6$, not $4$, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{x}{x - 1} = 3$. A clerk claims the unique real solution is not an integer.`,
      `The equation $\\dfrac{1}{x - 2} = \\dfrac{3}{x - 2}$. An examiner claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{x}{x - 4} = 2$. A candidate claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{2}{x} = \\dfrac{3}{x + 3}$. A student claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{x + 3}{x - 3} = 2$. A clerk claims the unique real solution is an odd integer.`,
    ],
    answer_key: [true, true, true, true, true],
    tactical_explanations: [
      `**A.** → True
...
At $x = 3$ the original is undefined, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The side of a square bed, after $5$ extra square metres of soil, plus the side of a smaller square whose area is $3$ m$^{2}$ less than the first, equals $4$ m. The larger area is then $4$ m$^{2}$. A student claims that the unique real solution is an even integer.`,
      `A surveyor records $\\sqrt{4x + 5} = 7$. After squaring, $4x + 5 = 49$, so $x = 11$, and the check $\\sqrt{49} = 7$ holds.`,
      `A gardener adds $5$ m$^{2}$ of soil to a square and $3$ m$^{2}$ less than that first area sits under a smaller square. The two sides add to $4$ m. The gardener claims the larger area is $8$ m$^{2}$. An examiner claims that the unique real solution is an odd integer.`,
      `The equation $\\sqrt{x + 3} = 4$. A candidate claims the unique real solution is even.`,
...
Both roots are defined, and the candidate survives, so the statement is True.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\lvert 2x - 5 \\rvert = \\lvert x + 4 \\rvert$. A clerk claims exactly one real solution exists.`,
      `A gauge error of $9$ units around a reading that is three times a value minus $6$ splits into two cases. Both $5$ and $-1$ check.`,
      `The equation $\\lvert x \\rvert = -4$. A candidate claims no real solution exists.`,
    ],
    answer_key: [true, true, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
asks an absolute value to equal a negative number. There is no real solution, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\sqrt{2x + 1} = x - 1$. An examiner claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{x + 3} = x - 3$. A candidate claims the unique real solution is an odd integer.`,
      `The equation $\\sqrt{x + 1} = 3 - x$. A student claims exactly one real solution exists.`,
      `The equation $\\sqrt{3x + 4} = x - 2$. A clerk claims the unique real solution exceeds $5$.`,
      `The equation $\\sqrt{x - 2} = 4 - x$. An examiner claims the unique real solution is an even integer.`,
    ],
    answer_key: [true, false, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
There is exactly one real solution, not two, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\lvert x - 3 \\rvert = 5$. A clerk claims the unique real solution is an even integer.`,
      `The equation $\\lvert 2x + 1 \\rvert = 9$. An examiner claims the unique real solution is negative.`,
      `The equation $\\lvert x - 4 \\rvert = \\lvert x + 2 \\rvert$. A candidate claims the unique real solution is negative.`,
      `The equation $\\sqrt{x} + 3 = 7$. A student claims the unique real solution is an even integer.`,
      `The equation $\\lvert x - 6 \\rvert + \\lvert x - 2 \\rvert = 8$. A clerk claims the unique real solution is an odd integer.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $12 \\neq 8$. The claimed point does not satisfy the equation, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{x}{x - 3} = \\dfrac{x + 6}{x - 1}$. A student claims the unique real solution is a non-integer rational number.`,
      `The equation $\\dfrac{x + 2}{x - 4} = \\dfrac{x + 8}{x - 2}$. A clerk claims the unique real solution is an integer.`,
      `The equation $\\dfrac{x}{x + 1} = \\dfrac{x + 3}{x - 2}$. An examiner claims the unique real solution is an odd integer.`,
      `The equation $\\dfrac{2x}{x + 5} = \\dfrac{x - 1}{x - 3}$. A candidate claims the unique real solution is positive.`,
      `The equation $\\dfrac{x - 1}{x + 2} = \\dfrac{x + 4}{x - 5}$. A student claims the unique real solution is an odd integer.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $-\\frac{1}{4}$, which is neither hole. That is the unique real solution, so the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{x + 1}{x} + \\dfrac{x}{x + 1} = \\dfrac{5}{2}$. A candidate claims exactly two distinct real solutions exist.`,
      `The equation $\\dfrac{1}{x} + \\dfrac{1}{x + 1} = \\dfrac{3}{2}$. A student claims exactly two distinct real solutions exist.`,
      `The equation $\\dfrac{3}{x} = \\dfrac{2}{x + 1}$. A clerk claims the unique real solution is negative.`,
      `The equation $\\dfrac{1}{x} + \\dfrac{1}{x + 2} = \\dfrac{5}{6}$. An examiner claims exactly one real solution exists.`,
      `The equation $\\dfrac{x + 3}{x} + \\dfrac{x}{x + 3} = \\dfrac{10}{3}$. A candidate claims the unique real solution is an even integer.`,
    ],
    answer_key: [true, true, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The discriminant is $12^{2} - 4 \\cdot 4 \\cdot (-27) = 144 + 432 = 576 = 24^{2}$, which is positive. There are two real solutions, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\sqrt{2x + 1} = 4 - x$. An examiner claims the unique real solution is an odd integer.`,
      `The equation $\\sqrt{x - 1} = 2 - x$. A candidate claims no real solution exists.`,
      `The equation $\\sqrt{x + 5} = x - 1$. A student claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{3x + 1} = x + 1$. A clerk claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{x - 4} = 6 - x$. An examiner claims the unique real solution is an even integer.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
There is exactly one real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\sqrt{x + 12} - \\sqrt{x} = 2$. A clerk claims the unique real solution is an even integer.`,
      `The equation $\\sqrt{x + 24} - \\sqrt{x} = 2$. An examiner claims the unique real solution exceeds $19$.`,
      `The equation $\\sqrt{x + 8} - \\sqrt{x} = 1$. A candidate claims no real solution exists.`,
      `The equation $\\sqrt{x + 5} - \\sqrt{x} = 1$. A student claims the unique real solution is an odd integer.`,
      `The equation $\\sqrt{x + 20} - \\sqrt{x} = 4$. A clerk claims no real solution exists.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $\\frac{1}{4}$, which is not divisible by $3$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The square root of a length plus $8$ m, plus the square root of the length itself, equals $6$ m. The length . A student claims that is positive and less than $6$ m.`,
...
The recovered length is $\\frac{49}{9}$ m, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\lvert 3 - 2x \\rvert = x + 1$. A candidate claims exactly two distinct real solutions exist.`,
      `The equation $\\lvert 2x + 1 \\rvert = 5$. A student claims the unique real solution is negative.`,
      `The equation $\\lvert 2x - 5 \\rvert = x + 1$. A clerk claims the unique real solution is an odd integer.`,
      `The equation $\\lvert x - 4 \\rvert = 2x - 1$. An examiner claims the unique real solution is an odd integer.`,
      `The equation $\\lvert 5 - x \\rvert = 2x + 3$. A candidate claims the unique real solution is an odd integer.`,
    ],
    answer_key: [true, true, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
There is a real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\sqrt{x + 4} = -2$. A clerk claims at least one real solution exists.`,
...
The identity does not hold at the hole, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The equation $\\dfrac{2x + 1}{x - 1} - \\dfrac{x + 3}{x + 1} = 1$. A clerk claims the unique real solution is negative.`,
      `The equation $\\dfrac{3x + 2}{x + 1} - \\dfrac{2x - 1}{x - 2} = 1$. An examiner claims the unique real solution is not an integer.`,
      `The equation $\\dfrac{5x + 1}{x - 2} - \\dfrac{2x + 3}{x + 1} = 2$. A candidate claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{x + 4}{x - 1} - \\dfrac{2x}{x + 2} = 1$. A student claims exactly two distinct real solutions exist.`,
      `The equation $\\dfrac{2x - 1}{x + 3} - \\dfrac{x + 2}{x - 1} = 1$. A clerk claims the unique real solution is an even integer.`,
    ],
    answer_key: [true, true, true, true, false],
    tactical_explanations: [
      `**A.** → True
...
The recovered value is $-\\frac{1}{5}$, which is neither hole. There is a real solution, not none, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk spends one-fifth of a purse, then one-quarter of what remains, then one-third of what is still left, and finally one-half of the last remainder, and has $18$ EUR. A student claims that the recovered value exceeds $140$.`,
      `The tens digit of a two-digit number is $2$ more than the units digit, and the number plus its reverse equals $132$. The number exceeds $70$. A clerk claims that the unique real solution exceeds $8$.`,
      `Pipe $A$ fills a tank in $20$ minutes and pipe $B$ in $30$ minutes. A leak empties the full tank in $60$ minutes. $A$ runs alone for $4$ minutes, $B$ then joins with the leak still closed for $3$ minutes, and finally the leak opens while both pipes stay on. An examiner claims that six more minutes suffice to fill the tank.`,
      `A father is $28$ years older than his son. Four years ago the father was five times as old as the son was then. The son is now a positive integer less than $15$ years old. A candidate claims that exactly one real solution exists.`,
      `A vat holds $40$ litres of $25\\%$ acid. Eight litres are drawn off and replaced by $50\\%$ acid. A student claims that the recovered value exceeds $100$.`,
    ],
    answer_key: [false, true, false, true, false],
    tactical_explanations: [
      `**A.** → False
...
The vat starts with $10$ litres of pure acid. Drawing $8$ litres of the $25\\%$ mix removes $2$ litres of acid, leaving $8$ litres of acid in $32$ litres. Adding $8$ litres of $50\\%$ stock adds $4$ litres of acid, so $12$ litres of acid sit in $40$ litres, which is $30\\%$, not $32\\%$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A train $150$ m long passes a $250$ m platform in $24$ seconds. The train's speed exceeds $50$ km/h. A candidate claims that exactly one real solution exists.`,
      `Between $2$ o'clock and $3$ o'clock the hands of a clock next overlap at $2{:}10$. A student claims that no real solution exists.`,
      `Thirty kilograms of $20\\%$ copper are mixed with some $70\\%$ copper to make a $40\\%$ alloy. Then $20$ kg of the richer alloy must be added. A clerk claims that the unique real solution is an even integer.`,
      `$A$ and $B$ together finish a job in $8$ days. $A$ alone would need $12$ days. Then $B$ alone would need $20$ days. An examiner claims that no real solution exists.`,
      `In $6$ years a father will be twice as old as his son will be then, and the father is now $30$ years older than the son. A candidate claims that the recovered value exceeds $100$.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The son is now $24$, not $18$. Eighteen would make them $48$ and $24$ in six years, but $48 \\neq 2 \\cdot 24$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The digits of a two-digit number add to $9$. If the digits are reversed, the new number is $9$ more than the original. The original number exceeds $40$. An examiner claims that exactly one real solution exists.`,
      `A boat goes $36$ km downstream in $2$ hours and returns the same $36$ km upstream in $4$ hours. A candidate claims that the recovered value exceeds $100$.`,
      `A prize of $8000$ EUR is split so that second place gets half of first place and third place gets half of second place. Then second place is $2000$ EUR. A student claims that the recovered value exceeds $100$.`,
      `Fifteen workers finish a job in $10$ days. After $4$ days, $5$ workers leave. Then $5$ extra workers must be hired so that the remaining work still finishes on the original day $10$. A clerk claims that exactly one real solution exists.`,
      `Three-quarters of a wage, plus $12$ EUR, equals twice the wage minus $20$ EUR. An examiner claims that the recovered value exceeds $44$.`,
    ],
    answer_key: [true, false, false, true, false],
    tactical_explanations: [
      `**A.** → True
...
and $2 \\cdot 64 - 20 = 108$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $60$ litre vat of $10\\%$ acid loses $12$ litres of water by evaporation, then $12$ litres of $40\\%$ acid are poured in. A clerk claims that the recovered value exceeds $100$.`,
      `Towns $180$ km apart send cars toward each other at $50$ km/h and $40$ km/h. The slower car starts $20$ minutes later. Then they meet $2$ hours after the faster car starts. An examiner claims that no real solution exists.`,
      `Five years ago a father was three times as old as his son. The father is now $30$ years older than the son. A candidate claims that the recovered value exceeds $100$.`,
      `A shop marks a price up by $20\\%$, then discounts the marked price by $10\\%$, then a loyalty card takes a further $2\\%$ off that discounted price. After these three adjustments the customer pays more than the original list price but less than $6\\%$ above it. A student claims that exactly one real solution exists.`,
      `A tank is $\\dfrac{2}{5}$ full after $12$ minutes at a constant fill rate. The rate then increases by one-quarter. The remaining three-fifths fill in $15$ minutes. A clerk claims that no real solution exists.`,
    ],
...
minutes, that is $14.4$ minutes, not $15$. Fifteen minutes at the new rate would cover $\\frac{5}{4} \\cdot \\frac{15}{30} = \\frac{5}{8}$ of the tank, which is more than the remaining $\\frac{3}{5}$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A clerk spends one-sixth of a purse, then one-fifth of the remainder, then one-quarter of what is still left, then one-third of the last remainder, and has $20$ EUR. A student claims that the recovered value exceeds $95$.`,
      `Two litres of $12\\%$ vinegar are diluted with water to $8\\%$ vinegar. Then $1$ litre of water must be added. A clerk claims that exactly one real solution exists.`,
      `Pipes $A$, $B$, and $C$ finish a job in $6$, $8$, and $24$ hours. $A$ and $B$ run together for $2$ hours, then $C$ joins. Then $4$ more hours finish the job. An examiner claims that no real solution exists.`,
      `Five consecutive integers have the property that four times the smallest exceeds the largest by $17$. The middle integer exceeds $15$. A candidate claims that no real solution exists.`,
      `Fifty kilograms of $30\\%$ copper are mixed with some $90\\%$ copper to make a $50\\%$ alloy. Then $20$ kg of the richer alloy must be added. A student claims that the unique real solution is an even integer.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
Twenty-five kilograms of the richer alloy recover $50\\%$, not $20$ kg. Twenty kilograms would give $15 + 18 = 33$ kg of copper in $70$ kg, which is $47.1\\%$, not $50\\%$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A $16$ m by $12$ m lawn has a uniform inner path. The remaining grass is $96$ m$^{2}$. A candidate claims that the recovered value exceeds $8$.`,
      ...
      `A positive number exceeds its reciprocal by $\\dfrac{8}{3}$. The positive solution is less than $2$. An examiner claims that the unique real solution is negative.`,
...
so the sides are $9$ cm and $15$ cm. A square would need equal sides, hence area $12^{2} = 144$ cm$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `Three consecutive even positive integers have the property that the sum of their squares is $200$. The middle integer . A student claims that exceeds $6$.`,
      `A stone has height $h = 24t - 4t^{2}$ metres. Then it is $32$ m high only at $t = 2$ seconds.`,
      `A rectangle has area $120$ cm$^{2}$ and its length is $1$ cm more than twice its width. The width . An examiner claims that exceeds $8$ cm.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The width is $7.5$ cm, which does not exceed $8$ cm. An $8$ cm width would give length $17$ cm and area $136$ cm$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The product of two consecutive positive integers is $210$. The smaller integer . A candidate claims that exceeds $14$.`,
      `A $12$ cm by $8$ cm picture is surrounded by a uniform frame. The outer area is $192$ cm$^{2}$. A student claims that the recovered value exceeds $8$.`,
      `An object falls from a tower with distance $5t^{2}$ metres in $t$ seconds. In the last $3$ seconds it covers $75$ m. The tower height . A clerk claims that exceeds $70$ m.`,
    ],
    answer_key: [true, true, false, false, true],
    tactical_explanations: [
      `**A.** → True
...
The tower height is $5 \\cdot 4^{2} = 80$ m. Check: in $1$ second the object falls $5$ m, so the last $3$ seconds of a $4$ second fall cover $80 - 5 = 75$ m. The statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `One leg of a right triangle is $4$ cm longer than the other, and the hypotenuse is $20$ cm. The shorter leg . A student claims that exceeds $10$ cm.`,
      ...
      `A $24$ m by $16$ m lawn has a uniform inner path. The remaining grass is $240$ m$^{2}$. A student claims that the recovered value exceeds $8$.`,
    ],
    answer_key: [true, false, true, false, false],
    tactical_explanations: [
      `**A.** → True
...
The root $x = 18$ would make the inner rectangle negative, so the path is $2$ m wide, not $4$ m. Check: inner $20$ by $12$ has area $240$. A $4$ m path would leave $16$ by $8$, which is $128$ m$^{2}$. The statement is False.`,
  ...
  },
  {
    ...
    statements: [
      ...
      `The equation $\\ell^{2} + \\ell^{2} = 200$. A clerk claims the recovered value exceeds $100$.`,
      `The equation $\\frac{1}{t} + \\frac{1}{t + 4} = \\frac{5}{24}$. An examiner claims the recovered value exceeds $100$.`,
      `Three consecutive positive integers have the property that four times the middle one exceeds the product of the other two by $2$. The middle integer is a perfect square. A candidate claims that no real solution exists.`,
    ],
    answer_key: [true, true, false, false, false],
    tactical_explanations: [
      `**A.** → True
...
Neither root is a perfect square. The middle integer from the property is not a perfect square, so the statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A surveyor records that the square root of a distance plus $21$ m, minus the square root of the distance plus $1$ m, equals $2$ m. An examiner claims that the recovered value exceeds $28$.`,
      `The square root of a length plus $5$ m, plus the square root of the length minus $3$ m, equals $4$ m. The length . A candidate claims that exceeds $3$ m and satisfies the radicand domain.`,
      `A depot on a straight road has distances to kilometre-post $1$ and kilometre-post $7$ that add to $10$ km. A student claims that the recovered value exceeds $19$.`,
      `The equation $\\dfrac{1}{x - 1} + \\dfrac{1}{x + 2} = 1$. A clerk claims no real solution exists.`,
      `The equation $\\sqrt{2x + 6} = x - 1$. An examiner claims the unique real solution is an even integer.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
Only $x = 5$ lies in the domain $x \\ge 1$, so there is exactly one real solution, not two. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The square root of a length plus $12$ m, plus the square root of the length plus $3$ m, equals $9$ m. A clerk claims that the recovered value exceeds $25$.`,
      `The equation $\\dfrac{1}{x - 1} + \\dfrac{1}{x} + \\dfrac{1}{x + 1} = \\dfrac{13}{12}$. An examiner claims the unique real solution is an odd integer.`,
      `The equation $\\lvert 2x - 4 \\rvert + \\lvert x - 5 \\rvert = 9$. A candidate claims the unique real solution is an odd integer.`,
      `The equation $\\dfrac{x + 3}{x - 2} = \\dfrac{2x}{x + 1}$. A student claims no real solution exists.`,
      `A surveyor records that the square root of a distance plus $8$ m, minus the square root of the distance itself, equals $1$ m. A clerk claims that the recovered value exceeds $100$.`,
    ],
    answer_key: [false, true, false, false, false],
    tactical_explanations: [
      `**A.** → False
...
The distance is $\\frac{49}{4}$ m, not $16$ m. Sixteen would give $\\sqrt{24} - 4$, which is not $1$. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A surveyor records that the square root of a distance plus $5$ m, minus the square root of the distance minus $2$ m, equals $1$ m. The distance . A student claims that exceeds $10$ m and satisfies the domain $x > 2$.`,
      `The equation $\\lvert x - 3 \\rvert + \\lvert 2x + 1 \\rvert = 11$. A clerk claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{2}{x + 1} - \\dfrac{3}{x - 1} = 1$. An examiner claims at least one real solution exists.`,
      `The equation $\\sqrt{4x - 3} = x - 1$. A candidate claims no real solution exists.`,
...
At $x = 3$ the left side is undefined. For $x \\neq 3$ the equation becomes $x + 3 = x + 5$, hence $3 = 5$, which never holds. There are no real solutions. The statement is False.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `The square root of a length plus $15$ m, plus the square root of the length plus $8$ m, equals $7$ m. The length . A candidate claims that is positive and less than $2$ m.`,
      `The equation $\\lvert 3 - 2x \\rvert = \\lvert x + 4 \\rvert$. A student claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{1}{x} - \\dfrac{1}{x + 3} = \\dfrac{1}{4}$. A clerk claims no real solution exists.`,
      `The equation $\\sqrt{2x + 1} = 4 - x$. An examiner claims the unique real solution is an odd integer.`,
      `The equation $\\dfrac{2x - 1}{x + 2} + \\dfrac{x - 3}{x - 1} = 3$. A candidate claims exactly one real solution exists.`,
    ],
    answer_key: [true, false, false, true, true],
    tactical_explanations: [
      `**A.** → True
...
This value is allowed because $\\frac{1}{7} \\neq -2$ and $\\frac{1}{7} \\neq 1$. So the equation has exactly one real solution, hence the statement is True.`,
  ...
  },
  {
    ...
    context: `Evaluate each statement. Mark it TRUE or FALSE.`,
    statements: [
      `A surveyor records that the square root of a distance plus $24$ m, minus the square root of the distance itself, equals $2$ m. The distance . An examiner claims that exceeds $20$ m.`,
      `A depot on a straight road has distances to kilometre-post $-2$ and kilometre-post $6$ that add to $12$ km. A candidate claims that the recovered value exceeds $17$.`,
      `The equation $\\dfrac{2}{x - 3} - \\dfrac{1}{x + 1} = 1$. A student claims no real solution exists.`,
      `The equation $\\sqrt{5x + 1} = x + 1$. A clerk claims the unique real solution is an even integer.`,
      `The equation $\\dfrac{x + 5}{x - 1} - \\dfrac{x - 2}{x + 3} = 2$. An examiner claims no real solution exists.`,
    ],
    answer_key: [true, false, false, false, false],
    tactical_explanations: [
      `**A.** → True
