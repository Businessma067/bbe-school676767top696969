# Chapter 6 — Accounting — keeping record of business transactions
...
**Owner's equity (equity)** — The portion of assets not financed by debt — what the owners have funded themselves. Equity = **assets − liabilities**. It is also a signal of the firm's wealth cushion.
...
Two Northline assets show how **straight-line depreciation** and **carrying (book) value** work. Each year the income statement includes the charge even though the cash outlay happened when the asset was bought. Never treat depreciation as a **cash outflow** in the year it is charged — the cash left at purchase as an investing outflow.

*Straight-line depreciation examples (Northline)*
| Asset | Cost | Residual | Useful life | Annual depreciation | Book value after year 1 |
| --- | --- | --- | --- | --- | --- |
| Diagnostic laptop | €2,400 | €0 | 3 years | €800 | €1,600 |
| Delivery van | €14,000 | €2,000 | 5 years | €2,400 | €11,600 |

For the laptop, book value continues to €800 after year 2 and €0 after year 3. For the van, depreciable cost is 14,000 − 2,000 = 12,000, so annual depreciation = 12,000 / 5 = €2,400. **Carrying value** = cost − accumulated depreciation.
...
*Northline — simplified year-end balance sheet after a profitable first year (€)*
| Assets | € | Liabilities and equity | € |
| --- | --- | --- | --- |
| Tools and equipment | 31,000 | Owner's equity | 78,000 |
| Delivery van | 11,600 | Bank loan | 15,000 |
...
**Cash** change and **profit** can diverge sharply. Opening cash €4,800 and closing cash €40,700 imply a cash increase of €35,900 in the same year that profit was €54,000, because profit includes non-cash depreciation and accruals while cash only counts actual movements — and because investing and financing cash also move the bank balance. A firm can be **profitable and still short of cash**, or raise cash by borrowing without matching profit.

*Illustrative cash movements (selected items)*
| Movement | Class | € |
| --- | --- | --- |
...
Cedar Circuit Components publishes a sample statement of financial position in **€ thousands**. Compare the two years in the table — do not learn the story as a wall of prose.

*Cedar Circuit Components — statement of financial position (€ thousands)*
| Line | Year 1 | Year 2 |
| --- | --- | --- |
...
Reading Year 2 structure: **non-current assets / total assets** = 495 / 776 ≈ 63.8% (plant-heavy, typical of manufacturing). **Equity ratio** = 388 / 776 = 50%. **Long-term finance** = equity 388 + non-current liabilities 238 = 626, covering non-current assets of 495. Cash of 118 exceeds trade payables of 96. Overall: manufacturing-typical mix, moderate equity funding, long-term assets matched by long-term finance.

Cedar's income statement uses the same €-thousands scale. Compare years in the table, then interpret the profit layers.

*Cedar Circuit Components — income statement (€ thousands)*
| Line | Year 1 | Year 2 |
| --- | --- | --- |
| Revenue | 520 | 640 |
...
> *Cost of sales = COS/COGS for the period; average inventory = typical stock level over the year. Result is 'times per year'. Days in inventory ≈ 365 / inventory turnover.*

For Cedar (€ thousands), turnover (revenue) = 640 with assets of 698 in Year 1 and 776 in Year 2, so average assets = (698 + 776) / 2 = 737 and **asset turnover** = 640 / 737 ≈ 0.87 — about €0.87 of sales per €1 of average assets. Using net assets instead, Year 2 net assets = 776 − 238 = 538 and Year 1 = 698 − 254 = 444, so average = 491 and turnover / average net assets = 640 / 491 ≈ 1.30. Average inventory = (92 + 78) / 2 = 85, so **inventory turnover** = 498 / 85 ≈ 5.9 times per year, or roughly 365 / 5.9 ≈ 62 days. Stock renews about six times a year, and asset productivity must still be judged against manufacturing peers.
...
For Cedar Year 2, equity = 388, total assets = 776 and total liabilities = 388, so the **equity ratio** and **debt ratio** are both 50%. If Cedar financed a new plant mostly with short-term overdraft instead of equity or a long-term loan, liquidity would worsen first (current liabilities up, working capital down) while gearing also shifts toward debt. **Liquidity**, **profitability**, efficiency and gearing answer different questions — a firm can look strong on ROE yet weak on the acid test — so read the set together, compare within industry or over time, and know which definition was used.

*Cedar Year 2 — ratio snapshot (€ thousands inputs)*
