 ...
 * 9 (Polynomial functions), 11 (Differentiation and single-variable
 * optimization), 12 (Elementary probability), and 13 (Binomial) are populated;
...
import { MATH_CH9_POLYNOMIALS } from "@/data/math-ch9-polynomials"; // Lovable sync: ch9 practice bank
import {
...
export const DEMO_MATH_CHAPTER_FREE: Partial<Record<number, number>> = {
  /** Chapters 7 and 9 have no book subtopics — unlock the first N tasks at chapter level. */
  7: 10,
  9: 10,
};
