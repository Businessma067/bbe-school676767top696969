/**
 * DE / UK translations for the BBE vs WISO exam-info comparison page.
 * Keys must match English source strings exactly (PageTranslator lookup).
 */

export const bbeVsWisoExtraDe: Record<string, string> = {
  "BBE vs WISO": "BBE vs WISO",
  "vs WISO": "vs WISO",
  "Compare language, places, selectivity, and which exam fits you":
    "Vergleiche Sprache, Plätze, Selektivität und welche Prüfung zu dir passt",

  "BBE vs WISO at WU Vienna: Entrance Exam Comparison Guide | BBE School":
    "BBE vs WISO an der WU Wien: Vergleich der Aufnahmeprüfungen | BBE School",
  "BBE vs WISO at WU Vienna: Entrance Exam Comparison Guide":
    "BBE vs WISO an der WU Wien: Vergleich der Aufnahmeprüfungen",
  "BBE vs WISO at WU Vienna explained: English vs German programmes, entrance exam subjects, places, selectivity, semester start, and which exam to prepare for.":
    "BBE vs WISO an der WU Wien erklärt: englisch- vs. deutschsprachige Programme, Prüfungsfächer, Plätze, Selektivität, Studienbeginn und welche Prüfung du vorbereiten solltest.",
  ...
  "Quick answer: BBE vs WISO": "Kurzantwort: BBE vs WISO",
  "BBE is WU Vienna’s English-taught Bachelor’s Program in Business and Economics. WISO is the German-taught Bachelor’s Program in Business, Economics and Social Sciences. Both selection procedures usually include a written, in-person multiple-choice entrance exam when registrations exceed places. The practical differences that matter most for applicants are language of study, the language section on the exam, how many seats exist, and when you can start.":
    "BBE ist das englischsprachige Bachelorstudium Business and Economics der WU Wien. WISO ist das deutschsprachige Bachelorstudium Wirtschafts- und Sozialwissenschaften. Beide Auswahlverfahren beinhalten in der Regel eine schriftliche Multiple-Choice-Aufnahmeprüfung vor Ort, wenn die Anmeldungen die Plätze übersteigen. Die praktisch wichtigsten Unterschiede für Bewerber:innen sind die Studiensprache, der Sprachteil der Prüfung, die Anzahl der Plätze und der mögliche Studienbeginn.",

  "Use this table as a decision snapshot. For BBE exam format details, see the BBE Entrance Exam Overview linked below.":
    "Nutze diese Tabelle als Entscheidungsüberblick. Details zum BBE-Prüfungsformat findest du im unten verlinkten BBE-Aufnahmeprüfungsüberblick.",
  ...
  "Most recent BBE structure: 34 questions in 2 hours (10 Economics, 11 English, 13 Math)":
    "Aktuellste BBE-Struktur: 34 Fragen in 2 Stunden (10 Wirtschaft, 11 Englisch, 13 Mathe)",

  "Most recent WiSo structure: 32 questions in 2 hours (10 Economics, 9 German, 13 Math)":
    "Aktuellste WiSo-Struktur: 32 Fragen in 2 Stunden (10 Wirtschaft, 9 Deutsch, 13 Mathe)",
  ...
  "Recent BBE and WISO exams have been held at VIECON, Vienna Congress and Convention Center (Messe Wien).":
    "Aktuelle BBE- und WISO-Prüfungen fanden im VIECON, Vienna Congress and Convention Center (Messe Wien) statt.",
  ...
  "WISO exam language": "WISO-Prüfungssprache",
  English: "Englisch",
  German: "Deutsch",

  "Independent guide": "Unabhängiger Leitfaden",
  "BBE School prepares applicants for the BBE entrance exam. Figures below summarise recent public WU cycle information and can change. Always confirm dates, fees, and rules on the official WU Vienna website.":
    "BBE School bereitet Bewerber:innen auf die BBE-Aufnahmeprüfung vor. Die Zahlen unten fassen aktuelle öffentliche Angaben der WU zusammen und können sich ändern. Bestätige Termine, Gebühren und Regeln immer auf der offiziellen Website der WU Wien.",

  "Illustration of two academic pathways branching from one university campus":
    "Illustration zweier akademischer Wege, die von einem Universitätscampus abzweigen",
  "One university, two bachelor pathways: BBE and WISO share a WU campus identity but differ in language, cohort size, and entrance-exam competition.":
    "Eine Universität, zwei Bachelorwege: BBE und WISO teilen die WU-Campus-Identität, unterscheiden sich aber in Sprache, Kohortengröße und Wettbewerb um die Aufnahmeprüfung.",

  "Side-by-side comparison": "Direkter Vergleich",
  "Use this table as a decision snapshot. For BBE exam format details, see the":
    "Nutze diese Tabelle als Entscheidungsüberblick. Details zum BBE-Prüfungsformat findest du im",
  "BBE Entrance Exam Guide →": "BBE-Aufnahmeprüfungsleitfaden →",
  Aspect: "Aspekt",
  BBE: "BBE",
  WISO: "WISO",

  "Programme language": "Studiensprache",
  "English-taught": "Englischsprachig",
  "German-taught": "Deutschsprachig",
  "Full programme name": "Vollständiger Programmname",
  ...
  "Exam language focus": "Schwerpunkt Sprachteil",
  "English (grammar, vocabulary, reading)": "Englisch (Grammatik, Wortschatz, Leseverständnis)",
  "German language comprehension": "Deutsches Sprachverständnis",
  "Shared exam pillars": "Gemeinsame Prüfungssäulen",
  "Mathematics + economics/business basics": "Mathematik + Wirtschafts-/Business-Grundlagen",
  "Places (recent cycle)": "Plätze (aktueller Zyklus)",
  "Selectivity signal": "Selektivitätssignal",
  "Very high (often ~16 applicants per place)": "Sehr hoch (oft ~16 Bewerber:innen pro Platz)",
  "High, but more places available": "Hoch, aber mehr Plätze verfügbar",
  "Programme start": "Studienbeginn",
  "Winter semester only": "Nur Wintersemester",
  "Winter or summer semester possible after a successful procedure":
    "Winter- oder Sommersemester nach erfolgreichem Verfahren möglich",
  "Typical cohort feel": "Typisches Kohortengefühl",
  "Smaller, international, English campus life":
    "Kleiner, international, englischsprachiges Campusleben",
  "Larger programme with broader specialisation paths later":
    "Größeres Programm mit breiteren Spezialisierungswegen später",

  "Places and selectivity": "Plätze und Selektivität",
  "Place counts are the clearest structural difference. WISO offers many more seats; BBE remains one of WU’s most competitive bachelor intakes. In a recent WU announcement, roughly":
    "Die Platzzahlen sind der klarste strukturelle Unterschied. WISO bietet deutlich mehr Plätze; BBE bleibt einer der kompetitivsten Bachelorzugänge der WU. In einer aktuellen WU-Mitteilung waren rund",
  "people were eligible for the BBE exam against":
    "Personen für die BBE-Prüfung zugelassen gegenüber",
  "places, while about": "Plätzen, während etwa",
  "were eligible for WISO against": "für WISO zugelassen waren gegenüber",
  "places.": "Plätzen.",
  "Available places (recent cycle)": "Verfügbare Plätze (aktueller Zyklus)",
  "Approximate competition (eligible applicants ÷ places)":
    "Ungefährer Wettbewerb (zulässige Bewerber:innen ÷ Plätze)",
  "BBE · eligible per place": "BBE · Zulässige pro Platz",
  "WISO · eligible per place": "WISO · Zulässige pro Platz",
  "Charts use approximate recent-cycle figures for illustration. Competition ratios move with each year’s registrations.":
    "Die Diagramme nutzen ungefähre Zahlen eines aktuellen Zyklus zur Veranschaulichung. Die Wettbewerbsquoten ändern sich mit den Anmeldungen jedes Jahres.",

  "What each entrance exam tests": "Was jede Aufnahmeprüfung prüft",
  "Both exams are multiple-choice and typically cover mathematics plus basic economics and business knowledge. The language pillar is where they diverge: BBE tests English; WISO tests German comprehension.":
    "Beide Prüfungen sind Multiple Choice und decken typischerweise Mathematik sowie grundlegende Wirtschafts- und Businesskenntnisse ab. Beim Sprachteil trennen sich die Wege: BBE prüft Englisch; WISO prüft deutsches Sprachverständnis.",
  "BBE written exam": "Schriftliche BBE-Prüfung",
  "WISO written exam": "Schriftliche WISO-Prüfung",
  "Economics & business fundamentals": "Wirtschafts- und Businessgrundlagen",
  "English grammar, vocabulary, and reading": "Englische Grammatik, Wortschatz und Lesen",
  "Mathematics at Austrian school-leaving depth":
    "Mathematik auf Niveau der österreichischen Matura",
  "Most recent BBE structure:": "Aktuellste BBE-Struktur:",
  "questions in": "Fragen in",
  hours: "Stunden",
  Mathematics: "Mathematik",
  "Multiple-choice only; held in person when the procedure runs":
    "Nur Multiple Choice; vor Ort, wenn das Verfahren stattfindet",
  ...
  "Despite different programmes, the administrative spine often looks similar: register in the published window, complete the Online Self-Assessment (OSA) if required, then sit the written exam if demand exceeds places. There is typically no alternative exam date.":
    "Trotz unterschiedlicher Programme sieht der administrative Ablauf oft ähnlich aus: im veröffentlichten Fenster registrieren, das Online-Self-Assessment (OSA) bei Bedarf absolvieren und die schriftliche Prüfung ablegen, wenn die Nachfrage die Plätze übersteigt. Einen Ersatztermin gibt es in der Regel nicht.",
  "Registration fee applies per programme (confirm the current amount with WU).":
    "Die Registrierungsgebühr gilt pro Studium (aktuellen Betrag bei der WU bestätigen).",
  "OSA is usually ungraded and does not replace the ranking based on the written exam.":
    "Das OSA wird meist nicht benotet und ersetzt nicht das Ranking der schriftlichen Prüfung.",
  "Recent BBE and WISO exams have been held at":
    "Aktuelle BBE- und WISO-Prüfungen fanden statt in",
  "BBE start is winter semester only; WISO can allow winter or summer start after a successful procedure.":
    "BBE startet nur im Wintersemester; WISO kann nach erfolgreichem Verfahren Winter- oder Sommerstart erlauben.",
  "Register in the window": "Im Fenster registrieren",
  "Complete the OSA": "OSA absolvieren",
  "Sit the written exam": "Schriftliche Prüfung ablegen",
  "BBE admission & application overview →": "BBE Zulassung & Bewerbung Übersicht →",

  "Who should choose BBE or WISO?": "Wer sollte BBE oder WISO wählen?",
  "Lean toward BBE if…": "Tendiere zu BBE, wenn…",
  "You want to study fully in English, prefer a smaller international cohort, and are ready for a highly selective written exam with an English section.":
    "du vollständig auf Englisch studieren willst, eine kleinere internationale Kohorte bevorzugst und bereit bist für eine stark selektive schriftliche Prüfung mit Englischteil.",
  "Lean toward WISO if…": "Tendiere zu WISO, wenn…",
  "You are comfortable studying in German, value a larger programme with more later specialisation options, and may want a summer-semester start after a successful selection procedure.":
    "du dich mit einem Studium auf Deutsch wohlfühlst, ein größeres Programm mit mehr späteren Spezialisierungsoptionen schätzt und nach erfolgreichem Verfahren eventuell im Sommersemester starten möchtest.",
  "Consider both if…": "Erwäge beides, wenn…",
  ...
  "Both pathways can lead to the same kind of high-pressure hall experience. Preparation quality matters more than collecting random PDFs.":
    "Beide Wege können zum gleichen Hochdruck-Erlebnis im Prüfungssaal führen. Qualität der Vorbereitung zählt mehr als das Sammeln zufälliger PDFs.",
  "How BBE scoring works →": "So funktioniert die BBE-Bewertung →",
  "How to prepare for BBE →": "So bereitest du dich auf BBE vor →",

  "Common myths about BBE vs WISO": "Häufige Mythen zu BBE vs WISO",
  "“WISO is just the easy German version of BBE.”":
    "„WISO ist nur die leichte deutsche Version von BBE.“",
  "Not accurate. WISO is a different programme with its own scale, language, and curriculum options. It is less scarce on seats, but it is still a competitive WU bachelor intake.":
    "Nicht zutreffend. WISO ist ein anderes Programm mit eigener Größe, Sprache und Curriculum-Optionen. Es gibt mehr Plätze, aber es bleibt ein kompetitiver WU-Bachelorzugang.",
  "“If I prepare for one exam, I am ready for both.”":
    "„Wenn ich eine Prüfung vorbereite, bin ich für beide bereit.“",
  ...
  "Want to feel the BBE exam style before you commit?":
    "Willst du den BBE-Prüfungsstil spüren, bevor du dich festlegst?",
  "Use the free demo course to sample Economics, Math, and English tasks with explanations, then take a diagnostic mock to see your starting point.":
    "Nutze den kostenlosen Demokurs, um Aufgaben in Wirtschaft, Mathematik und Englisch mit Erklärungen zu testen, und mache dann einen Diagnostik-Mock für deinen Ausgangspunkt.",
  "Start Free Demo Course →": "Kostenlosen Demokurs starten →",

  "What is the difference between BBE and WISO at WU Vienna?":
    "Was ist der Unterschied zwischen BBE und WISO an der WU Wien?",
  "BBE is WU’s English-taught Bachelor’s Program in Business and Economics. WISO is the German-taught Bachelor’s Program in Business, Economics and Social Sciences. Both use a written multiple-choice entrance exam when demand exceeds places, but language of instruction, language section of the exam, place numbers, and semester start options differ.":
    "BBE ist das englischsprachige Bachelorstudium Business and Economics der WU. WISO ist das deutschsprachige Bachelorstudium Wirtschafts- und Sozialwissenschaften. Beide nutzen eine schriftliche Multiple-Choice-Aufnahmeprüfung, wenn die Nachfrage die Plätze übersteigt, unterscheiden sich aber in Studiensprache, Sprachteil der Prüfung, Platzzahlen und Semesterstart.",
  "Is the BBE entrance exam harder than the WISO exam?":
    "Ist die BBE-Aufnahmeprüfung schwieriger als die WISO-Prüfung?",
  "BBE is generally more selective because far fewer places are available. Content overlap exists in mathematics and basic economics, but BBE tests English skills while WISO tests German language comprehension. Which feels harder depends on your language strengths and how competitive your cohort is.":
    "BBE ist in der Regel selektiver, weil deutlich weniger Plätze verfügbar sind. Inhaltliche Überschneidungen gibt es in Mathematik und Grundwirtschaft, aber BBE prüft Englisch, WISO deutsches Sprachverständnis. Was schwieriger wirkt, hängt von deinen Sprachstärken und dem Wettbewerb in deiner Kohorte ab.",
  "Can I take both the BBE and WISO entrance exams?":
    "Kann ich sowohl die BBE- als auch die WISO-Aufnahmeprüfung ablegen?",
  "Yes. Applicants interested in more than one WU bachelor programme typically register and pay the fee for each programme separately, then complete each selection procedure’s required steps. Confirm the current rules on the official WU website.":
    "Ja. Bewerber:innen, die an mehr als einem WU-Bachelor interessiert sind, registrieren sich in der Regel und zahlen die Gebühr für jedes Studium separat und absolvieren die jeweiligen Schritte. Bestätige die aktuellen Regeln auf der offiziellen WU-Website.",
  "How many places do BBE and WISO offer?":
    "Wie viele Plätze bieten BBE und WISO?",
  ...
  "Decide by language of study first: strong English and an international cohort point toward BBE; strong German and broader curricular flexibility often point toward WISO. Many applicants sit a diagnostic-style practice set to see how they handle BBE-format mathematics, economics, and English under time pressure.":
    "Entscheide zuerst nach Studiensprache: starkes Englisch und eine internationale Kohorte sprechen für BBE; starkes Deutsch und mehr Curriculum-Flexibilität oft für WISO. Viele Bewerber:innen machen einen diagnostischen Übungssatz, um zu sehen, wie sie BBE-Mathematik, Wirtschaft und Englisch unter Zeitdruck meistern.",
};

export const bbeVsWisoExtraUk: Record<string, string> = {
  "BBE vs WISO": "BBE vs WISO",
  "vs WISO": "vs WISO",
  "Compare language, places, selectivity, and which exam fits you":
    "Порівняйте мову, місця, селективність і який іспит вам підходить",

  "BBE vs WISO at WU Vienna: Entrance Exam Comparison Guide | BBE School":
    "BBE vs WISO у WU Vienna: Порівняння вступних іспитів | BBE School",
  "BBE vs WISO at WU Vienna: Entrance Exam Comparison Guide":
    "BBE vs WISO у WU Vienna: Порівняння вступних іспитів",
  "BBE vs WISO at WU Vienna explained: English vs German programmes, entrance exam subjects, places, selectivity, semester start, and which exam to prepare for.":
    "BBE vs WISO у WU Vienna: англо- та німецькомовні програми, предмети вступного іспиту, місця, конкуренція, початок навчання та який іспит готувати.",
  "Side-by-side comparison of WU’s BBE and WISO entrance exams: language, subjects, competition, and how to choose.":
  ...
  "Most recent WiSo structure: 32 questions in 2 hours (10 Economics, 9 German, 13 Math)":
    "Найновіша структура WiSo: 32 питання за 2 години (10 економіка, 9 німецька, 13 математика)",
  ...
  "WISO exam language": "Мова іспиту WISO",
  English: "Англійська",
  German: "Німецька",

  "Independent guide": "Незалежний гайд",
  "BBE School prepares applicants for the BBE entrance exam. Figures below summarise recent public WU cycle information and can change. Always confirm dates, fees, and rules on the official WU Vienna website.":
    "BBE School готує абітурієнтів до вступного іспиту BBE. Наведені нижче цифри узагальнюють нещодавні публічні дані WU і можуть змінюватися. Завжди перевіряйте дати, збори та правила на офіційному сайті WU Vienna.",

  "Illustration of two academic pathways branching from one university campus":
    "Ілюстрація двох академічних шляхів, що розходяться від одного університетського кампусу",
  "One university, two bachelor pathways: BBE and WISO share a WU campus identity but differ in language, cohort size, and entrance-exam competition.":
    "Один університет, два бакалаврські шляхи: BBE і WISO мають спільну ідентичність кампусу WU, але відрізняються мовою, розміром когорти та конкуренцією на вступному іспиті.",
  ...
  "Programme language": "Мова програми",
  "English-taught": "Англомовна",
  "German-taught": "Німецькомовна",
  "Full programme name": "Повна назва програми",
  "Business and Economics (BBE)": "Business and Economics (BBE)",
  "Business, Economics and Social Sciences (WISO)":
    "Економіка, бізнес і соціальні науки (WISO)",
  "Exam language focus": "Мовний акцент іспиту",
  "English (grammar, vocabulary, reading)": "Англійська (граматика, словник, читання)",
  "German language comprehension": "Розуміння німецької мови",
  "Shared exam pillars": "Спільні блоки іспиту",
  "Mathematics + economics/business basics": "Математика + основи економіки/бізнесу",
  "Places (recent cycle)": "Місця (нещодавній цикл)",
  "Selectivity signal": "Сигнал селективності",
  "Very high (often ~16 applicants per place)": "Дуже висока (часто ~16 абітурієнтів на місце)",
  "High, but more places available": "Висока, але більше місць",
  "Programme start": "Початок навчання",
  "Winter semester only": "Лише зимовий семестр",
  "Winter or summer semester possible after a successful procedure":
    "Зимовий або літній семестр можливий після успішного відбору",
  "Typical cohort feel": "Типове відчуття когорти",
  "Smaller, international, English campus life":
    "Менша, міжнародна, англомовна атмосфера кампусу",
  "Larger programme with broader specialisation paths later":
    "Більша програма з ширшими шляхами спеціалізації згодом",
  ...
  "were eligible for WISO against": "були допущені до WISO проти",
  "places.": "місць.",
  "Available places (recent cycle)": "Доступні місця (нещодавній цикл)",
  "Approximate competition (eligible applicants ÷ places)":
    "Орієнтовна конкуренція (допущені абітурієнти ÷ місця)",
  "BBE · eligible per place": "BBE · допущені на місце",
  "WISO · eligible per place": "WISO · допущені на місце",
  "Charts use approximate recent-cycle figures for illustration. Competition ratios move with each year’s registrations.":
    "Діаграми використовують орієнтовні цифри нещодавнього циклу для ілюстрації. Співвідношення конкуренції змінюється з реєстраціями кожного року.",
  ...
  "English grammar, vocabulary, and reading": "Англійська граматика, словник і читання",
  "Mathematics at Austrian school-leaving depth":
    "Математика на рівні австрійської шкільної випускної",
  "Most recent BBE structure:": "Найновіша структура BBE:",
  "questions in": "питань за",
  hours: "годин",
  Mathematics: "Математика",
  "Multiple-choice only; held in person when the procedure runs":
    "Лише тест із варіантами; очно, коли відбір проводиться",
  "Split academic atmosphere suggesting English-taught and German-taught study environments":
  ...
  "Despite different programmes, the administrative spine often looks similar: register in the published window, complete the Online Self-Assessment (OSA) if required, then sit the written exam if demand exceeds places. There is typically no alternative exam date.":
    "Попри різні програми, адміністративний каркас часто схожий: зареєструватися у опублікованому вікні, пройти Online Self-Assessment (OSA) за потреби, потім скласти письмовий іспит, якщо попит перевищує місця. Альтернативної дати зазвичай немає.",
  "Registration fee applies per programme (confirm the current amount with WU).":
    "Реєстраційний збір сплачується за кожну програму (підтвердіть поточну суму у WU).",
  "OSA is usually ungraded and does not replace the ranking based on the written exam.":
    "OSA зазвичай не оцінюється і не замінює рейтинг за письмовим іспитом.",
  "Recent BBE and WISO exams have been held at":
    "Нещодавні іспити BBE і WISO проводилися в",
  "BBE start is winter semester only; WISO can allow winter or summer start after a successful procedure.":
    "BBE починається лише в зимовому семестрі; WISO може дозволити зимовий або літній старт після успішного відбору.",
  "Register in the window": "Зареєструватися у вікні",
  "Complete the OSA": "Пройти OSA",
  "Sit the written exam": "Скласти письмовий іспит",
  "BBE admission & application overview →": "Огляд вступу та подачі документів BBE →",

  "Who should choose BBE or WISO?": "Кому обирати BBE чи WISO?",
  "Lean toward BBE if…": "Схиляйтеся до BBE, якщо…",
  "You want to study fully in English, prefer a smaller international cohort, and are ready for a highly selective written exam with an English section.":
    "хочете навчатися повністю англійською, віддаєте перевагу меншій міжнародній когорті та готові до дуже селективного письмового іспиту з англійським блоком.",
  "Lean toward WISO if…": "Схиляйтеся до WISO, якщо…",
  "You are comfortable studying in German, value a larger programme with more later specialisation options, and may want a summer-semester start after a successful selection procedure.":
    "вам комфортно навчатися німецькою, цінуєте більшу програму з ширшими опціями спеціалізації згодом і, можливо, хочете почати в літньому семестрі після успішного відбору.",
  "Consider both if…": "Розгляньте обидва, якщо…",
  "Your language skills support either path and you want a second chance at a WU bachelor seat. Register for each programme separately and prepare for the language section that each exam actually tests.":
  ...
  "Both pathways can lead to the same kind of high-pressure hall experience. Preparation quality matters more than collecting random PDFs.":
    "Обидва шляхи можуть привести до однакового високого тиску в залі. Якість підготовки важливіша за збір випадкових PDF.",
  "How BBE scoring works →": "Як працює оцінювання BBE →",
  "How to prepare for BBE →": "Як готуватися до BBE →",
  ...
  "Want to feel the BBE exam style before you commit?":
    "Хочете відчути стиль іспиту BBE до того, як зобов’язуватися?",
  "Use the free demo course to sample Economics, Math, and English tasks with explanations, then take a diagnostic mock to see your starting point.":
    "Скористайтеся безкоштовним демо-курсом, щоб спробувати завдання з економіки, математики та англійської з поясненнями, а потім пройдіть діагностичний mock, щоб побачити стартову точку.",
  "Start Free Demo Course →": "Почати безкоштовний демо-курс →",
  ...
  "Yes. Applicants interested in more than one WU bachelor programme typically register and pay the fee for each programme separately, then complete each selection procedure’s required steps. Confirm the current rules on the official WU website.":
    "Так. Абітурієнти, зацікавлені в більш ніж одній бакалаврській програмі WU, зазвичай реєструються й сплачують збір за кожну окремо, потім виконують кроки кожного відбору. Підтвердіть поточні правила на офіційному сайті WU.",
  "How many places do BBE and WISO offer?":
    "Скільки місць пропонують BBE і WISO?",
