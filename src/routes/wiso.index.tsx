        ...
        <section className="relative overflow-hidden px-4 pt-8 pb-12 sm:px-6 sm:pt-12 sm:pb-16 lg:px-8 lg:pt-14 lg:pb-20">
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
              ...
              <p className="mb-3 rounded-full border border-teal-200/80 bg-teal-50/80 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-teal-900 dark:border-teal-800/50 dark:bg-teal-950/40 dark:text-teal-200">
              ...
              <div className="mt-7 flex w-full flex-col items-stretch justify-center gap-3 sm:w-auto sm:flex-row">
                <LocalizedLink
                  ...
                  className="inline-flex flex-col items-center justify-center rounded-sm bg-teal-700 px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-700 focus:ring-offset-2"
                >
                ...
                <LocalizedLink
                  ...
                  className="inline-flex flex-col items-center justify-center rounded-sm border border-teal-700 bg-teal-700/10 px-6 py-3.5 text-sm font-semibold text-teal-900 transition-colors hover:bg-teal-700/20 focus:outline-none focus:ring-2 focus:ring-teal-700 focus:ring-offset-2 dark:text-teal-100"
                >
            ...
            <div className="mx-auto mt-12 grid max-w-4xl gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={stat.label}
                  className="rounded-2xl border border-teal-200/70 bg-teal-50/50 px-4 py-5 text-center dark:border-teal-800/40 dark:bg-teal-950/25"
                >
            ...
            <div className="mx-auto mt-8 max-w-4xl text-center">
              <LocalizedLink
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-teal-800 underline-offset-4 hover:underline dark:text-teal-300"
              >
        ...
        <section id="why-choose-us" className="px-6 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <LocalizedLink
                to="/bbe-vs-wiso"
                className="rounded-md border border-teal-700/40 bg-teal-50/60 px-4 py-2 text-sm font-semibold text-teal-900 hover:bg-teal-50 dark:bg-teal-950/30 dark:text-teal-100"
              >
                BBE vs WiSo
              </LocalizedLink>
            </div>
