...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "OSIK7qys7Gw33QjImit8Uj1mt-nhLXHAx3HPFS9GjAU" },
    ...
    links: [
      { rel: "icon", type: "image/png", sizes: "16x16", href: "/favicon-16.png?v=7" },
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32.png?v=7" },
      { rel: "icon", type: "image/png", sizes: "48x48", href: "/favicon-48.png?v=7" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/favicon.png?v=7" },
      ...
      {
        rel: "stylesheet",
        // Institutional serif for headlines + Inter for UI chrome/data.
