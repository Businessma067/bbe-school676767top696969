      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete your one-time purchase of {productName}, or redeem a Full Course unlock code.
            </DialogDescription>
          </DialogHeader>
            ...
            >
              ...
              <TabsContent value="promo" className="mt-4">
                <form onSubmit={handlePromoRedeem} className="space-y-4">
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    Enter a 15% discount code (unlimited or single-use), or a one-time Full Course unlock code.
                  </p>
                  <div>
